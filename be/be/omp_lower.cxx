 ...
 * $Revision: 1.76 $
 * $Date: 2000/09/14 17:39:32 $
 * $Author: mpm $
 * $Source: /isms/cmplrs.src/osprey1.0/be/be/RCS/omp_lower.cxx,v $
 *
 * Revision history:
...
static void Convert_Section_To_Pdo(WN *sections, WN *pragma)
{
  ...
  if (Cur_PU_Feedback) {
    INT32 region_fb = WN_MAP32_Get(FB_Map,sections);
    WN_MAP32_Set(FB_Map,new_do,region_fb);
    WN_MAP32_Set(FB_Map,lb,region_fb);
    WN_MAP32_Set(FB_Map,incr,sec_stack->Elements()*region_fb);
  }
