...
BOOL CG_specialization = TRUE;
BOOL CG_warn_bad_freqs = FALSE;

/* CG_tmp_skip_xxx is used temporarily during development */
INT32 CG_tmp_skip_after = INT32_MAX;
INT32 CG_tmp_skip_before = 0;
INT32 CG_tmp_skip_equal = -1;

INT32 CG_CU_skip_after = INT32_MAX;
INT32 CG_CU_skip_before = 0;
INT32 CG_CU_skip_equal = -1;
...
BOOL CG_init_black_hole_overridden = FALSE;
BOOL CG_init_black_hole = TRUE;
INT32 CG_maxinss = 100;
...
INT32 CFLOW_Enable_Layout = 0;   // 0: disable; > 0: enable. (Default: 0)
...
BOOL CG_unroll_prune_prefetches = TRUE;
BOOL CG_generate_bb_range = FALSE;
...
BOOL LOCS_Enable_Xblock_Latency = TRUE;
...
INT32 EMIT_Align_Branch_Targets = DEFAULT_ALIGN_BRANCH_TARGETS;
...
BOOL GRA_new_conflict = TRUE;

BOOL  HB_formation = TRUE;
BOOL  HB_coalesce_backedges = TRUE;
BOOL  HB_static_freq_heuristics = TRUE;
BOOL  HB_static_freq_no_fifty_splits = TRUE;
INT   HB_max_blocks = 20;
INT   HB_max_instructions;
const char* HB_max_sched_growth = "4.1";
const char* HB_max_sched_growth_sf = "2.05";
...
BOOL  HB_general_from_bottom = TRUE;
...
Xtensa_Arch earliest_arch = Barcelona_Xtensa;
Xtensa_Arch latest_arch = Barcelona_Xtensa;

BOOL jons_test_flags[5] = {FALSE, FALSE, FALSE, FALSE, FALSE};
