 ...
 *  $Revision: 1.9 $
 *  $Date: 2000/09/19 22:34:14 $
 *  $Author: srinivas $
 *  $Source: /isms/cmplrs.src/osprey1.0/be/cg/RCS/cg_loop_mii.h,v $
 *
 *  Revision history:
...
#ifdef _KEEP_RCS_ID
static const char cg_loop_mii_rcs_id[] = "$Source: /isms/cmplrs.src/osprey1.0/be/cg/RCS/cg_loop_mii.h,v $ $Revision: 1.9 $";
#endif /* _KEEP_RCS_ID */
