 ...
 *  Module: vector.c
 *  $Revision: 1.8 $
 *  $Date: 2000/04/07 01:11:27 $
 *  $Author: mtibuild $
 *  $Source: /isms/cmplrs.src/osprey1.0/be/cg/RCS/cg_vector.cxx,v $
 *
 *  Description:
 *  ============
 *
...
{
  /* SCA: this function, for some unknown reaon,
     sometimes produces garbage under solaris.
     If possible, you should build the vector 
     in sorted order using VECTOR_Sorted_Add_Element 
     instead of building it and then sorting it.
  */

  DevWarn("VECTOR_Sort: use VECTOR_Sorted_Add_Element instead");

  int count = VECTOR_count(vector);
  void * addr = &VECTOR_element(vector,0);
  qsort (
    addr, 
    count, 
    sizeof (void *),
