...
#ifdef _KEEP_RCS_ID
static char *cgemit_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/cg/RCS/cgemit.h,v $ $Revision: 3.22 $";
#endif /* _KEEP_RCS_ID */
 ...
 */
extern BOOL Check_If_Should_Align_BB (BB *bb, INT32 curpc, INT *num_of_nops);
...
/* Get an elf index from a symbol.  Can call only after initialized of the
   symbol to elf index map is constructed, see cgemit.c */
extern INT32 ST_elf_index( ST *st);
