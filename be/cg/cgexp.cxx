 ...
 * Module: cgexp.cxx
 * $Revision: 1.22 $
 * $Date: 2000/06/30 00:00:05 $
 * $Author: mpm $
 * $Source: /isms/cmplrs.src/osprey1.0/be/cg/RCS/cgexp.cxx,v $
 *
...
static void
Expand_OP (OPCODE opcode, TN *result, TN *op1, TN *op2, TN *op3, INT16 variant, OPS *ops)
{
...
extern void 
Exp_OP (OPCODE opcode, TN *result, TN *op1, TN *op2, TN *op3, INT16 variant, OPS *ops)
{
  ...
  if (Trace_Exp) {
	...
	fprintf(TFile, " ");
	if (variant) fprintf(TFile, "(%x)", variant);
	fprintf(TFile, "\n");
  }
