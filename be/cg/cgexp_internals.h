...
extern void Expand_Logical_Not (TN *dest, TN *src, INT16 variant, OPS *ops);
extern void Expand_Logical_And (TN *dest, TN *src1, TN *src2, INT16 variant, OPS *ops);
extern void Expand_Logical_Or (TN *dest, TN *src1, TN *src2, INT16 variant, OPS *ops);
...
extern void Expand_Float_Less (TN *dest, TN *src1, TN *src2, INT16 variant, TYPE_ID mtype, OPS *ops);
extern void Expand_Float_Less_Equal (TN *dest, TN *src1, TN *src2, INT16 variant, TYPE_ID mtype, OPS *ops);
extern void Expand_Float_Greater (TN *dest, TN *src1, TN *src2, INT16 variant, TYPE_ID mtype, OPS *ops);
extern void Expand_Float_Greater_Equal (TN *dest, TN *src1, TN *src2, INT16 variant, TYPE_ID mtype, OPS *ops);
extern void Expand_Float_Equal (TN *dest, TN *src1, TN *src2, INT16 variant, TYPE_ID mtype, OPS *ops);
extern void Expand_Float_Not_Equal (TN *dest, TN *src1, TN *src2, INT16 variant, TYPE_ID mtype, OPS *ops);
...
extern void Expand_Misaligned_Load (OPCODE op, TN *result, TN *base, TN *disp, INT16 variant, OPS *ops);
extern void Expand_Misaligned_Store (TYPE_ID mtype, TN *obj_tn, TN *base_tn, TN *disp_tn, INT16 variant, OPS *ops);
extern void Expand_Lda_Label (TN *dest, TN *lab, OPS *ops);

/* in exp_branch: */
extern void Initialize_Branch_Variants(void);
extern void Expand_Branch ( TN *targ, TN *src1, TN *src2, INT16 variant, OPS *ops);
/* Check that compare is of proper form, and return TOP to use for 
 * the compare.  May modify the variant and src tns. */
extern TOP Pick_Compare_TOP (INT16 *variant, TN **src1, TN **src2, OPS *ops);
