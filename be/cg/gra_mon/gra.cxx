...
//  $Revision: 1.33 $
//  $Date: 2000/04/12 21:44:14 $
//  $Author: mtibuild $
//  $Source: /isms/cmplrs.src/osprey1.0/be/cg/gra_mon/RCS/gra.cxx,v $
...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/cg/gra_mon/RCS/gra.cxx,v $ $Revision: 1.33 $";
#endif
...
/////////////////////////////////////
REGISTER_SET
GRA_Local_Register_Grant( BB* bb, ISA_REGCLASS rc )
/////////////////////////////////////
//  See interface description.
/////////////////////////////////////
{
...
/////////////////////////////////////
{
  ...
  //if (Get_Trace(TKIND_IR, TP_GRA, BB_id(REGION_First_BB)))
  Trace_IR(TP_GRA, "GRA1", NULL);

  GRA_Spill();      // Actually add the spills.
  GRA_Delete();

  GRA_GRANT_Unused_Caller_Saved();
  GRA_GRANT_Avail_Callee_Saved();
