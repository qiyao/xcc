...
#define GRA_RCS_ID
#ifdef _KEEP_RCS_ID
static char *gra_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/cg/gra_mon/RCS/gra.h,v $ $Revision: 1.17 $";
#endif
#endif
...
#define DEFAULT_FORCED_LOCAL_MAX 1
