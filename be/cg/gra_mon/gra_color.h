...
//  $Revision: 1.3 $
//  $Date: 2000/04/12 21:44:43 $
//  $Author: mtibuild $
//  $Source: /isms/cmplrs.src/osprey1.0/be/cg/gra_mon/RCS/gra_color.h,v $
...
#ifdef _KEEP_RCS_ID
static char *gra_color_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/cg/gra_mon/RCS/gra_color.h,v $ $Revision: 1.3 $";
#endif
#endif
