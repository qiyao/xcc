...
//
//      void GRA_GRANT_Local_Register( GRA_BB* gbb, ISA_REGCLASS rc,
//                                                  REGISTER           reg )
...
//
//      void GRA_GRANT_Avail_Callee_Saved( void )
//
//          Grant any available callee saved registers to lra. These are registers
//          that are used somewhere in the PU, but not live inside the particular
//          bb
//
/////////////////////////////////////
...
//  $Revision: 1.8 $
//  $Date: 2000/04/12 21:45:02 $
//  $Author: mtibuild $
//  $Source: /isms/cmplrs.src/osprey1.0/be/cg/gra_mon/RCS/gra_grant.h,v $
...
#ifdef _KEEP_RCS_ID
static char *gra_grant_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/cg/gra_mon/RCS/gra_grant.h,v $ $Revision: 1.8 $";
#endif
#endif
...
extern bool
GRA_GRANT_Local_Register_Okay(BB *bb, ISA_REGCLASS rc, REGISTER reg );
extern REGISTER_SET 
