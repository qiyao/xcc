...
//  $Revision: 1.7 $
//  $Date: 2000/04/12 21:46:04 $
//  $Author: mtibuild $
//  $Source: /isms/cmplrs.src/osprey1.0/be/cg/gra_mon/RCS/gra_pref.h,v $
...
#ifdef _KEEP_RCS_ID
static char *gra_preference_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/cg/gra_mon/RCS/gra_pref.h,v $ $Revision: 1.7 $";
#endif
#endif
