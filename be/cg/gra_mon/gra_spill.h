...
#ifdef _KEEP_RCS_ID
static char *gra_spill_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/cg/gra_mon/RCS/gra_spill.h,v $ $Revision: 1.7 $";
#endif
#endif
...
extern void GRA_Divide_Glue_Code(void);
