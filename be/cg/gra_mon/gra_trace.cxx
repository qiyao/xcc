...
//  $Revision: 1.31 $
//  $Date: 2000/05/19 20:14:45 $
//  $Author: murthy $
//  $Source: /isms/cmplrs.src/osprey1.0/be/cg/gra_mon/RCS/gra_trace.cxx,v $
...
/////////////////////////////////////
void
GRA_Trace_Grant( GRA_BB* gbb, ISA_REGCLASS cl, REGISTER reg )
/////////////////////////////////////
//  See interface description.
/////////////////////////////////////
{
...
/////////////////////////////////////
void
GRA_Trace_Reject_Grant( GRA_BB* gbb, ISA_REGCLASS cl, REGISTER reg )
/////////////////////////////////////
//  See interface description.
/////////////////////////////////////
{
  if ( trace_grants ) {
    fprintf(TFile,"<gra> Preventing local register grant %s to BB%d\n",
                  REGISTER_name(cl,reg),BB_id(gbb->Bb()));
  }
}
...
/////////////////////////////////////
{
  if (trace_memory) {
    ...
    last_brk = sbrk(0);
#else
    fprintf(TFile, "memory tracing not supported on WIN NT");
#endif
  }
}
