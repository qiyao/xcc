...
//
//      void GRA_Trace_Grant( GRA_BB* gbb, ISA_REGCLASS cl, REGISTER reg )
//          Trace a grant of the register <reg> in class <cl> to <gbb> if
//          grants are being traced.
//
//      void GRA_Trace_Reject_Grant( GRA_BB* gbb, ISA_REGCLASS cl, REGISTER reg )
//          Trace a rejection of a grant of the register <reg> in class <cl> to <gbb> 
//          if grants are being traced.
//
...
//
//	void GRA_Trace_Regs_Stats( ISA_REGCLASS rc,
...
//  $Revision: 1.25 $
//  $Date: 2000/04/12 21:46:45 $
//  $Author: mtibuild $
//  $Source: /isms/cmplrs.src/osprey1.0/be/cg/gra_mon/RCS/gra_trace.h,v $
...
#ifdef _KEEP_RCS_ID
static char *gra_trace_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/cg/gra_mon/RCS/gra_trace.h,v $ $Revision: 1.25 $";
#endif
#endif
