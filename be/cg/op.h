 ...
 * Module: op.h
 * $Revision: 3.140 $
 * $Date: 2000/08/31 23:36:48 $
 * $Author: mpm $
 * $Source: /isms/cmplrs.src/osprey1.0/be/cg/RCS/op.h,v $
 *
 ...
 *         Also, Xtensa has ops with large numbers of fixed operands (to represent
 *         state, etc.). So could have an op that exceeds these limits that is
 *         not variable (but the OP is still created correctly, of course).
 *
 *     Accessors:
 ...
 *
 *   BOOL OP_Defs_Reg(const OP *op, ISA_REGCLASS rclass, REGISTER reg)
 *   BOOL OP_Refs_Reg(const OP *op, ISA_REGCLASS rclass, REGISTER reg)
 ...
 *
 * xtensa has ops with large numbers of fixed operands (to represent
 * state, etc.). So could have an op that exceeds these limits that is
 * not variable (but the OP is still created correctly, of course).
 */
#define OP_MAX_FIXED_OPNDS	4
#define OP_MAX_FIXED_RESULTS	2
...
typedef struct op {
  ...
  mINT8         format_num;     /* bundle format number */
  mINT8         slot_num;       /* bundle slot number */
  mUINT8	unrolling;	/* which unrolled replication (if any) */
  mUINT8	results;	/* Number of results */
  mUINT8	opnds;		/* Number of operands */
  mINT32	profile_bb_id;	/* id of the basic block at point of cg profiling */
  union {
    struct tn  *spill_tn;       /* for spill/restore (store/load) */
  } u1;
...
#ifdef Is_True_On
#define INDEX_OK(n,m) (Is_True((((UINT)(n))<(m)),("Index out of range")),(n))
#else
#define INDEX_OK(n,m) (n)
#endif
...
#define OP_profile_bb_id(o)	((TOP)((o)->profile_bb_id+0))
#define OP_format_num(o)	((o)->format_num+0)
#define OP_slot_num(o)	((o)->slot_num+0)
#define OP_bb(o)	((o)->bb+0)
#define OP_results(o)	((o)->results+0)
#define OP_opnds(o)	((o)->opnds+0)
#define OP_code(o)	((TOP)((o)->opr+0))
#define OP_result(o,n)	((struct tn *)(o)->res_opnd[(INDEX_OK(n,OP_results(o)))+OP_result_offset(o)])
#define OP_opnd(o,n)	((struct tn *)(o)->res_opnd[(INDEX_OK(n,OP_opnds(o)))+OP_opnd_offset(o)])
#define OP_spill_tn(o)  ((o)->u1.spill_tn + 0)
...
#define Set_OP_profile_bb_id(op,id)	((op)->profile_bb_id = (id))
#define Set_OP_format_num(op,u)	((op)->format_num = (u))
#define Set_OP_slot_num(op,u)	((op)->slot_num = (u))
...
#define Set_OP_code(o,top) ((o)->opr = (top))
#define Set_OP_spill_tn(o,tn)  ((o)->u1.spill_tn = (tn))
...
#define OP_MASK_NO_FUSION 	  0x8000 /* OP can't be used in a fusion */
#define OP_MASK_IS_LOADCONST  0x10000 /* is OP expanded from a load_const ? */
#define OP_MASK_NO_GENERIC    0x20000 /* when set, don't make OP generic */
...
# define OP_no_fusion(o)		(OP_flags(o) & OP_MASK_NO_FUSION)
# define Set_OP_no_fusion(o)	(OP_flags(o) |= OP_MASK_NO_FUSION)
# define Reset_OP_no_fusion(o) 	(OP_flags(o) &= ~OP_MASK_NO_FUSION)
# define OP_is_load_const(o)       (OP_flags(o) & OP_MASK_IS_LOADCONST)
# define Set_OP_is_load_const(o)   (OP_flags(o) |= OP_MASK_IS_LOADCONST)
# define Reset_OP_is_load_const(o) (OP_flags(o) &= ~OP_MASK_IS_LOADCONST) 
# define OP_is_no_generic(o)       (OP_flags(o) & OP_MASK_NO_GENERIC)
# define Set_OP_no_generics(o)     (OP_flags(o) |= OP_MASK_NO_GENERIC)
# define Reset_OP_no_generic(o)    (OP_flags(o) &= ~OP_MASK_NO_GENERIC) 



extern BOOL OP_cond_def( const OP*);
extern BOOL OP_has_implicit_interactions(OP*);
extern BOOL OP_noop(const OP*);

/* Convenience access macros for properties of the OP */
/* TODO: define all the macros for OP properties. */
#define OP_tie(o)		(TI_ISA_Property_Is_Tie(OP_code(o)))
#define OP_load(o)		(TI_ISA_Property_Set(PROP_load, OP_code(o)) && \
                                 (!OP_is_load_const(o)))
#define OP_store(o)		(TI_ISA_Property_Set(PROP_store, OP_code(o)))
#define OP_prefetch(o)		(TI_ISA_Property_Set(PROP_prefetch, OP_code(o)))
#define OP_memory(o)		(OP_load(o) | OP_store(o) | OP_prefetch(o))
#define OP_mem_fill_type(o)     (TI_ISA_Property_Set(PROP_mem_fill_type, OP_code(o)))
#define OP_call(o)		(TI_ISA_Property_Set(PROP_call, OP_code(o)))
#define OP_xfer(o)		(TI_ISA_Property_Set(PROP_xfer, OP_code(o)))
#define OP_cond(o)		(TI_ISA_Property_Set(PROP_cond, OP_code(o)))
#define OP_likely(o)		(TI_ISA_Property_Set(PROP_likely, OP_code(o)))
#define OP_dummy(o)		(TI_ISA_Property_Set(PROP_dummy, OP_code(o)))
#define OP_pseudo(o)		((OP_code(o))==TOP_extw_pseudo || \
				 (OP_code(o))==TOP_memw_pseudo)
#define OP_flop(o)		(TI_ISA_Property_Set(PROP_flop, OP_code(o)))
#define OP_fadd(o)		(TI_ISA_Property_Set(PROP_fadd, OP_code(o)))
#define OP_fdiv(o)		(TI_ISA_Property_Set(PROP_fdiv, OP_code(o)))
#define OP_fmul(o)		(TI_ISA_Property_Set(PROP_fmul, OP_code(o)))
#define OP_fmisc(o)		(TI_ISA_Property_Set(PROP_fmisc, OP_code(o)))
#define OP_fsub(o)		(TI_ISA_Property_Set(PROP_fsub, OP_code(o)))
#define OP_iadd(o)		(TI_ISA_Property_Set(PROP_iadd, OP_code(o)))
#define OP_ior(o)		(TI_ISA_Property_Set(PROP_ior, OP_code(o)))
#define OP_ixor(o)		(TI_ISA_Property_Set(PROP_ixor, OP_code(o)))
#define OP_iand(o)		(TI_ISA_Property_Set(PROP_iand, OP_code(o)))
#define OP_icmp(o)		(TI_ISA_Property_Set(PROP_icmp, OP_code(o)))
#define OP_idiv(o)		(TI_ISA_Property_Set(PROP_idiv, OP_code(o)))
#define OP_imul(o)		(TI_ISA_Property_Set(PROP_imul, OP_code(o)))
#define OP_isub(o)		(TI_ISA_Property_Set(PROP_isub, OP_code(o)))
#define OP_madd(o)		(TI_ISA_Property_Set(PROP_madd, OP_code(o)))
#define OP_sqrt(o)		(TI_ISA_Property_Set(PROP_sqrt, OP_code(o)))
#define OP_mmmul(o)		(TI_ISA_Property_Set(PROP_mmmul, OP_code(o)))
#define OP_mmshf(o)		(TI_ISA_Property_Set(PROP_mmshf, OP_code(o)))
#define OP_mmalu(o)		(TI_ISA_Property_Set(PROP_mmalu, OP_code(o)))
#define OP_select(o)		(TI_ISA_Property_Set(PROP_select, OP_code(o)))
#define OP_cond_move(o)		(TI_ISA_Property_Set(PROP_cond_move, OP_code(o)))
#define OP_has_multireg_operand(o)	(TI_ISA_Property_Set(PROP_has_multireg_operand, OP_code(o)))
#define OP_uniq_res(o)		(TI_ISA_Property_Set(PROP_uniq_res, OP_code(o)))
#define OP_unalign_ld(o)	(TI_ISA_Property_Set(PROP_unalign_ld, OP_code(o)))
#define OP_unalign_store(o)	(TI_ISA_Property_Set(PROP_unalign_store, OP_code(o)))
#define OP_unalign_mem(o)	(OP_unalign_ld(o) | OP_unalign_store(o))
#define OP_unknown_memdata(o)	(TI_ISA_Property_Set(PROP_unknown_memdata, OP_code(o)))
#define OP_unknown_addr(o)	(TI_ISA_Property_Set(PROP_unknown_addr, OP_code(o)))
#define OP_defs_fcc(o)		(TI_ISA_Property_Set(PROP_defs_fcc, OP_code(o)))
#define OP_defs_fcr(o)		(TI_ISA_Property_Set(PROP_defs_fcr, OP_code(o)))
#define OP_defs_fpu_int(o)	(TI_ISA_Property_Set(PROP_defs_fpu_int, OP_code(o)))
#define OP_defs_fp(o)		(TI_ISA_Property_Set(PROP_defs_fp, OP_code(o)))
#define OP_refs_fcr(o)		(TI_ISA_Property_Set(PROP_refs_fcr, OP_code(o)))
#define OP_unsafe(o)            (TI_ISA_Property_Set(PROP_unsafe, OP_code(o)))
#define OP_jump(o)		(TI_ISA_Property_Set(PROP_jump, OP_code(o)))
#define OP_ijump(o)		(TI_ISA_Property_Set(PROP_ijump, OP_code(o)))
#define OP_f_group(o)           (TI_ISA_Property_Set(PROP_f_group, OP_code(o)))
#define OP_l_group(o)           (TI_ISA_Property_Set(PROP_l_group, OP_code(o)))
#define OP_privileged(o)        (TI_ISA_Property_Set(PROP_privileged, OP_code(o)))
#define OP_simulated(o)		(TI_ISA_Property_Set(PROP_simulated, OP_code(o)))
#define OP_generic(o)		(TI_ISA_Property_Set(PROP_generic, OP_code(o)))
#define OP_has_predicate(o)	(TI_ISA_Property_Set(PROP_predicated, OP_code(o)))
#define OP_access_reg_bank(o)	(TI_ISA_Property_Set(PROP_access_reg_bank, OP_code(o)))
#define OP_extern_effects(o)	(TI_ISA_Property_Set(PROP_extern_effects, OP_code(o)))
#define OP_side_effects(o)	(TI_ISA_Property_Set(PROP_side_effects, OP_code(o)))
#define OP_branch_predict(o)	(TI_ISA_Property_Set(PROP_branch_predict, OP_code(o)))
#define OP_var_opnds(o)		(TI_ISA_Property_Set(PROP_var_opnds, OP_code(o)))
#define OP_loop_start(o)	(TI_ISA_Property_Set(PROP_loop_start, OP_code(o)))
#define OP_uncond(o)            (OP_xfer(o) && !OP_cond(o))
#define OP_base_update(o)	(TI_ISA_Property_Set(PROP_base_update, OP_code(o)))

#define OP_operand_info(o)	(TI_ISA_Operand_Info(OP_code(o)))
#define OP_has_hazard(o)	(TI_ISA_Top_Has_Hazard(OP_code(o)))
#define OP_immediate_opnd(o)	(TI_TOP_Immediate_Operand(OP_code(o),NULL))
#define OP_has_immediate(o)	(OP_immediate_opnd(o) >= 0)
#define OP_inst_bytes(o)	(TI_ISA_Inst_Bytes(OP_code(o)))
#define OP_find_opnd_use(o,u)	(TI_TOP_Find_Operand_Use(OP_code(o),(u)))
#define OP_stream_get(o)	(TI_TOP_Stream_Get(OP_code(o)))
#define OP_stream_put(o)	(TI_TOP_Stream_Put(OP_code(o)))
#define OP_stream_op(o)		(OP_stream_get(o) || OP_stream_put(o))

inline INT OP_result_size(OP *op, INT result)
{
  const ISA_OPERAND_INFO *oinfo = TI_ISA_Operand_Info(OP_code(op));
  const ISA_OPERAND_VALTYP *otype = TI_ISA_Op_Result(oinfo, result);
  return TI_ISA_Valtyp_Size(otype);
}

inline INT OP_opnd_size(OP *op, INT opnd)
{
  const ISA_OPERAND_INFO *oinfo = TI_ISA_Operand_Info(OP_code(op));
  const ISA_OPERAND_VALTYP *otype = TI_ISA_Op_Operand(oinfo, opnd);
  return TI_ISA_Valtyp_Size(otype);
}
...
inline BOOL OP_result_is_reg(OP *op, INT result)
{
  const ISA_OPERAND_INFO *oinfo = TI_ISA_Operand_Info(OP_code(op));
  const ISA_OPERAND_VALTYP *otype = TI_ISA_Op_Result(oinfo, result);
  return TI_ISA_Valtyp_Is_Register(otype);
}
...
inline BOOL OP_opnd_is_literal(OP *op, INT opnd)
{
  const ISA_OPERAND_INFO *oinfo = TI_ISA_Operand_Info(OP_code(op));
  const ISA_OPERAND_VALTYP *otype = TI_ISA_Op_Operand(oinfo, opnd);
  return TI_ISA_Valtyp_Is_Literal(otype);
}
...
inline BOOL OP_opnd_is_enum(OP *op, INT opnd)
{
  const ISA_OPERAND_INFO *oinfo = TI_ISA_Operand_Info(OP_code(op));
  const ISA_OPERAND_VALTYP *otype = TI_ISA_Op_Operand(oinfo, opnd);
  return TI_ISA_Valtyp_Is_Enum(otype);
}
...
inline BOOL OP_result_is_signed(OP *op, INT result)
{
  const ISA_OPERAND_INFO *oinfo = TI_ISA_Operand_Info(OP_code(op));
  const ISA_OPERAND_VALTYP *otype = TI_ISA_Op_Result(oinfo, result);
  return TI_ISA_Valtyp_Is_Signed(otype);
}
...
inline BOOL OP_result_is_fpu_int(OP *op, INT result)
{
  const ISA_OPERAND_INFO *oinfo = TI_ISA_Operand_Info(OP_code(op));
  const ISA_OPERAND_VALTYP *otype = TI_ISA_Op_Result(oinfo, result);
  return TI_ISA_Valtyp_Is_FPU_Int(otype);
}
...
inline BOOL OP_opnd_is_pcrel(OP *op, INT opnd)
{
  const ISA_OPERAND_INFO *oinfo = TI_ISA_Operand_Info(OP_code(op));
  const ISA_OPERAND_VALTYP *otype = TI_ISA_Op_Operand(oinfo, opnd);
  return TI_ISA_Valtyp_Is_PCRel(otype);
}

inline ISA_LITCLASS OP_opnd_lit_class(OP *op, INT opnd)
{
  const ISA_OPERAND_INFO *oinfo = TI_ISA_Operand_Info(OP_code(op));
  const ISA_OPERAND_VALTYP *otype = TI_ISA_Op_Operand(oinfo, opnd);
  return TI_ISA_Valtyp_Litclass(otype);
}

inline ISA_REGCLASS OP_opnd_reg_class(OP *op, INT opnd)
{
  const ISA_OPERAND_INFO *oinfo = TI_ISA_Operand_Info(OP_code(op));
  const ISA_OPERAND_VALTYP *otype = TI_ISA_Op_Operand(oinfo, opnd);
  return TI_ISA_Valtyp_Regclass(otype);
}

inline ISA_REGCLASS OP_result_reg_class(OP *op, INT opnd)
{
  const ISA_OPERAND_INFO *oinfo = TI_ISA_Operand_Info(OP_code(op));
  const ISA_OPERAND_VALTYP *otype = TI_ISA_Op_Result(oinfo, opnd);
  return TI_ISA_Valtyp_Regclass(otype);
}

inline ISA_REGSUBCLASS OP_opnd_reg_subclass(OP *op, INT opnd)
{
  const ISA_OPERAND_INFO *oinfo = TI_ISA_Operand_Info(OP_code(op));
  const ISA_OPERAND_VALTYP *otype = TI_ISA_Op_Operand(oinfo, opnd);
  return TI_ISA_Valtyp_Regsubclass(otype);
}

inline ISA_REGSUBCLASS OP_result_reg_subclass(OP *op, INT opnd)
{
  const ISA_OPERAND_INFO *oinfo = TI_ISA_Operand_Info(OP_code(op));
  const ISA_OPERAND_VALTYP *otype = TI_ISA_Op_Result(oinfo, opnd);
  return TI_ISA_Valtyp_Regsubclass(otype);
...
{
  const ISA_OPERAND_INFO *oinfo = TI_ISA_Operand_Info(OP_code(op));
  return TI_ISA_Op_Operand_Use(oinfo, opnd);
}
 ...
 */
#define TOP_fixed_results(o)	(TI_ISA_Op_Results(TI_ISA_Operand_Info(o)))
#define TOP_fixed_opnds(o)	(TI_ISA_Op_Operands(TI_ISA_Operand_Info(o)))
...
/* Determine if the op defines/references the given register. */
extern BOOL OP_Defs_Reg(const OP *op, ISA_REGCLASS rclass, REGISTER reg);
extern BOOL OP_Refs_Reg(const OP *op, ISA_REGCLASS rclass, REGISTER reg);
...
inline void OP_Change_Opcode(OP *op, TOP opc)
{
  Is_True(   OP_fixed_results(op) == TOP_fixed_results(opc)
	  ...
	  ("different number of results/operands for %s and %s",
	   TI_TOP_Name(OP_code(op)), TI_TOP_Name(opc)));
  Is_True(OP_var_opnds(op) == TI_ISA_Property_Set(PROP_var_opnds, opc),
...
/* Count the number of real ops/instruction-bytes emitted by the op.
 */
extern INT16 OP_Real_Ops( const OP *op );
extern INT OP_Real_Inst_Bytes( const OP *op );
...
extern INT32 Op_Sameres_Operand (OP *op, INT32 result_index);
extern INT32 Op_Sameres_Result (OP *op, INT32 operand_index);
