...
static const char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/cg/RCS/op_map.cxx,v $ $Revision: 1.29 $";
#endif /* _KEEP_RCS_ID */
 ...
 */
{
  ...
  for (op = BB_first_op(bb); op; op = OP_next(op)) {
    /* OP_map_idx result is unsigned, so no need to check if positive */
