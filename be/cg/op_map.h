 ...
 *  Module: op_map.h
 *  $Revision: 1.18 $
 *  $Date: 2000/08/31 23:36:55 $
 *  $Author: mpm $
 *  $Source: /isms/cmplrs.src/osprey1.0/be/cg/RCS/op_map.h,v $
 *
 *  Revision comments:
 *
...
typedef enum { x_PTR, _I32, _I64, _DELETED } _OP_MAP_KIND;

extern OP_MAP _OP_MAP_Create(_OP_MAP_KIND kind);
#define OP_MAP_Create() _OP_MAP_Create(x_PTR)
...
#define BB_OP_MAP_Create(bb, pool)   BB_OP_MAP_Create_Kind((bb), (pool), x_PTR)
...
inline void BB_OP_MAP_Set(BB_OP_MAP map, OP *op, void *value)
{
  ...
  Is_True(map->kind == x_PTR, ("OP_MAP is of wrong kind"));
