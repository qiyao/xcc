...
/* hTN_MAP's iterator */
typedef struct htn_map_iterator *hTN_MAP_ITERATOR;
extern hTN_MAP_ITERATOR htn_map_iterator_create (hTN_MAP map);
extern BOOL is_htn_map_iterator_empty(hTN_MAP_ITERATOR iter);
extern TN *get_htn_map_iterator_tn (hTN_MAP_ITERATOR iter);
extern void *get_htn_map_iterator_value (hTN_MAP_ITERATOR iter);
extern void htn_map_iterator_next(hTN_MAP_ITERATOR iter);
