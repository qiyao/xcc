...
#ifdef _KEEP_RCS_ID
static const char rcs_id[] = "$Source: /isms/cmplrs.src/osprey1.0/be/cg/RCS/variants.cxx,v $ $Revision: 1.6 $";
#endif /* _KEEP_RCS_ID */
...
Negate_BR_Variant(INT variant)
{
  ...
  case V_BR_ALL_BITS_SET:   variant = V_BR_ANY_BIT_CLEAR;  break;
  case V_BR_ALL_BITS_CLEAR: variant = V_BR_ANY_BIT_SET;    break;
  case V_BR_ANY_BIT_SET:    variant = V_BR_ALL_BITS_CLEAR; break;
  case V_BR_ANY_BIT_CLEAR:  variant = V_BR_ALL_BITS_SET;   break;
  case V_BR_BIT_SET:        variant = V_BR_BIT_CLEAR;      break;
  case V_BR_BIT_CLEAR:      variant = V_BR_BIT_SET;        break;
...
Invert_BR_Variant(INT variant)
{
  ...
  case V_BR_BIT_SET:
  case V_BR_BIT_CLEAR:
    // these branches are not compares, so swapping operands
    // makes no sense.
    break;
...
BR_Variant_Name(INT variant)
{
  ...
  case V_BR_ALL_BITS_SET:   return is_false?"!ALL_BITS_SET"  :"ALL_BITS_SET";
  case V_BR_ALL_BITS_CLEAR: return is_false?"!ALL_BITS_CLEAR":"ALL_BITS_CLEAR";
  case V_BR_ANY_BIT_SET:    return is_false?"!ANY_BIT_SET"   :"ANY_BIT_SET";
  case V_BR_ANY_BIT_CLEAR:  return is_false?"!ANY_BIT_CLEAR" :"ANY_BIT_CLEAR";
  case V_BR_BIT_SET:        return is_false?"!BIT_SET"       :"BIT_SET";
  case V_BR_BIT_CLEAR:      return is_false?"!BIT_CLEAR"     :"BIT_CLEAR";
  }
