...
#ifdef _KEEP_RCS_ID
static const char variants_rcs_id[] = "$Source: /isms/cmplrs.src/osprey1.0/be/cg/RCS/variants.h,v $ $Revision: 1.30 $";
#endif /* _KEEP_RCS_ID */
...
#define V_BR_ALL_BITS_SET   79	/* All mask bits are set */
#define V_BR_ALL_BITS_CLEAR 80	/* All mask bits are clear */
#define V_BR_ANY_BIT_SET    81	/* Any mask bit is set */
#define V_BR_ANY_BIT_CLEAR  82	/* Any mask bit is clear */
#define V_BR_BIT_SET        83	/* Specified bit is set */
#define V_BR_BIT_CLEAR      84	/* Specified bit is clear */
 ...
 */
extern INT Negate_BR_Variant(INT variant);

/*
 * Invert a branch variant (also see Negate_BR_Variant)
 */
extern INT Invert_BR_Variant(INT variant);

/*
 * Return the name of a branch variant
 */
extern const char *BR_Variant_Name(INT variant);
...
#define	Get_alignment(o)		((o) & V_ALIGNMENT)
#define Get_align_offset(o)		(((o) & V_ALIGN_OFFSET) >> 4)
#define Get_align_offset_unknown(o)	((o) & V_ALIGN_OFFSET_UNKNOWN)
#define Get_align_offset_known(o)	(!Get_align_offset_unknown(o))

#define	Set_alignment(o,a)		((o) = ((o) & ~V_ALIGNMENT) | ((a)&0xf))
#define Set_align_offset(o,a)		((o) = ((o) & ~V_ALIGN_OFFSET) | (((a)&0xf)<<4))
#define	Set_align_offset_unknown(o)	((o) = (o) |= V_ALIGN_OFFSET_UNKNOWN)
#define Set_align_offset_known(o)	((o) &= ~V_ALIGN_OFFSET_UNKNOWN)
#define Reset_alignment(o)		((o) &= ~V_ALIGN_ALL)
...
#define	Get_normalized_op1(o)		((o) & V_NORMALIZED_OP1)
#define	Get_normalized_op2(o)		((o) & V_NORMALIZED_OP2)

#define Set_normalized_op1(o)		((o)= ((o) | V_NORMALIZED_OP1))
#define Set_normalized_op2(o)		((o)= ((o) | V_NORMALIZED_OP2))
...
/* ====================================================================
 * Intrinsic call <id> for TOP_intrncall.
 * ====================================================================
 */
#define OP_intrinsic_id(o)	(OP_variant(o))
