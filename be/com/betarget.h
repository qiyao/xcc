 ...
 * Module: betarget.h
 * $Revision: 1.6 $
 * $Date: 2000/04/06 01:54:46 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/be/com/RCS/betarget.h,v $
 *
...
#ifdef _KEEP_RCS_ID
static const char betarget_rcs_id[] = "$Source: /isms/cmplrs.src/osprey1.0/be/com/RCS/betarget.h,v $ $Revision: 1.6 $";
#endif /* _KEEP_RCS_ID */
...
extern void Delete_Offset_Wn_Delete_Tree(WN* wn);

// largest offset possible in small-frame stack model
extern DLL_SHARED const INT Max_Small_Frame_Offset;

extern DLL_SHARED BOOL Targ_Lower_Float_To_Unsigned;
extern DLL_SHARED BOOL Targ_Lower_Unsigned_To_Float;
