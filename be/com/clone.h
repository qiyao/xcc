...
private:
  ...
  INT32 _asm_neg_preg_adjustment;// adjustment for ASM output registers
                                 // during inlining
...
public:
  ...
  IPO_CLONE (WN_MAP_TAB *caller, 
	     ...
	     IPO_SYMTAB *cloned_symtab=NULL,
             ...
             BOOL same_file=TRUE,
             mUINT16 filenum=0,
	     INT32 asm_neg_preg_adjustment=0) :
    ...
    _asm_neg_preg_adjustment(asm_neg_preg_adjustment)
  {
  };
