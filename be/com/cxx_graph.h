...
#ifdef _KEEP_RCS_ID
static char *cxx_graph_rcs_id = cxx_graph_INCLUDED "$Revision: 1.8 $";
#endif /* _KEEP_RCS_ID */
...
extern DLL_SHARED const VINDEX16 INVALID_VINDEX16;
extern DLL_SHARED VINDEX16 GRAPH16_CAPACITY;
