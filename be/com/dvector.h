...
/** $Revision: 1.21 $
*** $Date: 2000/04/06 01:56:19 $
*** $Author: mtibuild $
*** $Source: /isms/cmplrs.src/osprey1.0/be/com/RCS/dvector.h,v $
**/

#ifndef ND_RCS_ID
#define ND_RCS_ID
#ifdef _KEEP_RCS_ID
static char *dvector_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/com/RCS/dvector.h,v $ $Revision: 1.21 $";
#endif /* _KEEP_RCS_ID */
#endif
