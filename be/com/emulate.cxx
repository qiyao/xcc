...
//depot/dev/mongoose/osprey1.0/be/com/emulate.cxx#1 - add change 23018 (text)
/*
...
#if defined(__sun__)
//
// Provide trunc(), which doesn't exist in the Solaris C library. This is a
...
typedef enum
{
  EM_L_MPY,		/* 32 bit multiply */
  EM_L_MPY_HIFI2,       /* 32 bit multiply on Xtensa HiFi2 */
  EM_L_DIV,		/* 32 bit divide */
  EM_L_REM,		/* 32 bit rem */
  EM_UL_DIV,		/* unsigned 32 bit divide */
  EM_UL_REM,		/* unsigned 32 bit rem */
  EM_L_TO_F,            /* convert 32 bit to float */
  EM_UL_TO_F,           /* convert 32 bit unsigned to float */
  EM_L_TO_D,            /* convert 32 bit to double */
  EM_UL_TO_D,           /* convert 32 bit unsigned to double */
  EM_F_TO_L,            /* convert float to 32 bit */
  EM_D_TO_L,            /* convert double to 32 bit */
  EM_F_TO_UL,           /* convert float to unsigned 32 bit */
  EM_D_TO_UL,           /* convert double to unsigned 32 bit */
  ...
  EM_LL_LSHR,		/* double-word logical shift right */
  EM_LL_ASHR,		/* double-word arithmetic shift right */
  EM_LL_SHL,		/* double-word shift left */
  EM_LL_TO_F,		/* cvt double-word to float */
  EM_ULL_TO_F,		/* cvt unsigned double-word to float */
  EM_LL_TO_D,		/* cvt double-word to double */
  EM_ULL_TO_D,		/* cvt unsigned double-word to double */
  EM_F_TO_LL,		/* cvt float to double-word */
  EM_D_TO_LL,		/* cvt double to double-word */
  EM_F_TO_ULL,		/* cvt float to unsigned double-word */
  EM_D_TO_ULL,		/* cvt double to unsigned double-word */

  EM_D_ABS,		/* double abs */
  EM_D_SQRT,		/* double sqrt */
  EM_D_ADD,		/* double add */
  EM_D_SUB,		/* double sub */
  EM_D_MPY,		/* double mulitply */
  EM_D_DIV,		/* double divide */
  EM_D_NEG,		/* double negation */
  EM_D_EQ,		/* double equal */
  EM_D_NE,		/* double not equal */
  EM_D_GE,		/* double greater equal */
  EM_D_GT,		/* double greater than */
  EM_D_LE,		/* double less equal */
  EM_D_LT,		/* double less than */
  EM_D_TO_F,            /* convert double to float */
  EM_F_TO_D,            /* convert float to double */

  EM_F_ABS,		/* float abs */
  EM_F_SQRT,		/* float sqrt */
  EM_F_ADD,		/* float add */
  EM_F_SUB,		/* float sub */
  EM_F_MPY,		/* float mulitply */
  EM_F_DIV,		/* float divide */
  EM_F_NEG,		/* float negation */
  EM_F_EQ,		/* float equal */
  EM_F_NE,		/* float not equal */
  EM_F_GE,		/* float greater equal */
  EM_F_GT,		/* float greater than */
  EM_F_LE,		/* float less equal */
  EM_F_LT,		/* float less than */
...
**	
**      COERCE_double
**              xtensa needs this because the gnu math library doesn't
**              have an absolute value for float (fabs takes and
**              returns double). So to use fabs for F4ABS we must
**              convert inputs and output to double. Once we start
**              using a better math library we can get rid of this
**
**
...
{
  EM_L_MPY,         "__mulsi3",      PURE_NSE, COERCE_none,
  EM_L_MPY_HIFI2,   "__mulsi3hifi2", PURE_NSE, COERCE_none,
  EM_L_DIV,         "__divsi3",      PURE_NSE, COERCE_none,
  EM_L_REM,         "__modsi3",      PURE_NSE, COERCE_none,
  EM_UL_DIV,        "__udivsi3",     PURE_NSE, COERCE_none,
  EM_UL_REM,        "__umodsi3",     PURE_NSE, COERCE_none,
  EM_L_TO_F,        "__floatsisf",   PURE_NSE, COERCE_none,
  EM_UL_TO_F,       "__floatunsisf", PURE_NSE, COERCE_none,
  EM_L_TO_D,        "__floatsidf",   PURE_NSE, COERCE_none,
  EM_UL_TO_D,       "__floatunsidf", PURE_NSE, COERCE_none,
  EM_F_TO_L,        "__fixsfsi",     PURE_NSE, COERCE_none,
  EM_D_TO_L,        "__fixdfsi",     PURE_NSE, COERCE_none,
  EM_F_TO_UL,       "__fixunssfsi",  PURE_NSE, COERCE_none,
  EM_D_TO_UL,       "__fixunsdfsi",  PURE_NSE, COERCE_none,

  EM_LL_MUL,        "__muldi3",      PURE_NSE,  COERCE_none,
  EM_LL_DIV,        "__divdi3",      PURE_NSE,  COERCE_none,
  EM_LL_REM,        "__moddi3",      PURE_NSE,  COERCE_none,
  EM_ULL_DIV,       "__udivdi3",     PURE_NSE,  COERCE_none,
  EM_ULL_REM,       "__umoddi3",     PURE_NSE,  COERCE_none,
  EM_LL_LSHR,       "__lshrdi3",     PURE_NSE,  COERCE_none,
  EM_LL_ASHR,       "__ashrdi3",     PURE_NSE,  COERCE_none,
  EM_LL_SHL,        "__ashldi3",     PURE_NSE,  COERCE_none,
  EM_LL_TO_F,       "__floatdisf",   PURE_NSE,  COERCE_none,
  EM_ULL_TO_F,      "__floatundisf", PURE_NSE,  COERCE_none,
  EM_LL_TO_D,       "__floatdidf",   PURE_NSE,  COERCE_none,
  EM_ULL_TO_D,      "__floatundidf", PURE_NSE,  COERCE_none,
  EM_F_TO_LL,       "__fixsfdi",     PURE_NSE,  COERCE_none,
  EM_D_TO_LL,       "__fixdfdi",     PURE_NSE,  COERCE_none,
  EM_F_TO_ULL,      "__fixunssfdi",  PURE_NSE,  COERCE_none,
  EM_D_TO_ULL,      "__fixunsdfdi",  PURE_NSE,  COERCE_none,

  EM_D_ABS,         "__absdf2",         PURE_NSE,  COERCE_none,
  EM_D_SQRT,        "sqrt",    PURE_NSE,  COERCE_none,
  EM_D_ADD,         "__adddf3",     PURE_NSE,  COERCE_none,
  EM_D_SUB,         "__subdf3",     PURE_NSE,  COERCE_none,
  EM_D_MPY,         "__muldf3",     PURE_NSE,  COERCE_none,
  EM_D_DIV,         "__divdf3",     PURE_NSE,  COERCE_none,
  EM_D_NEG,         "__negdf2",     PURE_NSE,  COERCE_none,
  EM_D_EQ,	    "__eqdf2",      PURE_NSE,  COERCE_none,
  EM_D_NE,	    "__nedf2",      PURE_NSE,  COERCE_none,
  EM_D_GE,	    "__gedf2",      PURE_NSE,  COERCE_none,
  EM_D_GT,	    "__gtdf2",      PURE_NSE,  COERCE_none,
  EM_D_LE,	    "__ledf2",      PURE_NSE,  COERCE_none,
  EM_D_LT,	    "__ltdf2",      PURE_NSE,  COERCE_none,
  EM_D_TO_F,        "__truncdfsf2", PURE_NSE,  COERCE_none,
  EM_F_TO_D,        "__extendsfdf2",  PURE_NSE,  COERCE_none,

  EM_F_ABS,         "__abssf2",     PURE_NSE,  COERCE_none,
  EM_F_SQRT,        "sqrtf",    PURE_NSE,  COERCE_none,
  EM_F_ADD,         "__addsf3",     PURE_NSE,  COERCE_none,
  EM_F_SUB,         "__subsf3",     PURE_NSE,  COERCE_none,
  EM_F_MPY,         "__mulsf3",     PURE_NSE,  COERCE_none,
  EM_F_DIV,         "__divsf3",     PURE_NSE,  COERCE_none,
  EM_F_NEG,         "__negsf2",     PURE_NSE,  COERCE_none,
  EM_F_EQ,	    "__eqsf2",      PURE_NSE,  COERCE_none,
  EM_F_NE,	    "__nesf2",      PURE_NSE,  COERCE_none,
  EM_F_GE,	    "__gesf2",      PURE_NSE,  COERCE_none,
  EM_F_GT,	    "__gtsf2",      PURE_NSE,  COERCE_none,
  EM_F_LE,	    "__lesf2",      PURE_NSE,  COERCE_none,
  EM_F_LT,	    "__ltsf2",      PURE_NSE,  COERCE_none,
};
...
extern bool   OP_is_emulated(OPCODE op, OPERATOR opr, 
			     bool kid1_is_integer_constant);
...
extern PREG_NUM AssignExprToPreg(WN *block, WN *tree, PREG_NUM destNo, 
				 TYPE_ID destType);
...
* ====================================================================
*/
static EMULATION Get_emulation(OPCODE op, OPERATOR opr, 
			       bool kid1_is_integer_constant);
...
/* ====================================================================
 *
 * EMULATION Get_emulation(OPCODE op, OPERATOR opr,
 *                         bool kid1_is_integer_constant)
 *
 * Provide the correct emulation enum based on 'op', 'opr' and 'kid1'
 *
  ...
  switch( op ) 
    {
      /* int cases */
    case OPC_U4MPY:
    case OPC_I4MPY:	return (Enable_HiFi2_Ops && !xt_mul16 && !xt_mac16) ?
			  EM_L_MPY_HIFI2 : EM_L_MPY;
    case OPC_I4DIV:	return EM_L_DIV;
    case OPC_I4REM:	return EM_L_REM;
    case OPC_U4DIV:	return EM_UL_DIV;
    case OPC_U4REM:	return EM_UL_REM;
    case OPC_F4I4CVT:   return (xt_hard_float ? EM_LAST : EM_L_TO_F);
    case OPC_F4U4CVT:   return (xt_hard_float ? EM_LAST : EM_UL_TO_F);
    case OPC_F8I4CVT:   return EM_L_TO_D;
    case OPC_F8U4CVT:   return EM_UL_TO_D;
    case OPC_I4F4TRUNC:
    case OPC_I4F4CVT:   return (xt_hard_float ? EM_LAST : EM_F_TO_L);
    case OPC_I4F8TRUNC:
    case OPC_I4F8CVT:   return EM_D_TO_L;
    case OPC_U4F4TRUNC:
    case OPC_U4F4CVT:   return (xt_hard_float ? EM_LAST : EM_F_TO_UL);
    case OPC_U4F8TRUNC:
    case OPC_U4F8CVT:   return EM_D_TO_UL;

      /* long long cases */
    case OPC_U8MPY:
    case OPC_I8MPY:	return EM_LL_MUL;
    case OPC_I8DIV:	return EM_LL_DIV;
    case OPC_I8REM:     return EM_LL_REM;
    case OPC_U8DIV:	return EM_ULL_DIV;
    case OPC_U8REM:     return EM_ULL_REM;
    case OPC_U8SHL:
    case OPC_I8SHL:     
      return (kid1_is_integer_constant ? EM_LAST : EM_LL_SHL);
    case OPC_I8ASHR:
      return (kid1_is_integer_constant ? EM_LAST : EM_LL_ASHR);
    case OPC_U8ASHR:
    case OPC_U8LSHR:
    case OPC_I8LSHR:
      return (kid1_is_integer_constant ? EM_LAST : EM_LL_LSHR);
    case OPC_F4I8CVT:   return EM_LL_TO_F;
    case OPC_F4U8CVT:   return EM_ULL_TO_F;
    case OPC_F8I8CVT:   return EM_LL_TO_D;
    case OPC_F8U8CVT:   return EM_ULL_TO_D;
    case OPC_I8F4TRUNC:
    case OPC_I8F4CVT:   return EM_F_TO_LL;
    case OPC_I8F8TRUNC:
    case OPC_I8F8CVT:   return EM_D_TO_LL;
    case OPC_U8F4TRUNC:
    case OPC_U8F4CVT:   return EM_F_TO_ULL;
    case OPC_U8F8TRUNC:
    case OPC_U8F8CVT:   return EM_D_TO_ULL;
  
      /* double cases */
    case OPC_F8ABS:	return EM_D_ABS;
    case OPC_F8SQRT:	return EM_D_SQRT;
    case OPC_F8ADD:	return EM_D_ADD;
    case OPC_F8SUB:	return EM_D_SUB;
    case OPC_F8MPY:	return EM_D_MPY;
    case OPC_F8DIV:	return EM_D_DIV;
    case OPC_F8NEG:	return EM_D_NEG;
    case OPC_F4F8CVT:   return EM_D_TO_F;
    case OPC_F8F4CVT:   return EM_F_TO_D;

      /* float cases */
    case OPC_F4ABS:	return (xt_hard_float ? EM_LAST : EM_F_ABS);
    case OPC_F4SQRT:	return (xt_hard_float_sqrt ? EM_LAST : EM_F_SQRT);
    case OPC_F4ADD:	return (xt_hard_float ? EM_LAST : EM_F_ADD);
    case OPC_F4SUB:	return (xt_hard_float ? EM_LAST : EM_F_SUB);
    case OPC_F4MPY:	return (xt_hard_float ? EM_LAST : EM_F_MPY);
    case OPC_F4NEG:	return (xt_hard_float ? EM_LAST : EM_F_NEG);
    case OPC_F4DIV:	return (xt_hard_float_div ? EM_LAST : EM_F_DIV);
    }
  ...
  if (type == MTYPE_F8)
    {
      switch (opr)
	{
	case OPR_EQ:	return EM_D_EQ;
	case OPR_NE:	return EM_D_NE;
	case OPR_GT:	return EM_D_GT;
	case OPR_GE:	return EM_D_GE;
	case OPR_LT:	return EM_D_LT;
	case OPR_LE:	return EM_D_LE;
	}
    }
  else if (type == MTYPE_F4)
    {
      switch (opr)
	{
	case OPR_EQ:	return (xt_hard_float ? EM_LAST : EM_F_EQ);
	case OPR_NE:	return (xt_hard_float ? EM_LAST : EM_F_NE);
	case OPR_GT:	return (xt_hard_float ? EM_LAST : EM_F_GT);
    case OPR_GE:	return (xt_hard_float ? EM_LAST : EM_F_GE);
	case OPR_LT:	return (xt_hard_float ? EM_LAST : EM_F_LT);
	case OPR_LE:	return (xt_hard_float ? EM_LAST : EM_F_LE);
	}
    }
...
/* ====================================================================
 * 
 * OP_is_emulated(OPCODE op, OPERATOR opr, 
 *	          bool kid1_is_integer_constant)
 *
 * return true if an OP is emulated
 *
 *===================================================================== */
extern bool OP_is_emulated(OPCODE op, OPERATOR opr, 
			   bool kid1_is_integer_constant)
{
    return (Get_emulation(op, opr, kid1_is_integer_constant) != EM_LAST);
}
...
static EMULATION WN_emulation(WN *tree)
{
  ...
  bool          kid1_is_integer_constant = 
      (WN_kid_count(tree) > 1) && Is_Integer_Constant(WN_kid1(tree));

  return Get_emulation(op, opr, kid1_is_integer_constant);
}
...
static void aux_memory_msg(char *msg, WN *tree, WN *mstore)
{
  ...
  if (Is_Integer_Constant(size))
  {
    n += sprintf(&buff[n], ", size = %" LLD_FMT "", WN_const_val(size));
  }
  else
  {
...
static WN *
em_saveregs (WN *block, WN *tree)
{
  /* Create a struct type for va_list. It seems I should just find the
     existing TY, but there doesn't seem to be an interface to do
     that, which makes me think I shouldn't try. */
  
  TY_IDX I4_ty = Be_Type_Tbl(MTYPE_I4);
  TY_IDX U4_ty = Be_Type_Tbl(MTYPE_U4);

  FLD_HANDLE first_field = New_FLD ();
  FLD_Init (first_field, Save_Str("__va_stk"), U4_ty, 0);

  FLD_HANDLE field = New_FLD ();
  FLD_Init (field, Save_Str("__va_reg"), U4_ty, 4);

  field = New_FLD ();
  FLD_Init (field, Save_Str("__va_ndx"), I4_ty, 8);
  Set_FLD_last_field(field);

  TY_IDX valist_struct_ty_idx;
  TY& valist_struct_ty = New_TY(valist_struct_ty_idx);

  TY_Init(valist_struct_ty,
	  2*TY_size(U4_ty) + TY_size(I4_ty),
	  KIND_STRUCT,
	  MTYPE_M,
	  Save_Str("__valist_internal_struct_ty"));
  Set_TY_fld(valist_struct_ty, first_field);
  Set_TY_align(valist_struct_ty_idx, 4);

  Make_Pointer_Type(valist_struct_ty_idx, TRUE);

  /* Create a local valist structure, and initialize it. We look
     through the formals to count them, and to find the symbol for the
     first vararg argument. */

  ST *st_valist = Gen_Temp_Symbol(valist_struct_ty_idx, "__valist_internal");
  Set_ST_addr_saved(st_valist);
  ST *pu_st = Get_Current_PU_ST();
  WN *pu_wn = PU_Info_tree_ptr(Current_PU_Info);

  FmtAssert(TY_is_varargs(Ty_Table[PU_prototype(Pu_Table[ST_pu(pu_st)])]),
	    ("instrinsic op SAVEREGS unexpected in non-varargs pu"));

  PLOC ploc = Setup_Input_Parameter_Locations(ST_pu_type(pu_st));
  UINT formal_cnt = ((WN_opcode(pu_wn) == OPC_ALTENTRY) ?
		     WN_kid_count(pu_wn) :
		     WN_num_formals(pu_wn));

  for (UINT i = 0; i < formal_cnt; i++)
  {
    WN *formal = WN_formal(pu_wn, i);
	
    if (WN_sclass(formal) == SCLASS_FORMAL_REF)
    {
      ST *base = Get_ST_formal_ref_base(WN_st(formal));
  ...
  /* Find the first vararg's offset. Find the first register vararg's
     symbol, if there are any varargs in registers. */
  INT first_vararg_offset = 0;
  ST *first_reg_vararg = NULL;
  if (PLOC_is_nonempty(ploc))
  {
    ploc = Get_Input_Parameter_Location(MTYPE_To_TY(Pointer_Mtype));
    first_vararg_offset = PLOC_offset(ploc);
    if (!PLOC_on_stack(ploc))
      first_reg_vararg = Get_Vararg_Symbol(ploc);
  }

  /* set the va_list.__va_stk to $arg_ptr - (32) */
  FmtAssert(first_upformal_sym != NULL,
	    ("expecting 'first_upformal_sym' != NULL"));

  Set_ST_addr_saved(first_upformal_sym);
  
  WN *wn_va_stk = WN_Stid(MTYPE_U4, 0, st_valist, ST_type(st_valist),
			  WN_Lda(Pointer_Mtype, -32, first_upformal_sym),
			  1);
  WN_INSERT_BlockLast(block, wn_va_stk);

  /* set va_list.__va_reg */
  if (first_reg_vararg)
  {
    WN *wn_va_reg = WN_Stid(MTYPE_U4, 4, st_valist, ST_type(st_valist),
			    WN_Lda(Pointer_Mtype, -first_vararg_offset, first_reg_vararg),
			    2);
    WN_INSERT_BlockLast(block, wn_va_reg);
  }

  /* Set va_list.__va_ndx.  If the first variable argument is on the stack,
     adjust __va_ndx by 2 words to account for the extra alignment offset for
     __va_stk.  */
  if (first_vararg_offset >= 24)
    first_vararg_offset += 8;
  WN *wn_va_ndx = WN_Stid(MTYPE_I4, 8, st_valist, ST_type(st_valist),
			  WN_Intconst(MTYPE_I4, first_vararg_offset),
			  3);
  WN_INSERT_BlockLast(block, wn_va_ndx);

  /* Return a pointer to st_valist. */
  return WN_Lda(Pointer_Mtype, ST_ofst(st_valist), st_valist);
}
...
static WN *
em_longlong_add (WN *block, WN *tree)
{
  TYPE_ID type = WN_rtype(tree);
  TYPE_ID new_type = ((type == MTYPE_U8) ? MTYPE_U4 : MTYPE_I4);

  /* Store each input into a preg using the original
     MTYPE_U8 or MTYPE_I8 type. */

  PREG_NUM preg0 = AssignExpr(block, WN_kid0(tree), type);
  PREG_NUM preg1 = AssignExpr(block, WN_kid1(tree), type);
  PREG_NUM result = Create_Preg(type, "tmp");

  /* Get the preg's representing each 4-byte chunk of the inputs. */
 
  PREG_NUM preg0_lo, preg0_hi;
  split_paired_preg_nums(preg0, new_type, &preg0_lo, &preg0_hi);
  PREG_NUM preg1_lo, preg1_hi;
  split_paired_preg_nums(preg1, new_type, &preg1_lo, &preg1_hi);
  PREG_NUM result_lo, result_hi;
  split_paired_preg_nums(result, new_type, &result_lo, &result_hi);

  /* Emit the whirl to emulate the 8 byte add. */

  WN *add_lo = WN_Add(MTYPE_U4,
		      WN_LdidPreg(MTYPE_U4, preg0_lo), 
		      WN_LdidPreg(MTYPE_U4, preg1_lo));
  AssignExprToPreg(block, add_lo, result_lo, MTYPE_U4);

  WN *add_hi = WN_Add(new_type,
		      WN_LdidPreg(new_type, preg0_hi), 
		      WN_LdidPreg(new_type, preg1_hi));
  AssignExprToPreg(block, add_hi, result_hi, new_type);

  WN *carry_comp = WN_LT(MTYPE_U4, 
			 WN_LdidPreg(MTYPE_U4, result_lo),
			 WN_LdidPreg(MTYPE_U4, preg0_lo));

  WN *one = WN_CreateIntconst(OPC_U4INTCONST, 1);
  WN* add_carry = WN_Add(new_type, WN_LdidPreg(new_type, result_hi), one);
  WN *label_wn = wn_new_label();
  LABEL_IDX new_label = WN_label_number(label_wn);
  WN *false_branch = WN_CreateFalsebr(new_label, carry_comp);
  ...
  if (Cur_PU_Feedback) {
    ...
    Cur_PU_Feedback->Annot_branch(false_branch, info_branch);
  }

  WN_INSERT_BlockLast(block, false_branch);
  AssignExprToPreg(block, add_carry, result_hi, new_type);
  WN_INSERT_BlockLast(block, label_wn);

  /* Delete the old tree and return the result as the
     original 8-byte type. */
...
static WN *
em_longlong_sub (WN *block, WN *tree)
{
  TYPE_ID type = WN_rtype(tree);
  TYPE_ID new_type = ((type == MTYPE_U8) ? MTYPE_U4 : MTYPE_I4);
  ...
  /* Emit the whirl to emulate the 8 byte sub. */

  WN *sub_lo = WN_Sub(MTYPE_U4,
		      WN_LdidPreg(MTYPE_U4, preg0_lo), 
		      WN_LdidPreg(MTYPE_U4, preg1_lo));
  AssignExprToPreg(block, sub_lo, result_lo, MTYPE_U4);

  WN *sub_hi = WN_Sub(new_type,
		      WN_LdidPreg(new_type, preg0_hi), 
		      WN_LdidPreg(new_type, preg1_hi));
  AssignExprToPreg(block, sub_hi, result_hi, new_type);

  WN *carry_comp = WN_GT(MTYPE_U4, 
			 WN_LdidPreg(MTYPE_U4, result_lo),
			 WN_LdidPreg(MTYPE_U4, preg0_lo));

  WN *one = WN_CreateIntconst(OPC_U4INTCONST, 1);
  WN *sub_carry = WN_Sub(new_type, WN_LdidPreg(new_type, result_hi), one);
  WN *label_wn = wn_new_label();
  LABEL_IDX new_label = WN_label_number(label_wn);
  WN *false_branch = WN_CreateFalsebr(new_label, carry_comp);
  ...
  WN_INSERT_BlockLast(block, false_branch);
  AssignExprToPreg(block, sub_carry, result_hi, new_type);
  WN_INSERT_BlockLast(block, label_wn);
...
static WN *
em_longlong_neg (WN *block, WN *tree)
{
  TYPE_ID type = WN_rtype(tree);
  TYPE_ID new_type = ((type == MTYPE_U8) ? MTYPE_U4 : MTYPE_I4);
  ...
  /* Emit the whirl to emulate the 8 byte neg. */

  WN *neg_lo = WN_Neg(MTYPE_I4,
		      WN_LdidPreg(MTYPE_I4, preg0_lo));
  AssignExprToPreg(block, neg_lo, result_lo, MTYPE_I4);

  WN *neg_hi = WN_Bnot(new_type,
		       WN_LdidPreg(new_type, preg0_hi));
  AssignExprToPreg(block, neg_hi, result_hi, new_type);

  WN *carry_comp = WN_EQ(MTYPE_I4, 
			 WN_LdidPreg(MTYPE_I4, preg0_lo),
			 WN_Intconst(MTYPE_I4, 0));

  WN *one = WN_CreateIntconst(OPC_U4INTCONST, 1);
  WN *neg_carry = WN_Add(new_type, WN_LdidPreg(new_type, result_hi), one);
  WN *label_wn = wn_new_label();
  LABEL_IDX new_label = WN_label_number(label_wn);
  WN *false_branch = WN_CreateFalsebr(new_label, carry_comp);
  ...
  WN_INSERT_BlockLast(block, false_branch);
  AssignExprToPreg(block, neg_carry, result_hi, new_type);
  WN_INSERT_BlockLast(block, label_wn);
...
static WN *
em_longlong_abs (WN *block, WN *tree)
{
  TYPE_ID type = WN_rtype(tree);
  TYPE_ID new_type = ((type == MTYPE_U8) ? MTYPE_U4 : MTYPE_I4);
  ...
  /* Emit the whirl to emulate the 8 byte abs. */

  /* the idea here is to generate the following code

		movi	result,preg0
		bge     preg0_hi, 0, L_done
		not	result_hi, preg0_hi
		neg	result_lo, preg0_lo,
		bne	preg0_hi, 0, L_done
		add	result_hi, 1
	L_done:
  */

  AssignExprToPreg(block, WN_LdidPreg(new_type, preg0_lo), result_lo, MTYPE_U4);
  AssignExprToPreg(block, WN_LdidPreg(new_type, preg0_hi), result_hi, new_type); 
  WN *label_wn = wn_new_label();
  LABEL_IDX new_label = WN_label_number(label_wn);

  WN *comp_wn1 = WN_GE(new_type,
			 WN_LdidPreg(new_type, preg0_hi), 
			 WN_Intconst(MTYPE_I4, 0));
  WN *branch_wn1 = WN_CreateTruebr(new_label, comp_wn1);
  ...
  if (Cur_PU_Feedback) {
     ...
     */
    FB_Info_Branch info_branch(FB_FREQ(1.0,FB_FREQ_TYPE_GUESS),FB_FREQ_UNKNOWN); 
    Cur_PU_Feedback->Annot_branch(branch_wn1, info_branch);
  }
...
static WN *
em_longlong_bnot (WN *block, WN *tree)
{
  TYPE_ID type = WN_rtype(tree);
  TYPE_ID new_type = ((type == MTYPE_U8) ? MTYPE_U4 : MTYPE_I4);
  ...
  /* Emit the whirl to emulate the 8 byte bnot. */

  WN *bnot_lo = WN_Bnot(MTYPE_U4, WN_LdidPreg(MTYPE_U4, preg0_lo));
  AssignExprToPreg(block, bnot_lo, result_lo, MTYPE_U4);

  WN *bnot_hi = WN_Bnot(new_type, WN_LdidPreg(new_type, preg0_hi));
  AssignExprToPreg(block, bnot_hi, result_hi, new_type);
...
static WN *
em_longlong_binop (WN *block, WN *tree)
{
  TYPE_ID type = WN_rtype(tree);
  TYPE_ID new_type = ((type == MTYPE_U8) ? MTYPE_U4 : MTYPE_I4);
  ...
  /* Emit the whirl to emulate the 8 byte binary operation. */

  WN *bin_lo = WN_Binary(WN_operator(tree), MTYPE_U4,
		      WN_LdidPreg(MTYPE_U4, preg0_lo), 
		      WN_LdidPreg(MTYPE_U4, preg1_lo));
  AssignExprToPreg(block, bin_lo, result_lo, MTYPE_U4);

  WN *bin_hi = WN_Binary(WN_operator(tree), new_type,
		      WN_LdidPreg(new_type, preg0_hi), 
		      WN_LdidPreg(new_type, preg1_hi));
  AssignExprToPreg(block, bin_hi, result_hi, new_type);
...
static WN *
em_longlong_minmax (WN *block, WN *tree)
{
  TYPE_ID type = WN_rtype(tree);
  TYPE_ID new_type = ((type == MTYPE_U8) ? MTYPE_U4 : MTYPE_I4);

  OPERATOR opr = WN_operator(tree);
  OPERATOR comp_opr1, comp_opr2, comp_opr3;
  switch (opr) {
    case OPR_MIN: comp_opr1=OPR_LT; comp_opr2=OPR_NE; comp_opr3=OPR_LT; break;
    case OPR_MAX: comp_opr1=OPR_GT; comp_opr2=OPR_NE; comp_opr3=OPR_GT; break;
    default:
  ...
  /* Emit the whirl to emulate the 8 byte min/max operation. */

  /* the idea here is, for (max preg0,preg1),
     to generate the following code

		movi	result,preg0
		bgtu	preg0_hi, preg1_hi, L_done
		bne	preg0_hi, preg1_hi, L_true
		bgtu	preg0_lo, preg1_lo, L_done
	L_true:
		movi	result,preg1
	L_done:

     this may be further improved ...
  */
  AssignExprToPreg(block, WN_LdidPreg(new_type, preg0_lo), result_lo, MTYPE_U4);
  AssignExprToPreg(block, WN_LdidPreg(new_type, preg0_hi), result_hi, new_type);
  WN *done_label_wn = wn_new_label();
  WN *true_label_wn = wn_new_label();
  LABEL_IDX done_new_label = WN_label_number(done_label_wn);
  LABEL_IDX true_new_label = WN_label_number(true_label_wn);

  WN *comp_wn1 = WN_Relational(comp_opr1, new_type,
			 WN_LdidPreg(new_type, preg0_hi), 
			 WN_LdidPreg(new_type, preg1_hi));
  WN *branch_wn1 = WN_CreateTruebr(done_new_label, comp_wn1);
  ...
  WN *comp_wn2 = WN_Relational(comp_opr2, new_type,
			 WN_LdidPreg(new_type, preg0_hi), 
			 WN_LdidPreg(new_type, preg1_hi));
  WN *branch_wn2 = WN_CreateTruebr(true_new_label, comp_wn2);
  ...
  if (Cur_PU_Feedback) {
     ...
     */
    FB_Info_Branch info_branch(FB_FREQ(1.0,FB_FREQ_TYPE_GUESS),FB_FREQ_UNKNOWN); 
    Cur_PU_Feedback->Annot_branch(branch_wn2, info_branch);
  }

  WN_INSERT_BlockLast(block, branch_wn2);

  WN *comp_wn3 = WN_Relational(comp_opr3, MTYPE_U4,
			 WN_LdidPreg(MTYPE_U4, preg0_lo), 
			 WN_LdidPreg(MTYPE_U4, preg1_lo));
  WN *branch_wn3 = WN_CreateTruebr(done_new_label, comp_wn3);
  ...
  if (Cur_PU_Feedback) {
     ...
     */
    FB_Info_Branch info_branch(FB_FREQ(1.0,FB_FREQ_TYPE_GUESS),FB_FREQ_UNKNOWN); 
    Cur_PU_Feedback->Annot_branch(branch_wn3, info_branch);
  }

  WN_INSERT_BlockLast(block, branch_wn3);

  WN_INSERT_BlockLast(block, true_label_wn);
  AssignExprToPreg(block, WN_LdidPreg(new_type, preg1_lo), result_lo, MTYPE_U4);
  AssignExprToPreg(block, WN_LdidPreg(new_type, preg1_hi), result_hi, new_type);
...
preg_equivalent_integer (WN *wn)
{
  if (WN_operator(wn) == OPR_LDID &&
      ...
      !Preg_Is_Dedicated(WN_load_offset(wn)) &&
      (wn = Preg_Home(WN_load_offset(wn))) &&
...
static WN *
em_longlong_cshiftr (WN *block, WN *tree)
{
  TYPE_ID type = WN_rtype(tree);
  TYPE_ID new_type = ((type == MTYPE_U8) ? MTYPE_U4 : MTYPE_I4);
  ...
  PREG_NUM preg0 = AssignExpr(block, WN_kid0(tree), type);
  FmtAssert(Is_Integer_Constant(WN_kid1(tree)) ||
            preg_equivalent_integer(WN_kid1(tree)), 
            ("Long long shift emulation requires a constant shift amount"));
  int shift_amt = (Is_Integer_Constant(WN_kid1(tree)) ? 
                   WN_const_val(WN_kid1(tree)) :
                   WN_const_val(preg_equivalent_integer(WN_kid1(tree)))) 
                & (MTYPE_bit_size(MTYPE_I8)-1);
  PREG_NUM result = Create_Preg(type, "tmp");
  ...
  /* Emit the whirl to emulate the 8 byte shift operation. */

  WN *shft_lo, *shft_hi;
  if (shift_amt >= MTYPE_bit_size(MTYPE_I4)) {
    shft_lo = WN_Binary(WN_operator(tree), new_type, 
			WN_LdidPreg(new_type, preg0_hi),
			WN_Intconst(MTYPE_I4, shift_amt-MTYPE_bit_size(MTYPE_I4)));
    if (WN_operator(tree) == OPR_ASHR)
      shft_hi = WN_Binary(WN_operator(tree), new_type, 
			  WN_LdidPreg(new_type, preg0_hi),
			  WN_Intconst(MTYPE_I4, MTYPE_bit_size(MTYPE_I4)-1));
    else
      shft_hi = WN_Intconst(new_type, 0);
  } else {
    WN *lo_bits = WN_Lshr(MTYPE_U4, WN_LdidPreg(MTYPE_U4, preg0_lo),
			  WN_Intconst(MTYPE_I4, shift_amt));
    WN *hi_bits = WN_Shl(MTYPE_U4, WN_LdidPreg(MTYPE_U4, preg0_hi),
			 WN_Intconst(MTYPE_I4, MTYPE_bit_size(MTYPE_I4)-shift_amt));
    shft_lo = WN_Bior(MTYPE_U4, lo_bits, hi_bits);
    shft_hi = WN_Binary(WN_operator(tree), new_type, 
			WN_LdidPreg(new_type, preg0_hi),
			WN_Intconst(MTYPE_I4, shift_amt));
  }
  AssignExprToPreg(block, shft_lo, result_lo, MTYPE_U4);
  AssignExprToPreg(block, shft_hi, result_hi, new_type);
...
static WN *
em_longlong_cshiftl (WN *block, WN *tree)
{
  TYPE_ID type = WN_rtype(tree);
  TYPE_ID new_type = ((type == MTYPE_U8) ? MTYPE_U4 : MTYPE_I4);
  ...
  WN *shft_lo, *shft_hi;
  if (shift_amt >= MTYPE_bit_size(MTYPE_I4)) {
    shft_lo = WN_Intconst(MTYPE_U4, 0);
    shft_hi = WN_Binary(WN_operator(tree), new_type, 
			WN_LdidPreg(new_type, preg0_lo),
			WN_Intconst(MTYPE_I4, shift_amt-MTYPE_bit_size(MTYPE_I4)));
  } else {
    WN *lo_bits = WN_Lshr(MTYPE_U4, WN_LdidPreg(MTYPE_U4, preg0_lo),
			  WN_Intconst(MTYPE_I4, MTYPE_bit_size(MTYPE_I4)-shift_amt));
    WN *hi_bits = WN_Shl(MTYPE_U4, WN_LdidPreg(MTYPE_U4, preg0_hi),
			 WN_Intconst(MTYPE_I4, shift_amt));
    shft_lo = WN_Binary(WN_operator(tree), MTYPE_U4, 
			WN_LdidPreg(MTYPE_U4, preg0_lo),
			WN_Intconst(MTYPE_I4, shift_amt));
    shft_hi = WN_Bior(new_type, lo_bits, hi_bits);
  }
  AssignExprToPreg(block, shft_lo, result_lo, MTYPE_U4);
  AssignExprToPreg(block, shft_hi, result_hi, new_type);
...
static WN *
em_longlong_cmp (WN *block, WN *tree)
{
  TYPE_ID type = WN_desc(tree);
  TYPE_ID new_type = ((type == MTYPE_U8) ? MTYPE_U4 : MTYPE_I4);

  OPERATOR opr = WN_operator(tree);
  OPERATOR comp_opr1, comp_opr2, comp_opr3;
  switch (opr) {
    case OPR_GE: comp_opr1=OPR_LT; comp_opr2=OPR_NE; comp_opr3=OPR_LT; break;
    case OPR_GT: comp_opr1=OPR_LT; comp_opr2=OPR_NE; comp_opr3=OPR_LE; break;
    case OPR_LE: comp_opr1=OPR_GT; comp_opr2=OPR_NE; comp_opr3=OPR_GT; break;
    case OPR_LT: comp_opr1=OPR_GT; comp_opr2=OPR_NE; comp_opr3=OPR_GE; break;
    default:
	 FmtAssert(0,("Unexpected operator"));
  }
  ...
  /* Emit the whirl to emulate the 8 byte compare. */

  /* the idea here is, for (unsigned preg0<=preg1),
     to generate the following code
  ...
  */
  ...
  WN *zero = WN_CreateIntconst(OPC_U4INTCONST, 0);
  WN *one = WN_CreateIntconst(OPC_U4INTCONST, 1);

  PREG_NUM result = AssignExpr(block, zero, new_type);
  WN *done_label_wn = wn_new_label();
  WN *true_label_wn = wn_new_label();
  LABEL_IDX done_new_label = WN_label_number(done_label_wn);
  LABEL_IDX true_new_label = WN_label_number(true_label_wn);
  ...
  WN_INSERT_BlockLast(block, true_label_wn);
  AssignExprToPreg(block, one, result, new_type);

  WN_INSERT_BlockLast(block, done_label_wn);

  /* Delete the old tree and return the result */
  
  WN_Delete(tree);
  return WN_LdidPreg(new_type, result);
}

static WN *
em_longlong_cmpeq (WN *block, WN *tree)
{
  TYPE_ID type = WN_desc(tree);
  TYPE_ID new_type = ((type == MTYPE_U8) ? MTYPE_U4 : MTYPE_I4);
  ...
  WN *cmp_lo = WN_Relational(WN_operator(tree), MTYPE_I4,
			 WN_LdidPreg(MTYPE_U4, preg0_lo), 
			 WN_LdidPreg(MTYPE_U4, preg1_lo));
  WN *cmp_hi = WN_Relational(WN_operator(tree), MTYPE_I4,
			 WN_LdidPreg(new_type, preg0_hi), 
			 WN_LdidPreg(new_type, preg1_hi));
  WN *cmp_final = WN_Binary((WN_operator(tree)==OPR_EQ) ? OPR_BAND : OPR_BIOR,
			    MTYPE_I4, cmp_lo, cmp_hi);
...
static WN *
em_longlong_extend (WN *block, WN *tree)
{
  TYPE_ID type = WN_rtype(tree);
  TYPE_ID new_type = ((type == MTYPE_U8) ? MTYPE_U4 : MTYPE_I4);

  /* Get a new preg to stuff values into */

  PREG_NUM result = Create_Preg(type, "tmp");

  /* Get the preg's representing each 4-byte chunk of the inputs. */

  PREG_NUM preg0 = AssignExpr(block, WN_kid0(tree), WN_desc(tree));
  PREG_NUM result_lo, result_hi;
  split_paired_preg_nums(result, new_type, &result_lo, &result_hi);

  WN *extend_hi;

  if (MTYPE_is_unsigned(WN_desc(tree))) {
    extend_hi = WN_Intconst(MTYPE_U4, 0);
  } else {
    extend_hi = WN_Ashr(MTYPE_I4, WN_LdidPreg(MTYPE_I4, preg0),
			     WN_Intconst(MTYPE_I4, 
					 MTYPE_bit_size(MTYPE_I4)-1));
  }
  AssignExprToPreg(block, WN_LdidPreg(MTYPE_U4, preg0), result_lo, MTYPE_U4);
  AssignExprToPreg(block, extend_hi, result_hi, new_type);
...
/* This function seems pretty stupid, but I have problems where an U8U4LDID 
   feeds a I8U8CVT, which feeds I8STID. The U8U4LDID is supposed to be
   expanded eventually by em_longlong_extend, but that only happens if it's
   the child of a 8-byte store. The presence of the I8U8CVT hides it so that
   it never gets expanded, unless we force an emulation by storing the
   child of the I8U8CVT, like we do with other 8-byte operations. */
static WN *
em_longlong_nop (WN *block, WN *tree)
{
  TYPE_ID new_type = WN_rtype(tree);
  ...
  WN_Delete(tree);
  return WN_LdidPreg(new_type, preg0);
}

static WN *
em_longlong_tie_cvt (WN *block, WN *tree)
{
  TYPE_ID rtype = WN_rtype(tree);
  TYPE_ID desc = WN_desc(tree);

  PREG_NUM result = Create_Preg(rtype, "tie_longlong_cvt_tmp");
  if (desc==MTYPE_I8 || desc==MTYPE_U8) {
    /* source is long long, lower the kid */
    PREG_NUM preg = AssignExpr(block, WN_kid0(tree), desc);
    WN_kid0(tree) = WN_LdidPreg(desc, preg);
  } else {

    /* result is long long */
    /* store result into a preg using the original MTYPE_U8 or MTYPE_I8 type */

    PREG_NUM result_lo, result_hi;
    TYPE_ID new_type = ((rtype == MTYPE_U8) ? MTYPE_U4 : MTYPE_I4);
    split_paired_preg_nums(result, new_type, &result_lo, &result_hi);
  }

  WN* stid = WN_StidPreg(rtype, result, tree);
...
static WN *
em_longlong_truncate (WN *block, WN *tree)
{
  TYPE_ID type = (WN_operator(tree) == OPR_CVTL) ? 
    WN_rtype(tree) : WN_desc(tree);
  TYPE_ID new_type = ((type == MTYPE_U8) ? MTYPE_U4 : MTYPE_I4);
  TYPE_ID old_type = WN_rtype(tree);
  int num_bits;
  if (WN_operator(tree) == OPR_CVTL) {
    num_bits = WN_cvtl_bits(tree);
  } else {
    num_bits = MTYPE_bit_size(WN_rtype(tree));
  }
  ...
  PREG_NUM preg0_lo, preg0_hi;
  split_paired_preg_nums(preg0, new_type, &preg0_lo, &preg0_hi);
  PREG_NUM result = Create_Preg(WN_rtype(tree), "tmp");
  PREG_NUM result_lo, result_hi;

  if (MTYPE_bit_size(old_type) > MTYPE_bit_size(MTYPE_I4)) {
    split_paired_preg_nums(result, new_type, &result_lo, &result_hi);
  } else {
    result_lo = result;
  }

  /* Emit the whirl to emulate the 8 byte truncate. */

  WN *trunc_lo = WN_LdidPreg(new_type, preg0_lo);
  if (num_bits < MTYPE_bit_size(new_type)) {
    trunc_lo = WN_CreateCvtl(OPR_CVTL, new_type, MTYPE_V, num_bits, trunc_lo);
  }
  AssignExprToPreg(block, trunc_lo, result_lo, new_type);

  if (MTYPE_bit_size(old_type) > MTYPE_bit_size(MTYPE_I4)) {
    WN *trunc_hi;
    if (MTYPE_is_signed(type)) {
      trunc_hi = WN_Ashr(MTYPE_I4, WN_LdidPreg(new_type, result_lo), 
			 WN_Intconst(MTYPE_I4, MTYPE_bit_size(MTYPE_I4)-1));
    } else {
      trunc_hi = WN_Intconst(MTYPE_U4, 0);
    }
    AssignExprToPreg(block, trunc_hi, result_hi, new_type);
  }
  ...
  WN_Delete(tree);
  return WN_LdidPreg(old_type, result);
}

#endif

static WN *
em_float_change_sign (WN *block, WN *tree)
{
  TYPE_ID type = WN_rtype(tree);
  TYPE_ID new_type = ((type == MTYPE_U8) ? MTYPE_U4 : MTYPE_I4);

  /* Store each input into a preg using the original type. */

  PREG_NUM preg0 = AssignExpr(block, WN_kid0(tree), type);
  PREG_NUM result = Create_Preg(type, "tmp");
  PREG_NUM preg0_hi = preg0, preg0_lo;
  PREG_NUM result_hi = result, result_lo;

  /* Get the preg's representing each 4-byte chunk of the inputs. */

  if (type == MTYPE_F8) {
    split_paired_preg_nums(preg0, MTYPE_I4, &preg0_lo, &preg0_hi);
    split_paired_preg_nums(result, MTYPE_I4, &result_lo, &result_hi);
  } else {
    Is_True(type == MTYPE_F4, ("expected a floating point type"));
  }

  WN *result_wn;
  if (WN_operator(tree) == OPR_NEG) {
    result_wn = WN_Bxor(MTYPE_I4,
			WN_LdidPreg(MTYPE_I4, preg0_hi), 
			WN_Intconst(MTYPE_I4, 0x80000000));
  } else {
    result_wn = WN_Band(MTYPE_I4,
			WN_LdidPreg(MTYPE_I4, preg0_hi), 
			WN_Intconst(MTYPE_I4, 0x7fffffff));
  }
  AssignExprToPreg(block, result_wn, result_hi, MTYPE_I4);
  if (type == MTYPE_F8)
    AssignExprToPreg(block, WN_LdidPreg(new_type, preg0_lo), result_lo, 
		     MTYPE_I4); 

  /* Delete the old tree and return the result as the original type. */
...
extern WN *intrinsic_runtime(WN *block, WN *tree)
{
  ...
  BOOL   byvalue = FALSE;
  BOOL   parmMod= FALSE;
  TYPE_ID coerce_return_type = MTYPE_UNKNOWN;
  ...
  for(n = 0; n < WN_num_actuals(tree); n++)
  {
	...
	*/
    ...
    case COERCE_double:
      {
	FmtAssert(WN_rtype(actual) == MTYPE_F4, ("expecting float type"));
	args[ argC++] = WN_Type_Conversion(actual, MTYPE_F8);
	coerce_return_type = MTYPE_F8;
      }
      break;
  ...
  {
    TYPE_ID	rtype =  ((coerce_return_type != MTYPE_UNKNOWN) ?
			  coerce_return_type : WN_rtype(tree));
    ...
    */
    ...
    /* Originally this was:
       ...
       But since 'tree' is usually (I would think always) a non-call,
       then copying 'tree's call flags could potentially be copying
       garbage, or some other information unioned with call_flags in
       the WN class.
    */
    if (OPERATOR_is_call(WN_operator(tree)))
      WN_call_flag(call) = WN_call_flag(tree);
    ...
    */
    ...
    // Update feedback
    if ( Cur_PU_Feedback )
      Cur_PU_Feedback->FB_set_in_out_same(call);
...
#ifdef TARG_XTENSA
/* With the gnu math library we have to muck with the return value for
   some of the functions. This will be unnecessary if/when we switch
   to the sgi math library. */
WN *
coerce_emulation_return (WN *tree, WN *wn)
{
  EMULATION id = WN_emulation(tree); 
...
extern WN *emulate(WN *& block, WN *tree)
{
  ...
  else
  {
	...
	wn = em_quad_neg(block, tree);
      } else if (MTYPE_is_float(WN_rtype(tree)) &&
                 !(xt_hard_float && WN_rtype(tree) == MTYPE_F4)) {
        if (block==NULL)
	  block = WN_CreateBlock();
	wn = em_float_change_sign(block, tree);
      }
      break;
    ...
    case OPR_ABS:
      if (MTYPE_is_float(WN_rtype(tree)) &&
          !(xt_hard_float && WN_rtype(tree) == MTYPE_F4)) {
        if (block==NULL)
	  block = WN_CreateBlock();
	wn = em_float_change_sign(block, tree);
...
#ifdef TARG_XTENSA
    /* Emulate MTYPE_I8 and MTYPE_U8 operators that aren't implemented
       by intrinsic calls. */

    if ((WN_rtype(tree) == MTYPE_I8) || (WN_rtype(tree) == MTYPE_U8))
    {
      if (block==NULL)
	block = WN_CreateBlock();
      switch (WN_operator(tree))
      {
      case OPR_ADD:
	wn = em_longlong_add(block, tree);
	break;
      case OPR_SUB:
	wn = em_longlong_sub(block, tree);
	break;
      case OPR_NEG:
	wn = em_longlong_neg(block, tree);
	break;
      case OPR_ABS:
	wn = em_longlong_abs(block, tree);
	break;
      case OPR_BNOT:
	wn = em_longlong_bnot(block, tree);
	break;
      case OPR_BXOR:
      case OPR_BIOR:
      case OPR_BAND:
	wn = em_longlong_binop(block, tree);
	break;
      case OPR_SHL:
	if (Is_Integer_Constant(WN_kid1(tree)) || 
            preg_equivalent_integer(WN_kid1(tree)))
	  wn = em_longlong_cshiftl(block, tree);
	break;
      case OPR_ASHR:
      case OPR_LSHR:
	if (Is_Integer_Constant(WN_kid1(tree)) ||
            preg_equivalent_integer(WN_kid1(tree)))
	  wn = em_longlong_cshiftr(block, tree);
	break;
      case OPR_CVT: 
      {
	TYPE_ID arg_type = WN_desc(tree);
	if ((arg_type == MTYPE_I4) || (arg_type == MTYPE_U4) ||
	    (arg_type == MTYPE_I2) || (arg_type == MTYPE_U2) ||
	    (arg_type == MTYPE_I1) || (arg_type == MTYPE_U1))
	  wn = em_longlong_extend(block, tree);
	else if ((arg_type == MTYPE_I8) || (arg_type == MTYPE_U8))
	  wn = em_longlong_nop(block, tree);
	else if (MTYPE_is_tie(arg_type))
	  wn = em_longlong_tie_cvt(block, tree);
	break;
      }
      case OPR_CVTL: 
	wn = em_longlong_truncate(block, tree);
	break;
      case OPR_MIN:
      case OPR_MAX:
	wn = em_longlong_minmax(block, tree);
	break;
      }
    }
    
    if ((WN_desc(tree) == MTYPE_I8) || (WN_desc(tree) == MTYPE_U8))
    {
      if (block==NULL)
	block = WN_CreateBlock();
      switch (WN_operator(tree))
      ...
      case OPR_LE:
      case OPR_LT:
	wn = em_longlong_cmp(block, tree);
	break;
      case OPR_EQ:
      case OPR_NE:
	wn = em_longlong_cmpeq(block, tree);
	break;
      case OPR_CVT: 
      {
	TYPE_ID ret_type = WN_rtype(tree);
	if ((ret_type == MTYPE_I4) || (ret_type == MTYPE_U4) ||
	    (ret_type == MTYPE_I2) || (ret_type == MTYPE_U2) ||
	    (ret_type == MTYPE_I1) || (ret_type == MTYPE_U1))
	  wn = em_longlong_truncate(block, tree);
	else if (MTYPE_is_tie(ret_type))
	  wn = em_longlong_tie_cvt(block, tree);
	break;
      }
      }
