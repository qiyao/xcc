...
#ifdef _KEEP_RCS_ID
static char *erbe_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/com/RCS/erbe.h,v $ $Revision: 3.34 $";
#endif /* _KEEP_RCS_ID */
...
#define EC_Misaligned_Offset	EC_BASE_BE+131	/* str, int, str */
...
/* TIE code expansion/lowering errors */
#define EC_TIE_missing_store	 EC_BASE_BE+150	 /* int, str */

/* WOPT errors */
#define EC_WOPT_bad_restrict_die	EC_BASE_BE + 160
#define EC_WOPT_bad_restrict_warn	EC_BASE_BE + 161
