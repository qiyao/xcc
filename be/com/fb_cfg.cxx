...
// Module: fb_cfg.cxx
// $Revision: 1.19 $
// $Date: 2000/05/19 20:19:14 $
// $Author: murthy $
// $Source: /isms/cmplrs.src/osprey1.0/be/com/RCS/fb_cfg.cxx,v $
//
// Description:
//
// Code to generate CFG for edge frequency data.  
// Uses CFG to compute unknown frequencies from known values.
  ...
  case OPR_CSELECT:
    {
      ...
      Add_edge( nx_then, nx_join );
      Add_edge( nx_else, nx_join );
      Add_edge( nx_join, nx_true );
      Add_edge( nx_join, nx_false );
      Set_curr( nx_join );
    }
    break;
