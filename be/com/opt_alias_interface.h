...
* $Revision: 1.46 $
* $Date: 2000/04/07 01:12:26 $
* $Author: mtibuild $
* $Source: /isms/cmplrs.src/osprey1.0/be/com/RCS/opt_alias_interface.h,v $
*
* Revision history:
...
#ifdef _KEEP_RCS_ID
static char *opt_alias_interfacercs_id = 	opt_alias_interface_INCLUDED"$Revision: 1.46 $";
#endif /* _KEEP_RCS_ID */
...
void Join_mtype_alias_classes (struct ALIAS_MANAGER *, TYPE_ID, TYPE_ID);

UINT32 Mtype_alias_class (const struct ALIAS_MANAGER *, TYPE_ID);
