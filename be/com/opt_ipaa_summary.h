...
// $Revision: 1.8 $
// $Date: 2000/04/06 01:58:55 $
// $Author: mtibuild $
// $Source: /isms/cmplrs.src/osprey1.0/be/com/RCS/opt_ipaa_summary.h,v $
//
// Revision history:
...
#ifdef _KEEP_RCS_ID
static char *opt_ipaa_summary_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/com/RCS/opt_ipaa_summary.h,v $ $Revision: 1.8 $";
#endif /* _KEEP_RCS_ID */

// Trace flag for IPAA summary file build/output:
extern DLL_SHARED BOOL Trace_IPAA_Summary;
...
extern DLL_SHARED IPAA_SUMMARY *IPAA_Summary;

// ====================================================================
// ====================================================================
//
...
extern "C" {
 ...
 void *IPAA_CALLSITES_Read ( char *base, Elf64_Word size );
...
class IPAA_CALLSITES
{
  ...
  friend void * IPAA_CALLSITES_Read(char *base, Elf64_Word size);
...
class IPAA_LOCAL_MAP
{
  ...
  friend void *IPAA_LOCAL_MAP_Read(char *base, Elf64_Word size);
