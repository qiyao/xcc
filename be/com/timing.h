...
#ifdef _KEEP_RCS_ID
static char *timing_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/com/RCS/timing.h,v $ $Revision: 3.33 $";
#endif /* _KEEP_RCS_ID */
...
typedef enum {
	...
	T_CFLOW_Comp,	
	T_Prep_CU,		/* Scheduling preparation */
	T_Prep_Comp,	
	T_Freq_CU,		/* BB frequency */
	T_Freq_Comp,	
	T_Peep_CU,		/* Peephole optimization */
	T_Peep_Comp,
