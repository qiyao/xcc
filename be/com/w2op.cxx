...
BOOL TOP_Can_Be_Speculative (TOP opcode)
{
  ...
  case EAGER_SAFE:
     ...
     */
    if (TI_ISA_Property_Set(PROP_ftrap, opcode)
	|| TI_ISA_Property_Set(PROP_itrap, opcode)) break;
    /*FALLTHROUGH*/
  ...
  case EAGER_ARITH:
     ...
     */
    if (TI_ISA_Property_Set(PROP_fdiv, opcode) ||
        TI_ISA_Property_Set(PROP_idiv, opcode)) break;
    /*FALLTHROUGH*/
  ...
  case EAGER_DIVIDE:
     ...
     */
    if (TI_ISA_Property_Set(PROP_memtrap, opcode)) break;
    /*FALLTHROUGH*/
  ...
  case EAGER_MEMORY:
     ...
     */
    if (TI_ISA_Property_Set(PROP_unsafe, opcode)) break;
    return TRUE;
