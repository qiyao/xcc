...
#define LOWER_BITS_OP		  0x010000000000ll 
  ...
  /* For Xtensa:
     LOWER_PAIRED lowers both I8 and F8 data types.
 */
#define LOWER_FLOAT		  0x020000000000ll 
#define LOWER_PAIRED              0x040000000000ll
#define LOWER_LONGLONG            0x080000000000ll

/* constant multiply */
#define LOWER_MPY_DIV_CONST       0x100000000000ll 

 /* For Xtensa:
    LOWER_TIE_FOR_CG
	lowers both OPR_INTRINSIC_OP and OPR_INTRINSIC_CALL
	with TIE intrinsic id.
	lowers any converting LDID and ILOAD with TIE types
	into explicit conversion and a non-converting load.
    Should be called right before isel.
    Currently part of LOWER_TO_CG.
 */
#define LOWER_TIE_FOR_CG	  0x200000000000ll 

/* Special lowering of MLDIDs within ASM_INPUT expressions
 * in an attempt to catch cases where a struct with a single
 * field is passed as a register-constrained argument to ASM
 */
#define LOWER_MLDID_IN_ASM        0x400000000000ll
