 ...
 * Module: al_loop.h
 * $Revision: 1.4 $
 * $Date: 2000/04/06 02:03:07 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/al_loop.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *al_loop_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/al_loop.h,v $ $Revision: 1.4 $";
#endif /* _KEEP_RCS_ID */
