 ...
 * Module: al_ref.h
 * $Revision: 1.5 $
 * $Date: 2000/04/06 02:03:12 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/al_ref.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *al_ref_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/al_ref.h,v $ $Revision: 1.5 $";
#endif /* _KEEP_RCS_ID */
