 ...
 * $Revision: 1.9 $
 * $Date: 2000/04/06 02:03:50 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/array_lower.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *array_lower_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/array_lower.h,v $ $Revision: 1.9 $";
#endif /* _KEEP_RCS_ID */
