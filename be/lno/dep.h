...
//
//         BOOL Dependence_Carried_By_Loop (INT depth)
//
//	        Returns TRUE if the loop at depth carries the dependence.
//	
...
//
// 	    void Append(DEPV_LIST *list);
//
//		append everything on list onto this
//
...
//
//	    INT First_Non_Star() const
//
//		Collapse all the dependence vectors into one and then
//		Return the position of the first non star
//
...
/** $Revision: 1.48 $
*** $Date: 2000/04/06 02:05:33 $
*** $Author: mtibuild $
*** $Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/dep.h,v $
**/
...
#ifdef _KEEP_RCS_ID
static char *dep_rcs_id = dep_INCLUDED "$Revision: 1.48 $";
#endif /* _KEEP_RCS_ID */
...
private:
  MEM_POOL *_pool;
  INT _num_bad_outer_min, _num_bad_outer_max;
  DEPV_COMPUTE() {;}
  ~DEPV_COMPUTE() {;}
  INT64 *_step1;
  INT64 *_step2;
