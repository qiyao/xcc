 ...
 * Module: doacross.cxx
 * $Revision: 1.40 $
 * $Date: 2000/09/14 17:43:03 $
 * $Author: mpm $
 * $Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/doacross.cxx,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/doacross.cxx,v $";
#endif /* _KEEP_RCS_ID */
...
LWN_Delete_Tree(wn_if);
  ...
  Get_Do_Loop_Info(processor_loop)->Has_Non_Intrinsic_Calls=TRUE;	// sync
  ...
  Get_Do_Loop_Info(outer_doacross)->Has_Non_Intrinsic_Calls=TRUE;	// sync
