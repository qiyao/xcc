...
*** Module: ff_pragmas.h
*** $Revision: 1.5 $
*** $Date: 2000/04/06 02:06:01 $
*** $Author: mtibuild $
*** $Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/ff_pragmas.h,v $
*** 
*** Description:
*** 
...
#ifdef _KEEP_RCS_ID
static char *ff_pragmas_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/ff_pragmas.h,v $ $Revision: 1.5 $";
#endif /* _KEEP_RCS_ID */
