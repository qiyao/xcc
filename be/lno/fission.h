...
***             WN_MAP loop_map= -1, UINT32 total_loops= 0,
***             FF_STMT_LIST *stl_1=NULL, FF_STMT_LIST *stl_2=NULL)
***
***             Similar to the above test routine except that the fission
***             is actually done. If a mapping (<> -1) is provided,
***             no legality test will be done. The mapping will guide
***             the fission instead. Returns TRUE if more than one loops
***             are formed.
***
***     FISSION_FUSION_STATUS
