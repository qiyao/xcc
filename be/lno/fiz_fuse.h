...
#ifdef _KEEP_RCS_ID
static char *fiz_fuse_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/fiz_fuse.h,v $ $Revision: 1.24 $";
#endif /* _KEEP_RCS_ID */
#endif
...
public:
  ...
  void Check();
  void Build(WN* func_nd, BOOL all_loops=FALSE, BOOL verbose=FALSE);
};
