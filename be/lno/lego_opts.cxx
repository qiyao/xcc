...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/lego_opts.cxx,v $ $Revision: 1.95 $";
...
void LEGO_INFO::Print(FILE* fp)  
{
  ...
  if (Array()) {
	...
	? ST_name(Pid_Sym0()->St()) 
	: !Preg_Is_Dedicated(Pid_Sym0()->WN_Offset())
	...
	? ST_name(Pid_Sym1()->St()) 
	: !Preg_Is_Dedicated(Pid_Sym1()->WN_Offset())
