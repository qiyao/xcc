...
#ifdef _KEEP_RCS_ID
static char *lego_opts_rcs_id = access_vector_INCLUDED "$Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/lego_opts.h,v $ $Revision: 1.24 $";
#endif /* _KEEP_RCS_ID */
...
public:
  ...
  void Print (FILE* fp) {
    fprintf (fp, "offset %d proc_wn 0x%lx index %d\n", _offset, _do_wn, _index);
  }
};
