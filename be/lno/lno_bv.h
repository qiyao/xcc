...
*** Module: lno_bv.h
*** $Revision: 1.8 $
*** $Date: 2000/04/06 02:08:51 $
*** $Author: mtibuild $
*** $Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/lno_bv.h,v $
*** 
*** Revision history:
***
...
#ifdef _KEEP_RCS_ID
static char *lno_bv_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/lno_bv.h,v $ $Revision: 1.8 $";
#endif /* _KEEP_RCS_ID */
#endif
