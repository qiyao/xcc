...
*** Module: lno_scc.h
*** $Revision: 1.13 $
*** $Date: 2000/04/06 02:09:07 $
*** $Author: mtibuild $
*** $Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/lno_scc.h,v $
*** 
*** Revision history:
***
...
***         BOOL Has_Cycles()
***
***             Returns TRUE if the directed graph contains any cycles or
***             self-cycles.
***
...
#ifdef _KEEP_RCS_ID
static char *lno_scc_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/lno_scc.h,v $ $Revision: 1.13 $";
#endif /* _KEEP_RCS_ID */
#endif
