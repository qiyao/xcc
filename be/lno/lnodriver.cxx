			        ...
			        WN *region_wn, BOOL alloca)
{
    ...
    /* Initialize the vectorizer data structures and variables early
       so that SIMD messages are handled correctly. We could and should
       probably do this once per file only. */
    SIMD_Initialize();
