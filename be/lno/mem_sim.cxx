...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/mem_sim.cxx,v $ $Revision: 1.6 $";
...
static void Instrument_Address(WN *address, BOOL is_load, INT num_bytes)
{
  ...
  LWN_Copy_Frequency(insertion_point, call);
