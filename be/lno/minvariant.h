...
//
// void Minvariant_Removal_Loop(WN *loop, ARRAY_DIRECTED_GRAPH16 *dg);
//
//      Move memory invariants out of loops enclosed in a loop as far as possible.
//      Do loops must all execute at least once.
//
...
#ifdef _KEEP_RCS_ID
static char *minvariant = "$Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/minvariant.h,v $ $Revision: 1.9 $";
#endif
#endif
