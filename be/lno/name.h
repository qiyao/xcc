...
/** $Revision: 1.7 $
*** $Date: 2000/04/06 02:11:13 $
*** $Author: mtibuild $
*** $Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/name.h,v $
**/

#ifndef NAME_RCS_ID
#define NAME_RCS_ID
#ifdef _KEEP_RCS_ID
static char *name_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/name.h,v $ $Revision: 1.7 $";
#endif /* _KEEP_RCS_ID */
#endif
