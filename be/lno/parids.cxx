...
extern void Print_Prompf_Transaction_Log(BOOL after)
{
  ...
  fclose(fp_anl);
#else
  DevWarn("Print_Prompf_Transaction_Log called");
#endif
}
...
#else
  DevWarn("Print_Prompf_Prallelization_Log called");
#endif
} 
...
{ 
  ...
  fclose(fp_anl);
#else
  DevWarn("Print_Prompf_Doacross_Log called");
#endif
}
					     ...
					     BOOL after) 
{
  ...
  fclose(fp_anl);
#else
  DevWarn("Print_Prompf_Parallel_Region_Log");
#endif
}
					        ...
					        MEM_POOL* mem_pool)
{
  ...
  fclose(fp_anl);
#else
  DevWarn("Print_Prompf_Preopt_Transaction_Log");
#endif
} 
