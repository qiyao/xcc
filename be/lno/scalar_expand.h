...
/** $Revision: 1.40 $
*** $Date: 2000/04/06 02:12:59 $
*** $Author: mtibuild $
*** $Source: /isms/cmplrs.src/osprey1.0/be/lno/RCS/scalar_expand.h,v $
**/
...
#ifdef _KEEP_RCS_ID
static char *scalar_expand_rcs_id = scalar_expand_INCLUDED "$Revision: 1.40 $";
#endif /* _KEEP_RCS_ID */
