...
***
***	WN* Wind_Down(WN* loop, INT unroll_factor, BOOL cache_winddown, 
...
***	  tate it as a register winddown loop.  Mark the windown as module    
***	  the 'unroll_factor' iterations.  Assign it an estimated
...
extern WN* Wind_Down(WN* loop, INT unroll_factor, BOOL cache_winddown,
  EST_REGISTER_USAGE est_register_usage);
