...
#ifdef _KEEP_RCS_ID
static char *opt_defsrcs_id =	opt_defs_INCLUDED"$Revision: 1.90 $";
#endif /* _KEEP_RCS_ID */
...
#define INSERT_OPT_FLAG        0x20 /* bit-insert pattern matching */
