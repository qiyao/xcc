...
#ifdef _KEEP_RCS_ID
static char *opt_durcs_id = 	opt_du_INCLUDED"$Revision: 1.34 $";
#endif /* _KEEP_RCS_ID */
...
public:
  ...
  // reaching this use.
  // DEM 10/13/04:  A value of NULL can mean either that the use is loop
  // invariant for all enclosing do loops or that the use is defined
  // in the same iteration of the innermost loop
