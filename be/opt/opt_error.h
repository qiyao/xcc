 ...
 * Module: opt_error.h
 * $Revision: 1.7 $
 * $Date: 2000/04/06 15:23:02 $
 * $Author: dlstephe $
 * $Source: /isms/cmplrs.src/osprey1.0/be/opt/RCS/opt_error.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *opt_error_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/opt/RCS/opt_error.h,v $ $Revision: 1.7 $";
#endif /* _KEEP_RCS_ID */
