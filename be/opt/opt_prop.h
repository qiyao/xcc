...
#ifdef _KEEP_RCS_ID
static char *opt_proprcs_id = 	opt_prop_INCLUDED"$Revision: 1.18 $";
#endif /* _KEEP_RCS_ID */
...
private:
  ...
  BOOL     Find_unique_definition(CODEREP            *phi_opnd,
				  slist<PHI_NODE *>  &visited,
				  STMTREP           **candidate_defstmt);
  CODEREP *Find_unique_definition(CODEREP *phi_opnd);
