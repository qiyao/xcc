...
// $Revision: 1.11 $
// $Date: 2000/04/06 15:24:55 $
// $Author: dlstephe $
// $Source: /isms/cmplrs.src/osprey1.0/be/opt/RCS/opt_region_emit.h,v $
//
// Revision history:
...
#ifdef _KEEP_RCS_ID
static char *opt_region_emitrcs_id = 	opt_region_emit_INCLUDED"$Revision: 1.11 $";
#endif /* _KEEP_RCS_ID */
