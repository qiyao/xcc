...
#ifdef _KEEP_RCS_ID
static char *opt_rvircs_id = opt_rvi_INCLUDED"$ $Revision: 1.38 $";
#endif /* _KEEP_RCS_ID */
...
private:
  ...
  // hoisting LDA to least common ancestor in the dominator tree */
  void Hoisting_lda_lcm( void );
  ...
  void Get_wn_local_lda_attributes( BB_NODE *bb, WN *wn, BOOL *check_lda, BOOL hoist_intconst );
