...
// Module: opt_util.h
// $Revision: 1.19 $
// $Date: 2000/04/06 15:26:09 $
// $Author: dlstephe $
// $Source: /isms/cmplrs.src/osprey1.0/be/opt/RCS/opt_util.h,v $
//
// Revision history:
...
#ifdef _KEEP_RCS_ID
static char *opt_utilrcs_id = 	opt_util_INCLUDED"$Revision: 1.19 $";
#endif /* _KEEP_RCS_ID */
