...
// Module: opt_vn_ivc.h
// $Revision: 1.9 $
// $Date: 2000/04/06 15:26:35 $
// $Author: dlstephe $
// $Source: /isms/cmplrs.src/osprey1.0/be/opt/RCS/opt_vn_ivc.h,v $
//
// ====================================================================
//
/* 
...
public:
   ...
   typedef typename forward_to_next_iterator<Container,Next>::reference reference;
