...
#ifdef _KEEP_RCS_ID
static char *opt_wnrcs_id = 	opt_wn_INCLUDED"$Revision: 1.102 $";
#endif /* _KEEP_RCS_ID */
...
extern BOOL Op_can_be_propagated(OPCODE op, OPT_PHASE phase, bool const_amount);
