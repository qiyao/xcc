...
typedef enum {
  ...
  RID_TYPE_eh	        = 0x4f000, /* EH region mask (all EH are transparent)*/
  ...
  RID_TYPE_rest_callee  = 0x40000  /* it's a region to restore callee saved
				      registers */
} RID_TYPE;
...
extern DLL_SHARED WN_MAP RID_map;
extern DLL_SHARED MEM_POOL REGION_mem_pool;
