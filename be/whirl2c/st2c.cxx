 ...
 * Module: st2c.c
 * $Revision: 1.58 $
 * $Date: 2000/04/06 02:20:35 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/be/whirl2c/RCS/st2c.cxx,v $
 *
 * Revision history:
 ...
 */
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/whirl2c/RCS/st2c.cxx,v $ $Revision: 1.58 $";
#endif /* _KEEP_RCS_ID */
...
#define COMMON_BLOCK_MEMBER_NAME(num) \
   Concat2_Strings("u", Number_as_String(num, "%" LLD_FMT ""))
