 ...
 * Module: stab_attr.c
 * $Revision: 1.56 $
 * $Date: 2000/08/30 17:22:02 $
 * $Author: nenad $
 * $Source: /isms/cmplrs.src/osprey1.0/be/whirl2c/RCS/stab_attr.cxx,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/whirl2c/RCS/stab_attr.cxx,v $ $Revision: 1.56 $";
#endif /* _KEEP_RCS_ID */
...
Ptr_as_String(const void *ptr)
{
   ...
   if (sizeof(void *) == sizeof(UINT32))
      ...
      sprintf(new_name, "%" LLU_FMT "", ptr_as_number.u64);
   else
