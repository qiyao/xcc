 ...
 * Module: tcon2c.c
 * $Revision: 1.21 $
 * $Date: 2000/04/06 02:20:45 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/be/whirl2c/RCS/tcon2c.cxx,v $
 *
 * Revision history:
 ...
 */
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/whirl2c/RCS/tcon2c.cxx,v $ $Revision: 1.21 $";
#endif /* _KEEP_RCS_ID */
...
TCON2C_translate(TOKEN_BUFFER tokens, TCON tvalue)
{
   ...
   case MTYPE_STR:
    ...
    case MTYPE_I8:
      Append_Token_String(tokens, Targ_Print("%1"LLD_FMT"LL", tvalue));
      break;

    case MTYPE_U8:
      Append_Token_String(tokens, Targ_Print("%1"LLU_FMT"ULL", tvalue));
      break;
