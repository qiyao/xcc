 ...
 * Module: w2c_driver.c
 * $Revision: 1.59 $
 * $Date: 2000/04/06 02:21:01 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/be/whirl2c/RCS/w2c_driver.cxx,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/whirl2c/RCS/w2c_driver.cxx,v $ $Revision: 1.59 $";
#endif /* _KEEP_RCS_ID */
...
BOOL  W2C_Safe_Tie = FALSE;  /* Always copy-in/copy-out for TIE macros if TRUE */
...
W2C_Outfile_Init(BOOL emit_global_decls)
{
   ...
   if (Is_Target_Xtensa())
     {
       Write_String(W2C_File[W2C_DOTC_FILE], W2C_File[W2C_LOC_FILE],
		    "/* You may need to include additional Xtensa specific header files. */\n\n");
     }
