 ...
 * $Revision: 1.29 $
 * $Date: 2000/04/06 02:21:21 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/be/whirl2c/RCS/whirl2c_common.h,v $
 *
 * Revision history:
...
#define CONTEXT_TIE_INTRINSIC 0x00000100     /* Processing a TIE intrinsic translation block */
#define CONTEXT_TIE_INTRINSIC_SETUP 0x00000200 /* Processing a TIE intrinsic setup block */
...
#define CONTEXT_tie_intrinsic(c) ((c).flags & CONTEXT_TIE_INTRINSIC)
#define CONTEXT_set_tie_intrinsic(c) \
   ((c).flags = (c).flags | CONTEXT_TIE_INTRINSIC)
#define CONTEXT_reset_tie_intrinsic(c) \
   ((c).flags = (c).flags  & ~CONTEXT_TIE_INTRINSIC)

#define CONTEXT_tie_intrinsic_setup(c) ((c).flags & CONTEXT_TIE_INTRINSIC_SETUP)
#define CONTEXT_set_tie_intrinsic_setup(c) \
   ((c).flags = (c).flags | CONTEXT_TIE_INTRINSIC_SETUP)
#define CONTEXT_reset_tie_intrinsic_setup(c) \
   ((c).flags = (c).flags  & ~CONTEXT_TIE_INTRINSIC_SETUP)
 ...
 */
#define WHIRL2C_number_as_c_name(number) Number_as_String(number, "_%" LLD_FMT "")
...
#define WHIRL2C_TIE_TEMP_ID "_TIE_temp_"
