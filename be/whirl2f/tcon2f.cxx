 ...
 * Module: tcon2f.c
 * $Revision: 1.3 $
 * $Date: 2000/04/06 02:21:57 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/be/whirl2f/RCS/tcon2f.cxx,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/whirl2f/RCS/tcon2f.cxx,v $ $Revision: 1.3 $";
#endif
...
TCON2F_translate(TOKEN_BUFFER tokens, TCON tvalue, BOOL is_logical)
{
   ...
   if (!is_logical)
   {
	 ...
	 break;
      ...
      case MTYPE_I8:
	 Append_Token_String(tokens, Targ_Print("%1"LLD_FMT"_8", tvalue));
	 break;
	 ...
	 break;
      ...
      case MTYPE_U8:
	 Append_Token_String(tokens, Targ_Print("%1"LLU_FMT"_8", tvalue));
	 break;
