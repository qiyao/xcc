 ...
 * $Revision: 1.11 $
 * $Date: 2000/04/06 02:22:18 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/be/whirl2f/RCS/whirl2f_common.h,v $
 *
 * Revision history:
...
#define WHIRL2F_number_as_name(number) Number_as_String(number, "%" LLD_FMT "")
