 ...
 * Module: wn2f.c
 * $Revision: 1.24 $
 * $Date: 2000/04/12 17:55:06 $
 * $Author: nenad $
 * $Source: /isms/cmplrs.src/osprey1.0/be/whirl2f/RCS/wn2f.cxx,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/whirl2f/RCS/wn2f.cxx,v $ $Revision: 1.24 $";
#endif
...
WN2F_Begin_Prompf_Transformed_Func(TOKEN_BUFFER tokens, INT32 func_id)
{
   ...
   Append_Token_String(tokens, Number_as_String(func_id, "%" LLU_FMT ""));
}
