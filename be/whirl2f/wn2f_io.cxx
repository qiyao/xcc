...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/whirl2f/RCS/wn2f_io.cxx,v $ $Revision: 1.9 $";
#endif
	       ...
	       WN2F_CONTEXT context)
{
   ...
   case IOF_LABEL:
	 ...
	 Append_Token_String(tokens, 
			     Number_as_String(Origfmt_Ioctrl_Label, "%" LLD_FMT ""));
      else
	 WN2F_translate(tokens, WN_kid0(item), context);
      break;
