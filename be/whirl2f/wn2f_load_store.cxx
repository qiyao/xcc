 ...
 * $Revision: 1.21 $
 * $Date: 2000/04/06 02:22:15 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/be/whirl2f/RCS/wn2f_load_store.cxx,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/whirl2f/RCS/wn2f_load_store.cxx,v $ $Revision: 1.21 $";
#endif
...
WN2F_Block(TOKEN_BUFFER tokens, ST * st, STAB_OFFSET offset,WN2F_CONTEXT context)
{
  ...
  {
      Append_Token_Special(tokens, '+');
      Append_Token_String(tokens, Number_as_String(offset, "%" LLD_FMT ""));
  }
}
