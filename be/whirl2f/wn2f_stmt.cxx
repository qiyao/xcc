 ...
 * $Author: mpm $
 * $Source: /isms/cmplrs.src/osprey1.0/be/whirl2f/RCS/wn2f_stmt.cxx,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/be/whirl2f/RCS/wn2f_stmt.cxx,v $ $Revision: 1.25 $";
#endif
			    ...
			    WN2F_CONTEXT   context)
{
   ...
   if (bound->const0 != 0)
   {
      ...
      Append_Token_String(bound_expr, Number_as_String(bound->const0, "%" LLD_FMT ""));
   }
