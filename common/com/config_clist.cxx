 ...
 * ====================================================================
 *
 * $Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/config_clist.cxx,v $
 *
 * Revision history:
...
static OPTION_DESC Options_CLIST[] =
{
  ...
  { OVK_BOOL,	OV_VISIBLE,	FALSE, "safe_tie",       NULL,
       0, 0, 0, &CLF.safe_tie,          NULL,
       "Always output complete copy-in/copy-out for TIE macros" },
