 ...
 * $Revision: 1.5 $
 * $Date: 2000/04/06 02:23:16 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/config_clist.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_clist_h_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/config_clist.h,v $ $Revision: 1.5 $";
#endif /* _KEEP_RCS_ID */
...
typedef struct clist_flags {
   ...
   BOOL        safe_tie;        /* Always copy-in/copy-out for TIE macros if TRUE */
...
extern DLL_SHARED CLIST_FLAGS *Current_CLIST;
...
#define CLIST_safe_tie          Current_CLIST->safe_tie;
