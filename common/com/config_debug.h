 ...
 * $Revision: 1.11 $
 * $Date: 2000/04/06 02:23:21 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/config_debug.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_debug_h_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/config_debug.h,v $ $Revision: 1.11 $";
#endif /* _KEEP_RCS_ID */
...
extern DLL_SHARED DEBUG_FLAGS *Current_DEBUG;

/* And this is always the invariant bottom of stack: */
extern DLL_SHARED DEBUG_FLAGS Initial_DEBUG;
