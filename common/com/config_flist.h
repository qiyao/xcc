 ...
 * $Revision: 1.6 $
 * $Date: 2000/04/06 02:23:29 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/config_flist.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_flist_h_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/config_flist.h,v $ $Revision: 1.6 $";
#endif /* _KEEP_RCS_ID */
...
extern DLL_SHARED FLIST_FLAGS *Current_FLIST;
