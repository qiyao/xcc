...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_lno_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/config_lno.cxx,v $ $Revision: 1.36 $";
#endif /* _KEEP_RCS_ID */
...
static LNO_FLAGS Default_LNO = {
  ...
  TRUE,		/* Minvar */
  1,		/* Opt */
  0,		/* Cache_model, (Used to be 2, changed to 0 for SIMD. p.t.) */
  TRUE,		/* Run_outer */
  0,		/* Outer_unroll */
  ...
  FALSE,	/* Run_vintr, turn-off for xtensa (p.t.) */
  TRUE,		/* Run_oinvar */
  1,		/* Run_doacross */
  ...
  0,            /* Simd_loop_after */
  0,            /* Simd_verbose */
  FALSE,        /* Aligned_formal_pointers */
  FALSE,        /* Aligned_pointers */
  FALSE,        /* Aligned_accesses */
  FALSE,        /* Aligned_loads */
  FALSE,        /* Aligned_stores */
  TRUE,         /* Fold_arrays */
  FALSE,        /* Simd_shr_safe */
  TRUE,         /* Simd_if_conv */
  FALSE,        /* Simd_agg_if_conv */
  TRUE,         /* Simd_check_guards */
...
LNO_FLAGS Initial_LNO = {
  ...
  FALSE,	/* Verbose */
  TRUE,		/* Version_mp_loops */
  FALSE,	/* Run_vintr, turn-off for xtensa (d.p.) */
  TRUE,		/* Run_oinvar */
  1,		/* Run_doacross */
  0,		/* Preferred_doacross_tile_size */
  2600,         /* Parallel_overhead */ 
...
static OPTION_DESC Options_LNO[] = {
  ...
  LNOPT_BOOL ( "test_call_info",        NULL,   Test_call_info ), 
  LNOPT_BOOL ( "call_info",             NULL,   Call_info ), 
  ...
  LNOPT_U32  ( "num_iters",             NULL,   100,0,999999,Num_Iters),
  ...
  LNOPT_U32  ( "simd", 	                NULL,   1,0,100,Simd_level),
  LNOPT_U32  ( "simd_before", 	        NULL,   0,1,999999,Simd_loop_before),
  LNOPT_U32  ( "simd_after", 	        NULL,   0,1,999999,Simd_loop_after),
  LNOPT_U32  ( "simd_verbose",      "simd_v",   1,1,999999,Simd_verbose),
  LNOPT_BOOL ( "aligned_formal_pointers", NULL, Aligned_formal_pointers),
  LNOPT_BOOL ( "aligned_pointers", NULL, Aligned_pointers),
  LNOPT_BOOL ( "aligned_accesses", "aligned_acc", Aligned_accesses),
  LNOPT_BOOL ( "aligned_loads", NULL, Aligned_loads),
  LNOPT_BOOL ( "aligned_stores", NULL, Aligned_stores),
  LNOPT_BOOL ( "fold_arrays", NULL,   Fold_arrays),
  LNOPT_BOOL ( "simd_shr_safe", NULL, Simd_shr_safe),
  LNOPT_BOOL ( "simd_if_conv", NULL, Simd_if_conv),
  LNOPT_BOOL ( "simd_agg_if_conv", NULL, Simd_agg_if_conv),
  LNOPT_BOOL ( "simd_check_guards", NULL, Simd_check_guards),
...
LNO_Configure ( void )
{
  ...
  if (LNO_SIMD_Verbose>0 && LNO_SIMD_Level==0) {
    fprintf(stdout, "(SIMD_DISABLED) Vectorization is not enabled, use -O3 -LNO:simd=1 to turn it on.\n");
    LNO_SIMD_Verbose = 0;
  }
