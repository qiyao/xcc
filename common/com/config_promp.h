 ...
 * $Revision: 1.5 $
 * $Date: 2000/04/06 02:23:59 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/config_promp.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_promp_h_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/config_promp.h,v $ $Revision: 1.5 $";
#endif /* _KEEP_RCS_ID */
...
extern DLL_SHARED PROMP_FLAGS *Current_PROMP;
