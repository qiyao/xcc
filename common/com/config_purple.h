...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_purple_h_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/config_purple.h,v $ $Revision: 1.3 $";
#endif /* _KEEP_RCS_ID */
...
extern DLL_SHARED PURPLE_FLAGS *Current_PURPLE;
