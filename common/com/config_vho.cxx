 ...
 * Module: config_vho.c
 * $Revision: 1.8 $
 * $Date: 2000/04/06 02:24:07 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/config_vho.cxx,v $
 *
 * Revision history:
 *
 * Description:
...
BOOL   VHO_Switch_If_Else_Set              = FALSE;
...
static OPTION_DESC Options_VHO[] = {
  ...
  { OVK_INT32,	OV_INTERNAL,	FALSE, "switch_if_else",      "switch_if_else",
    6, 1, INT32_MAX,    &VHO_Switch_If_Else_Limit,   &VHO_Switch_If_Else_Set },
