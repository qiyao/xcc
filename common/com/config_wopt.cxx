 ...
 * $Revision: 1.148 $
 * $Date: 2000/04/06 02:24:12 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/config_wopt.cxx,v $
 *
 * Revision history:
...
BOOL  WOPT_Enable_DCE_Alias = TRUE;  /* enable to eliminate dead store #4634 */
...
#ifdef TARG_XTENSA
BOOL  WOPT_Enable_New_SR_Limit = 2;
#else
BOOL  WOPT_Enable_New_SR_Limit = 0;
#endif
BOOL  WOPT_Enable_Output_Copy = TRUE;
INT32 WOPT_Enable_Ocopy_Lookupstmt = 3; /* fix xcalibur #1991, from 2 to 3 */
...
BOOL  WOPT_Enable_Undef_Prop = TRUE;
BOOL  WOPT_Enable_Undef_Aggressive_Prop = TRUE;
...
BOOL  WOPT_Enable_Rvi_Uninitialized = TRUE; /* enable RVI of uninitialized */
...
/* Xtensa doesn't support Enable Bits Load yet */
BOOL  WOPT_Enable_Bits_Load_Store = FALSE; // accept LDBITS, STBITS, etc.
...
BOOL  WOPT_Enable_Expand_MPY_Const = TRUE; // Enable expand mpy by constant 

UINT32 WOPT_Always_Fold_Const_Term = 0; 
...
static OPTION_DESC Options_WOPT[] = {
  ...
  { OVK_BOOL,	OV_INTERNAL,	TRUE, "undef_prop",	"undef_p",
    0, 0, 0,	&WOPT_Enable_Undef_Prop, NULL },
  { OVK_BOOL,	OV_INTERNAL,	TRUE, "undef_aggressive",	"undef_a",
    0, 0, 0,	&WOPT_Enable_Undef_Aggressive_Prop, NULL },
  ...
  { OVK_BOOL,	OV_INTERNAL,	TRUE, "uninitd_rvi",		"",
    0, 0, 0,	&WOPT_Enable_Rvi_Uninitialized, NULL },
  ...
  { OVK_BOOL,	OV_INTERNAL,	FALSE, "epre4ivr",	"epre4ivr",
  ...
  { OVK_BOOL,	OV_INTERNAL,	TRUE, "expand_mpy_const","expand_mpy",
    TRUE, 0, 0,	&WOPT_Enable_Expand_MPY_Const, NULL },
  { OVK_UINT32,	OV_INTERNAL,	TRUE, "fold_const_term","fold_const_term",
    0, 0, 2,	&WOPT_Always_Fold_Const_Term, NULL },
