...
#ifdef _KEEP_RCS_ID
static char *dwarf_DST_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/dwarf_DST.h,v $ $Revision: 1.45 $";
#endif /* _KEEP_RCS_ID */
...
typedef UINT8  DST_access;        /* AT_accessibility (members, inheritance) */
typedef UINT8  DST_virtuality;    /* AT_virtuality (member functions, bases) */
...
typedef struct DST_subpr_decl
{
   ...
   DST_access     access;     /* AT_accessibility codes */
   ...
   DST_INFO_IDX	  parent;     /* if member function, point to parent dst */
} DST_SUBPR_DECL;
...
#define DST_SUBPROGRAM_decl_access(attr) ((attr)->decl.access)
...
#define DST_SUBPROGRAM_decl_parent(attr) ((attr)->decl.parent)
...
#define DST_SUBPROGRAM_def_parent(attr) ((attr)->def.parent)
...
#define DST_MEMBER_access(attr) ((attr)->access)
...
#define DST_INHERITANCE_access(attr)    ((attr)->access)
