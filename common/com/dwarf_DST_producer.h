...
#ifdef _KEEP_RCS_ID
static char *dwarf_DST_producer_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/dwarf_DST_producer.h,v $ $Revision: 1.42 $";
#endif /* _KEEP_RCS_ID */
...
DST_mk_subprogram(USRCPOS      decl,
		  ...
		  BOOL         is_prototyped,
		  BOOL         is_external,
		  DST_access   access = DW_ACCESS_public);
...
DST_mk_class_type(USRCPOS      decl,      /* Source location */
		  ...
		  DST_INFO_IDX abstract_origin,
		  DST_INFO_IDX inheritance, /* type with the vtable */
		  BOOL         is_incomplete,
