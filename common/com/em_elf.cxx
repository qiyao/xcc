 ...
 * Module: em_elf.c
 * $Revision: 1.87 $
 * $Date: 2000/04/06 02:25:05 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/em_elf.cxx,v $
 *
 * Description:
 *
    ...
    Elf64_Word align)
{
	...
	Increase_Data_Buffer_Size (scninfo, newoffset + BUFSIZ);
      ...
      if (length > 0) {
	memcpy(SCNINFO_buffer(scninfo) + index, (const char *)input_buf,
	       length);
      }
    }
...
/* Undefine a symbol that was previous entered */
void
