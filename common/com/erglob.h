...
#ifdef _KEEP_RCS_ID
static char *erglob_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/erglob.h,v $ $Revision: 2.56 $";
#endif /* _KEEP_RCS_ID */
...
#define EC_Simd_Opt_Lev EC_Undef_Code+66        /* none */
#define EC_Simd_Unsupported EC_Undef_Code+67    /* none */
...
#define EC_Bad_Align	EC_Undef_Code+152	/* str */
...
#define EC_Ill_Initializer EC_Undef_Code+208	/* none */
...
/* ASM operands: */
#define EC_Inv_Asm	EC_Undef_Code+340	/* none */
#define EC_Inv_Asm_Opnd	EC_Undef_Code+341	/* none */
#define EC_Asm_Rodata	EC_Undef_Code+342	/* none */
...
#define EC_FB_File_Version EC_BASE_FILE+79      /* str */
#define EC_FB_File_Options EC_BASE_FILE+80      /* str */
#define EC_FB_File_Fmt	EC_BASE_FILE+81		/* str, str */
#define EC_FB_Dup_Scn	EC_BASE_FILE+82		/* str, str */
#define EC_FB_Miss_Scn	EC_BASE_FILE+83		/* str, str */
#define EC_FB_Unk_Scn	EC_BASE_FILE+84		/* str */
#define EC_FB_Ent_Size	EC_BASE_FILE+85		/* str, str, int, int */
#define EC_FB_File_Old  EC_BASE_FILE+86	 	/* str */
#define EC_FB_FILE_MISSING EC_BASE_FILE+87      /* str */

/* other feedback error codes: */
#define EC_FB_Unknown_Freq EC_BASE_FILE+88       /* str */
#define EC_FB_Missing_Data EC_BASE_FILE+89       /* str */
#define EC_FB_Cant_Instrument EC_BASE_FILE+90    /* str */

/* CIF file error codes: */
#define EC_Cif_Open     EC_BASE_FILE+91		/* str, err */
#define EC_Cif_Write    EC_BASE_FILE+92		/* str, err */
#define EC_Cif_Close    EC_BASE_FILE+93		/* str, err */
#define EC_GI_Fork      EC_BASE_FILE+94		/* str, err */
#define EC_GI_Exec      EC_BASE_FILE+95		/* str, err */
