...
// $Revision: 1.11 $
// $Date: 2000/04/06 02:25:53 $
// $Author: mtibuild $
// $Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/instr_reader.h,v $
//
// Revision history:
...
#define prof_FREAD(_buffer, _size, _nitems, _fp, _error_message, _error_arg) \
...
struct PU_Profile_Handle
{
  ...
  bool inited;
    ...
    PU_Profile_Handle (char* pname = NULL, INT32 c_sum = 0, INT32 o_flags = 0) :
	pu_name (pname),
        checksum (c_sum),
        opt_flags (o_flags),
     {
...
extern DLL_SHARED FB_FREQ Total_Cycle_Count;
extern DLL_SHARED BOOL Feedback_Enabled[PROFILE_PHASE_LAST];
...
extern INT32 Get_PU_Optimization_Level(PU_PROFILE_HANDLE pu_handle);
