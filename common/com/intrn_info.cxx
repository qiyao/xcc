...
const intrn_info_t intrn_info[INTRINSIC_CORE_LAST+1] = {
  { /* NONE */
  ...
  { /* I4FFS */
	BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_I4, "ffs", "I4FFS", "__ffssi2"},
  { /* SAVEREGS */
	BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_PV, "saveregs", "SAVEREGS", "__saveregs__"},
  { /* I4CLZ */
	BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_I4, NULL, NULL, "__clzsi2"},
  { /* I4CTZ */
	BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_I4, NULL, NULL, "__ctzsi2"},
  { /* UMULSIDI3 */
	BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_U8, NULL, NULL, "__umulsidi3"},
};
