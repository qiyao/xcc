 ...
 */
#ifdef BACK_END
extern DLL_SHARED BOOL Write_BE_Maps;
extern DLL_SHARED BOOL Write_AC_INTERNAL_Map;
extern DLL_SHARED BOOL Write_ALIAS_CLASS_Map;
#endif /* BACK_END */
...
typedef struct output_file {
    ...
    void *mapHd;		    /* Handle for mapped region */
#endif
...
extern DLL_SHARED Output_File *Current_Output;

/* Call these once at the beginning and end, respectively. */
extern Output_File *WN_open_output (char *file_name);
extern void WN_close_output (Output_File *fl, unsigned int output_type = ET_IR);
...
extern void Close_Output_Info (unsigned int output_type = ET_IR);
extern void WN_write_elf_symtab (const void* symtab, UINT64 size,
				 UINT64 entsize, UINT align, Output_File* fl);

#ifdef BACK_END
/* Write autotie information. */
extern void Write_Global_Autotie_Info (PU_Info *pu_tree);
extern void Write_Autotie_PU_Info (PU_Info *pu);
#endif
