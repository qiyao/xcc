...
#ifdef _KEEP_RCS_ID
static char *opt_irrcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/ir_reader.h,v $ $Revision: 1.63 $";
#endif /* _KEEP_RCS_ID */
...
extern DLL_SHARED BOOL IR_dump_map_info;
/* whether to dump the region OPs info; defaults to FALSE */
extern DLL_SHARED BOOL IR_dump_region;
/* whether to dump the line numbers; defaults to FALSE */
extern DLL_SHARED BOOL IR_dump_line_numbers;
