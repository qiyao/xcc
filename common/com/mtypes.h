 ...
 * Module: mtypes.h
 * $Revision: 2.32 $
 * $Date: 2000/04/06 02:26:32 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/mtypes.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *mtypes_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/mtypes.h,v $ $Revision: 2.32 $";
#endif /* _KEEP_RCS_ID */

#define MTYPE_MAX	128	/* 7-bits for mtype in WHIRL */
...
/* these are initialized in libti.cxx */
#define MTYPE_XTBOOL	28	/* 1-bit xtbool */
#define MTYPE_XTBOOL2	29	/* 2-bit xtbool */
#define MTYPE_XTBOOL4	30	/* 4-bit xtbool */
#define MTYPE_XTBOOL8	31	/* 8-bit xtbool */
#define MTYPE_XTBOOL16	32	/* 16-bit xtbool */

/* must define MTYPE_CORE_LAST as the index of the last one defined. */
#define MTYPE_CORE_LAST	32	/* Must be defined */
...
extern DLL_SHARED TYPE_ID		Mtype_Last;

// built_in TIE types (e.g., int) map to pre-defined mtypes (e.g., MTYPE_I4)
// so they do not need to add any new mtypes
extern DLL_SHARED UINT8			Num_Built_In;
...
#define MTYPE_CLASS_TIE		0x20
#define MTYPE_CLASS_XTBOOL	0x40
#define MTYPE_CLASS_TIE_PACKED	0x80
...
typedef struct type_desc {
  ...
  mUINT16	num_pregs;	/* was dummy1, used for packed mtype */
...
#define MTYPE_num_pregs(n)	(Machine_Types[n].num_pregs)
...
#define MTYPE_is_tie(n)		(MTYPE_type_class(n) & MTYPE_CLASS_TIE)
#define MTYPE_is_xtbool(n)	(MTYPE_type_class(n) & MTYPE_CLASS_XTBOOL)
#define MTYPE_is_tie_packed(n)	(MTYPE_type_class(n) & MTYPE_CLASS_TIE_PACKED)
...
extern DLL_SHARED MTYPE_MASK Machine_Types_Available;
