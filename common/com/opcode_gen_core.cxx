...
static BOOL
Is_MTYPE_b_f_i_M_p_z [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  1, /* MTYPE_B       */
  0, /* MTYPE_I1      */
  0, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_b_f_i_M_p_V_z [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  1, /* MTYPE_B       */
  0, /* MTYPE_I1      */
  0, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_b_f_i_M_p_s_z [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  1, /* MTYPE_B       */
  1, /* MTYPE_I1      */
  1, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_b_f_i_p_z [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  1, /* MTYPE_B       */
  0, /* MTYPE_I1      */
  0, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_bs_I1_I2_I4_I8 [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  0, /* MTYPE_B       */
  1, /* MTYPE_I1      */
  1, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_bs_U1_U2_U4_U8 [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  0, /* MTYPE_B       */
  0, /* MTYPE_I1      */
  0, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_b_bs_f_i_p_s_z [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  1, /* MTYPE_B       */
  1, /* MTYPE_I1      */
  1, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_b_bs_f_i_M_p_s_z [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  1, /* MTYPE_B       */
  1, /* MTYPE_I1      */
  1, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_f_I4_I8_I16 [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  0, /* MTYPE_B       */
  0, /* MTYPE_I1      */
  0, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_f_i_M_p_V_z [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  0, /* MTYPE_B       */
  0, /* MTYPE_I1      */
  0, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_f_i_M_p_s_V_z [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  0, /* MTYPE_B       */
  1, /* MTYPE_I1      */
  1, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_f_i_M_p_s_z [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  0, /* MTYPE_B       */
  1, /* MTYPE_I1      */
  1, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_f_i_M_p_z [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  0, /* MTYPE_B       */
  0, /* MTYPE_I1      */
  0, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_f_i_M_z [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  0, /* MTYPE_B       */
  0, /* MTYPE_I1      */
  0, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_f_i [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  0, /* MTYPE_B       */
  0, /* MTYPE_I1      */
  0, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_f_i_p [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  0, /* MTYPE_B       */
  0, /* MTYPE_I1      */
  0, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_f_i_p_s_z [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  0, /* MTYPE_B       */
  1, /* MTYPE_I1      */
  1, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_f_i_p_z [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  0, /* MTYPE_B       */
  0, /* MTYPE_I1      */
  0, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_f_i_z [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  0, /* MTYPE_B       */
  0, /* MTYPE_I1      */
  0, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_f_z [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  0, /* MTYPE_B       */
  0, /* MTYPE_I1      */
  0, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_b_i_p [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  1, /* MTYPE_B       */
  0, /* MTYPE_I1      */
  0, /* MTYPE_I2      */
...
static BOOL
Is_MTYPE_b_i_s [MTYPE_CORE_LAST+1] = {
  0, /* MTYPE_UNKNOWN */
  1, /* MTYPE_B       */
  1, /* MTYPE_I1      */
  1, /* MTYPE_I2      */
...
static
BOOL
Is_Valid_Tie_Opcode_Parts (OPERATOR opr, TYPE_ID rtype, TYPE_ID desc)
{
  /* TIE types are greater than MTYPE_CORE_LAST and are allowed to appear on
     certain operators (mainly loads and stores)
  */

  if (MTYPE_is_tie(rtype)==false && MTYPE_is_xtbool(rtype)==false &&
      MTYPE_is_tie(desc)==false && MTYPE_is_xtbool(desc)==false)
    return FALSE;

  if (opr == OPR_LDID || opr == OPR_ILOAD || opr == OPR_ILOADX) {
    /* allow LS32/LS16 be represented as vec8x32I4LDID etc. */
    return (rtype == desc || 
	    (tie_info &&
		(tie_info->mtype_rtor_macro(desc,rtype) ||
		 tie_info->mtype_mtor_macro(desc,rtype) ||
		 tie_info->mtype_rtom_macro(desc,rtype))));

  } else if (opr == OPR_STID || opr == OPR_ISTORE || opr == OPR_ISTOREX) {
    if (rtype != MTYPE_V)
	return FALSE;
    else
	return TRUE;
    ...
    return TRUE;
  } else if (opr == OPR_CSELECT || opr == OPR_SELECT) {
    if (MTYPE_is_tie(rtype) || MTYPE_is_xtbool(rtype))
      return TRUE;
  }

  if (MTYPE_is_xtbool(rtype) && desc==MTYPE_V) {
    if (opr == OPR_BNOT || opr == OPR_BAND ||
        opr == OPR_BIOR || opr == OPR_BXOR)
      return TRUE;
  }
...
BOOL
Is_Valid_Core_Opcode_Parts (OPERATOR opr, TYPE_ID rtype, TYPE_ID desc)
{
  BOOL valid;

       if (opr   < OPERATOR_FIRST || opr   > OPERATOR_LAST) valid = FALSE;
  else if (rtype < MTYPE_FIRST    || rtype > MTYPE_CORE_LAST)    valid = FALSE;
  else if (desc  < MTYPE_FIRST    || desc  > MTYPE_CORE_LAST)    valid = FALSE;
...
Is_Valid_Opcode_Parts (OPERATOR opr, TYPE_ID rtype, TYPE_ID desc)
{
  ...
  if (Is_Valid_Tie_Opcode_Parts(opr,rtype,desc))
    return TRUE;

  /* xtbool types are part of core (i.e. static) but should be handled
     by Is_Valid_Tie_Opcode_Parts() so if we reach here with xtbool types,
     it is not a valid combination
  */
  if (MTYPE_is_xtbool(rtype) || MTYPE_is_xtbool(desc))
    return FALSE;

  if (Is_Valid_Core_Opcode_Parts(opr,rtype,desc))
    return TRUE;
...
{
  OPERATOR opr   = (OPERATOR) (((UINT32) opc) & OPERATOR_BIT_MASK);
  TYPE_ID  rtype = (TYPE_ID)  ((((UINT32) opc) >> OPERATOR_BIT_SIZE) &
			RTYPE_BIT_MASK);
  TYPE_ID  desc  = (TYPE_ID)  ((((UINT32) opc) >>
			(OPERATOR_BIT_SIZE+RTYPE_BIT_SIZE)) &
			DESC_BIT_MASK);
