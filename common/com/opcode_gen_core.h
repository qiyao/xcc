...
extern DLL_SHARED struct OPERATOR_info_struct {
  char		  _name[23];
  mINT8		  nkids;
...
#define OPERATOR_BIT_SIZE	8
#define RTYPE_BIT_SIZE		7
#define DESC_BIT_SIZE		7
#define OPERATOR_BIT_MASK	0xFF
#define RTYPE_BIT_MASK		0x7F
#define DESC_BIT_MASK		0x7F
#define LAST_OPCODE_BITS	0x3FFFFF

#define RTYPE(x) (x<<OPERATOR_BIT_SIZE)
#define DESC(x)  (x<<(OPERATOR_BIT_SIZE+RTYPE_BIT_SIZE))
...
typedef enum {
  ...
  OPC_U4LNOT             = OPR_LNOT + RTYPE(MTYPE_U4) + DESC(MTYPE_V),
  ...
  OPC_XTBOOLXTBOOLLDID   = OPR_LDID + RTYPE(MTYPE_XTBOOL) + DESC(MTYPE_XTBOOL),
  OPC_XTBOOLSTID         = OPR_STID + RTYPE(MTYPE_V) + DESC(MTYPE_XTBOOL),
  OPC_XTBOOLXTBOOLILOAD  = OPR_ILOAD + RTYPE(MTYPE_XTBOOL) + DESC(MTYPE_XTBOOL),
  OPC_XTBOOLISTORE       = OPR_ISTORE + RTYPE(MTYPE_V) + DESC(MTYPE_XTBOOL),
  OPC_XTBOOL2XTBOOL2LDID = OPR_LDID+RTYPE(MTYPE_XTBOOL2)+DESC(MTYPE_XTBOOL2),
  OPC_XTBOOL2STID        = OPR_STID + RTYPE(MTYPE_V) + DESC(MTYPE_XTBOOL2),
  OPC_XTBOOL2XTBOOL2ILOAD= OPR_ILOAD+RTYPE(MTYPE_XTBOOL2)+DESC(MTYPE_XTBOOL2),
  OPC_XTBOOL2ISTORE      = OPR_ISTORE + RTYPE(MTYPE_V) + DESC(MTYPE_XTBOOL2),
  OPC_XTBOOL4XTBOOL4LDID = OPR_LDID+RTYPE(MTYPE_XTBOOL4)+DESC(MTYPE_XTBOOL4),
  OPC_XTBOOL4STID        = OPR_STID + RTYPE(MTYPE_V) + DESC(MTYPE_XTBOOL4),
  OPC_XTBOOL4XTBOOL4ILOAD= OPR_ILOAD+RTYPE(MTYPE_XTBOOL4)+DESC(MTYPE_XTBOOL4),
  OPC_XTBOOL4ISTORE      = OPR_ISTORE + RTYPE(MTYPE_V) + DESC(MTYPE_XTBOOL4),
  OPC_XTBOOL8XTBOOL8LDID = OPR_LDID+RTYPE(MTYPE_XTBOOL8)+DESC(MTYPE_XTBOOL8),
  OPC_XTBOOL8STID        = OPR_STID + RTYPE(MTYPE_V) + DESC(MTYPE_XTBOOL8),
  OPC_XTBOOL8XTBOOL8ILOAD= OPR_ILOAD+RTYPE(MTYPE_XTBOOL8)+DESC(MTYPE_XTBOOL8),
  OPC_XTBOOL8ISTORE      = OPR_ISTORE + RTYPE(MTYPE_V) + DESC(MTYPE_XTBOOL8),
  OPC_XTBOOL16XTBOOL16LDID=OPR_LDID+RTYPE(MTYPE_XTBOOL16)+DESC(MTYPE_XTBOOL16),
  OPC_XTBOOL16STID        = OPR_STID + RTYPE(MTYPE_V) + DESC(MTYPE_XTBOOL16),
  OPC_XTBOOL16XTBOOL16ILOAD=OPR_ILOAD+RTYPE(MTYPE_XTBOOL16)+DESC(MTYPE_XTBOOL16),
  OPC_XTBOOL16ISTORE      = OPR_ISTORE + RTYPE(MTYPE_V) + DESC(MTYPE_XTBOOL16),

  OPC_XTBOOLI4CVT         = OPR_CVT + RTYPE(MTYPE_XTBOOL)   + DESC(MTYPE_I4),
  OPC_XTBOOL2I4CVT        = OPR_CVT + RTYPE(MTYPE_XTBOOL2)  + DESC(MTYPE_I4),
  OPC_XTBOOL4I4CVT        = OPR_CVT + RTYPE(MTYPE_XTBOOL4)  + DESC(MTYPE_I4),
  OPC_XTBOOL8I4CVT        = OPR_CVT + RTYPE(MTYPE_XTBOOL8)  + DESC(MTYPE_I4),
  OPC_XTBOOL16I4CVT       = OPR_CVT + RTYPE(MTYPE_XTBOOL16) + DESC(MTYPE_I4),

  OPC_I4XTBOOLCVT         = OPR_CVT + RTYPE(MTYPE_I4)   + DESC(MTYPE_XTBOOL),
  OPC_I4XTBOOL2CVT        = OPR_CVT + RTYPE(MTYPE_I4)  + DESC(MTYPE_XTBOOL2),
  OPC_I4XTBOOL4CVT        = OPR_CVT + RTYPE(MTYPE_I4)  + DESC(MTYPE_XTBOOL4),
  OPC_I4XTBOOL8CVT        = OPR_CVT + RTYPE(MTYPE_I4)  + DESC(MTYPE_XTBOOL8),
  OPC_I4XTBOOL16CVT       = OPR_CVT + RTYPE(MTYPE_I4) + DESC(MTYPE_XTBOOL16),

  OPC_XTBOOLU4CVT         = OPR_CVT + RTYPE(MTYPE_XTBOOL)   + DESC(MTYPE_U4),
  OPC_XTBOOL2U4CVT        = OPR_CVT + RTYPE(MTYPE_XTBOOL2)  + DESC(MTYPE_U4),
  OPC_XTBOOL4U4CVT        = OPR_CVT + RTYPE(MTYPE_XTBOOL4)  + DESC(MTYPE_U4),
  OPC_XTBOOL8U4CVT        = OPR_CVT + RTYPE(MTYPE_XTBOOL8)  + DESC(MTYPE_U4),
  OPC_XTBOOL16U4CVT       = OPR_CVT + RTYPE(MTYPE_XTBOOL16) + DESC(MTYPE_U4),

  OPC_U4XTBOOLCVT         = OPR_CVT + RTYPE(MTYPE_U4)   + DESC(MTYPE_XTBOOL),
  OPC_U4XTBOOL2CVT        = OPR_CVT + RTYPE(MTYPE_U4)  + DESC(MTYPE_XTBOOL2),
  OPC_U4XTBOOL4CVT        = OPR_CVT + RTYPE(MTYPE_U4)  + DESC(MTYPE_XTBOOL4),
  OPC_U4XTBOOL8CVT        = OPR_CVT + RTYPE(MTYPE_U4)  + DESC(MTYPE_XTBOOL8),
  OPC_U4XTBOOL16CVT       = OPR_CVT + RTYPE(MTYPE_U4) + DESC(MTYPE_XTBOOL16),

  OPC_XTBOOLBAND          = OPR_BAND + RTYPE(MTYPE_XTBOOL) + DESC(MTYPE_V),
  OPC_XTBOOLBIOR          = OPR_BIOR + RTYPE(MTYPE_XTBOOL) + DESC(MTYPE_V),
  OPC_XTBOOLBXOR          = OPR_BXOR + RTYPE(MTYPE_XTBOOL) + DESC(MTYPE_V),
  OPC_XTBOOLBNOT          = OPR_BNOT + RTYPE(MTYPE_XTBOOL) + DESC(MTYPE_V),

  OPC_XTBOOLCALL          = OPR_CALL + RTYPE(MTYPE_XTBOOL) + DESC(MTYPE_V),
  OPC_XTBOOL2CALL         = OPR_CALL + RTYPE(MTYPE_XTBOOL2) + DESC(MTYPE_V),
  OPC_XTBOOL4CALL         = OPR_CALL + RTYPE(MTYPE_XTBOOL4) + DESC(MTYPE_V),
  OPC_XTBOOL8CALL         = OPR_CALL + RTYPE(MTYPE_XTBOOL8) + DESC(MTYPE_V),
  OPC_XTBOOL16CALL        = OPR_CALL + RTYPE(MTYPE_XTBOOL16) + DESC(MTYPE_V),

  OPC_XTBOOLSELECT        = OPR_SELECT + RTYPE(MTYPE_XTBOOL) + DESC(MTYPE_V),
  OPC_XTBOOL2SELECT       = OPR_SELECT + RTYPE(MTYPE_XTBOOL2) + DESC(MTYPE_V),
  OPC_XTBOOL4SELECT       = OPR_SELECT + RTYPE(MTYPE_XTBOOL4) + DESC(MTYPE_V),
  OPC_XTBOOL8SELECT       = OPR_SELECT + RTYPE(MTYPE_XTBOOL8) + DESC(MTYPE_V),
  OPC_XTBOOL16SELECT      = OPR_SELECT + RTYPE(MTYPE_XTBOOL16) + DESC(MTYPE_V),

#ifdef TARG_XTENSA
  //
  // On xtensa, we use OPC_TN to hold a TN, so that we can use pattern-matching
  // for expansion routines.
  //
  OPC_TN                 = OPR_TN + RTYPE(MTYPE_V) + DESC(MTYPE_V),
#endif
  OPCODE_LAST            = LAST_OPCODE_BITS
