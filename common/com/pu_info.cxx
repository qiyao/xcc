...
Sizeof_PU_Infos (PU_Info *pu_tree)
{
    ...
    num_PUs = Number_PU_Infos(pu_tree, 0, /* set_maptab */ TRUE);
...
INT
Number_PU_Infos (PU_Info *pu_tree, INT num_PUs, BOOL set_maptab)
{
    PU_Info *pu;
	...
	PU_Info_maptab(pu) = (struct wn_map_tab *)num_PUs;
      ...
      if (PU_Info_child(pu)) {
        num_PUs = Number_PU_Infos(PU_Info_child(pu), num_PUs, set_maptab);
      }
    }
    return num_PUs;
}
