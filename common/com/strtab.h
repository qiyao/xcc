...
extern STR_TAB_BUFFER *Strtab_new_str_tab_buffer();
...
// [CG]: New interface to get continuous buffer
class STR_TAB_BUFFER;
extern STR_TAB_BUFFER *TCON_new_str_tab_buffer();
...
#else
  typedef __gnu_cxx::hash_map<STR_IDX, STR_IDX, __gnu_cxx::hash<STR_IDX>, __gnu_cxx::equal_to<STR_IDX>,
      mempool_allocator<__gnu_cxx::pair<const STR_IDX, STR_IDX> > > rep_type;
#endif
  rep_type rep;  
