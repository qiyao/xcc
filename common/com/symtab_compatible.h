...
ST_type (const ST* s) {
	...
	return s->u2.type;
    case CLASS_FUNC:
      //There are cases where one doesn't know the sym_class of the ST,
      //and hiding the details of determining it is appropriate, so 
      //we don't need this dev warn any more
