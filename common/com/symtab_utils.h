...
//----------------------------------------------------------------------
extern DLL_SHARED TY_IDX MTYPE_TO_TY_array[MTYPE_MAX];
#define MTYPE_To_TY(t)	MTYPE_TO_TY_array[t]
#define Be_Type_Tbl(t)	MTYPE_TO_TY_array[t]
		    
// Well known predefined types
extern DLL_SHARED TY_IDX Void_Type, FE_int_Type, FE_double_Type;
extern DLL_SHARED TY_IDX Spill_Int_Type, Spill_Float_Type;
extern DLL_SHARED TY_IDX Tie_Output_Volatile_Type;
extern DLL_SHARED TY_IDX Tie_Output_Struct_Type;
 ...
 */
extern DLL_SHARED ST* MTYPE_TO_PREG_array[MTYPE_MAX];
...
extern DLL_SHARED ST	*Int_Preg, *Float_Preg, *Return_Val_Preg;	/* for pseudo-registers */
extern DLL_SHARED ST	*Tie_Output_Volatile_Preg;	/* for tie intrinsics */
