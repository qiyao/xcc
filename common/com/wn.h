...
***	)
***
***	     Return Bool if WN has feedback information
***	     There is no way (currently) to do this reliably, ie. if the wn
***	     has a valid map, we cannot determine if the frequency is correct
***
***	INT32 WN_Get_Feedback (
***	    const WN *wn
***	)
***
***	     Return WN feedback information (if Cur_PU_Feedback and maps exist)
***
***
***	void WN_Set_Feedback (
***	    WN *wn,
***	    INT32 freq
***	)
***
***	     Set WN feedback information (if Cur_PU_Feedback and maps exist)
***
***
***
...
***		TYPE_ID	rtype
***	)
***             Return a part node which reads a part of a TIE intrinsic output
***
**/
...
extern DLL_SHARED MEM_POOL *WN_mem_pool_ptr;

extern WN *WN_Create(OPERATOR opr, TYPE_ID rtype, TYPE_ID desc, mINT16 kid_count);
inline WN *WN_Create(OPCODE opcode, mINT16 kid_count) {
...
extern BOOL Valid_Feedback(const WN *wn);

extern INT32 WN_Get_Feedback(const WN *wn);

extern void WN_Set_Feedback(WN *wn, INT32 freq);
...
extern WN *WN_CreateLoopInfo (WN *induction, WN *trip, UINT16 trip_est, UINT16 depth,
...
extern WN *WN_CreateTn( TN * );

WN *WN_CreateOutpart(WN *intr_out, INT part, TYPE_ID rtype);
...
extern BOOL WN_verifier(WN *, BOOL);
