...
#ifdef _KEEP_RCS_ID
static char *wn_map_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/wn_map.h,v $ $Revision: 1.28 $";
#endif /* _KEEP_RCS_ID */
...
/* feedback value is possibly valid, however it is unlikely */
#define	WN_FB_PROBABLY_UNINITIALIZED	(-1)
...
extern DLL_SHARED WN_MAP_TAB *Current_Map_Tab;
