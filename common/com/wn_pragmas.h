 ...
 * Module: wn_pragmas.h
 * $Revision: 1.76 $
 * $Date: 2000/04/06 02:28:15 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/wn_pragmas.h,v $
 *
 * Description:
 *
...
#ifdef _KEEP_RCS_ID
static char *pragmas_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/wn_pragmas.h,v $ $Revision: 1.76 $";
#endif /* _KEEP_RCS_ID */
...
typedef enum {
  ...
  WN_PRAGMA_SIMD_IF_CONVERT,	/* aggressive if-conversion	*/

  /* XPRES pragmas */
  
  WN_PRAGMA_XPRES_GENERATE_HW,	/* generate xpres hardware */

  /* SWP pragmas */
  
  WN_PRAGMA_SUPER_SWP,		/* search exhaustively for modulo schedule */
  WN_PRAGMA_SWP_SCHEDULE,	/* provide a schedule to avoid long swp scheduling */
...
#define WN_PRAGMA_PAGE_ALLOCATE WN_PRAGMA_PAGE_PLACE	/* to be removed */
  ...
  WN_PRAGMA_FILL,
  WN_PRAGMA_ALIGN,
  WN_PRAGMA_ALIGNED,            /* symbol aligned at a specified boundary */
...
extern DLL_SHARED WN_PRAGMA_DESC WN_pragmas[];
