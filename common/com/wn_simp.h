...
simplifier with other modules:
   ...
   WN_SimpParentMap - set to LNO's parent map. If non-nil, causes
      the simplifier to keep parent pointers current.
...
/** $Revision: 1.16 $
 $Date: 2000/04/06 02:28:23 $
 $Author: mtibuild $
 $Source: /isms/cmplrs.src/osprey1.0/common/com/RCS/wn_simp.h,v $
**/
...
extern DLL_SHARED WN_MAP WN_SimpParentMap;

extern DLL_SHARED BOOL WN_Simp_Fold_ILOAD;

extern DLL_SHARED BOOL WN_Simp_Fold_LDA;
