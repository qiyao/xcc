...
static const char * const interface[] = {
  ...
  " *   are exported:",
  " *",
  " *   TOP ISA_Decode_Inst(UINT64 inst, ISA_EXEC_UNIT unit)",
  " *       Decode the instruction <inst> in execution unit <unit> and",
  " *       return its opcode by function return value.",
  " *",
  " * ====================================================================",
  " * ====================================================================",
  " */",
...
/////////////////////////////////////
{
  ...
  if (vk == VISIT_GEN_CODE) {
    fprintf(f, "%*sopc = (%s >> %d) & 0x%x;\n", 
	       indent, "",
	       state->u.i.stype == INST_STATE ? "inst" : "unit",
	       state->u.i.pos,
	       ntrans - 1);
...
#define FNAME "targ_isa_decode"
  ...
  fprintf(hfile, "\nextern TOP ISA_Decode_Inst(UINT64 inst, ISA_EXEC_UNIT unit);\n");
