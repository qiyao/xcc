...
//
//  $Revision: 1.16 $
//  $Date: 2000/04/06 02:32:28 $
//  $Author: mtibuild $
//  $Source: /isms/cmplrs.src/osprey1.0/common/targ_info/generate/RCS/isa_hazards_gen.cxx,v $
...
#define FNAME "targ_isa_hazards"
  ...
  fprintf(hfile, "\ninline BOOL ISA_HAZARD_TOP_Has_Hazard(TOP topcode)\n"
		 "{\n"
		 "  extern DLL_SHARED mUINT8 ISA_HAZARD_hazard_index[%d];\n"
  ...
  fprintf(hfile, "\ninline ISA_HAZARD_INFO *ISA_HAZARD_First(TOP topcode)\n"
		 "{\n"
		 "  extern DLL_SHARED mUINT8 ISA_HAZARD_hazard_index[%d];\n"
		 "  extern DLL_SHARED ISA_HAZARD_INFO ISA_HAZARD_hazard_info[%d];\n"
