...
//	Create a LIT CLASS with the <name>. <func> is a function that
//	takes a INT64 literal value and returns 1 if the value is
//	represented by the literal class. 'min' and 'max' bound the
//      range of values representable by the literal class.
//
...
//  $Revision: 1.4 $
//  $Date: 2000/04/06 02:32:36 $
//  $Author: mtibuild $
//  $Source: /isms/cmplrs.src/osprey1.0/common/targ_info/generate/RCS/isa_lits_gen.h,v $

#ifndef isa_lits_gen_INCLUDED
#define isa_lits_gen_INCLUDED

#ifdef _KEEP_RCS_ID
static const char isa_lits_gen_rcs_id[] = "$Source: /isms/cmplrs.src/osprey1.0/common/targ_info/generate/RCS/isa_lits_gen.h,v $ $Revision: 1.4 $";
#endif /* _KEEP_RCS_ID */
...
extern void ISA_Create_Lit_Class_Range (const char *name, LITCLASS_TYPE type, ...);
extern void ISA_Create_Lit_Class_Func (const char *name, const char *func,
				       const long long min, const long long max);
