...
//
//  void ISA_Register_Set( ISA_REGCLASS rclass,
//			   int min_regnum,
//			   int max_regnum,
...
#ifdef _KEEP_RCS_ID
static const char isa_registers_gen_rcs_id[] = "$Source: /isms/cmplrs.src/osprey1.0/common/targ_info/generate/RCS/isa_registers_gen.h,v $ $Revision: 1.8 $";
#endif
#endif

typedef struct isa_register_class *ISA_REGCLASS;
