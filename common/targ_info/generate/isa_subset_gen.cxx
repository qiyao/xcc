...
//
//  $Revision: 1.23 $
//  $Date: 2000/04/06 02:33:13 $
//  $Author: mtibuild $
//  $Source: /isms/cmplrs.src/osprey1.0/common/targ_info/generate/RCS/isa_subset_gen.cxx,v $
...
#define FNAME	"targ_isa_subset"
  ...
  fprintf(hfile,"extern DLL_SHARED const char* ISA_SUBSET_Name( ISA_SUBSET subset );\n");
