...
//      Adds a single <opcode> (which must not already have been added to an
//      ISA subset to <subset> and all its supersets.  Use this when the
//      vararg form of Instruction_Group is awkward.
//      
...
//  $Revision: 1.5 $
//  $Date: 2000/04/06 02:33:16 $
//  $Author: mtibuild $
//  $Source: /isms/cmplrs.src/osprey1.0/common/targ_info/generate/RCS/isa_subset_gen.h,v $
...
#ifdef _KEEP_RCS_ID
static char *isa_subset_gen_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/targ_info/generate/RCS/isa_subset_gen.h,v $ $Revision: 1.5 $";
#endif
#endif
