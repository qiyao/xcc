...
//
//  $Revision: 1.4 $
//  $Date: 2000/04/06 02:33:18 $
//  $Author: mtibuild $
//  $Source: /isms/cmplrs.src/osprey1.0/common/targ_info/generate/RCS/proc_gen.cxx,v $
...
/////////////////////////////////////
{
  FILE* hfile = fopen("targ_proc.h","wb");
  FILE* cfile = fopen("targ_proc.c","wb");
  FILE* efile = fopen("targ_proc.Exported","wb");
  ...
  fprintf(hfile,"\nextern DLL_SHARED const char* PROCESSOR_Name(PROCESSOR proc);\n");
