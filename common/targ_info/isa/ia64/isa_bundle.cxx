...
main()
{
  ...
  /* === All legal bundle orderings (16 of them at the moment) should be
     specified below. */
  ...
  /* ===== Specification for template 2 ===== */
  ISA_Bundle_Type_Create("mli", ".mli", 3);
  Slot (0, M_Unit);
  Slot (1, L_Unit);
  Slot (2, L_Unit);

  /* ===== Specification for template 3 ===== */
  ISA_Bundle_Type_Create("reserved_3", ".0x3", 3);
  Slot (0, R_Unit);
  Slot (1, R_Unit);
  Slot (2, R_Unit);

  /* ===== Specification for template 4 ===== */
  ISA_Bundle_Type_Create("mmi", ".mmi", 3);
  Slot (0, M_Unit);
  Slot (1, M_Unit);
  Slot (2, I_Unit);

  /* ===== Specification for template 5 ===== */
  ...
  /* ===== Specification for template 6 ===== */
  ISA_Bundle_Type_Create("mfi", ".mfi", 3);
  Slot (0, M_Unit);
  Slot (1, F_Unit);
  Slot (2, I_Unit);

  /* ===== Specification for template 7 ===== */
  ISA_Bundle_Type_Create("mmf", ".mmf", 3);
  Slot (0, M_Unit);
  Slot (1, M_Unit);
  Slot (2, F_Unit);

  /* ===== Specification for template 8 ===== */
  ISA_Bundle_Type_Create("mib", ".mib", 3);
  Slot (0, M_Unit);
  Slot (1, I_Unit);
  Slot (2, B2_Unit);

  /* ===== Specification for template 9 ===== */
  ISA_Bundle_Type_Create("mbb", ".mbb", 3);
  Slot (0, M_Unit);
  Slot (1, B_Unit);
  Slot (2, B2_Unit);

  /* ===== Specification for template 10 ===== */
  ISA_Bundle_Type_Create("reserved_a", ".0xa", 3);
  Slot (0, R_Unit);
  Slot (1, R_Unit);
  Slot (2, R_Unit);

  /* ===== Specification for template 11 ===== */
  ISA_Bundle_Type_Create("bbb", ".bbb", 3);
  Slot (0, B_Unit);
  Slot (1, B_Unit);
  Slot (2, B2_Unit);

  /* ===== Specification for template 12 ===== */
  ISA_Bundle_Type_Create("mmb", ".mmb", 3);
  Slot (0, M_Unit);
  Slot (1, M_Unit);
  Slot (2, B2_Unit);

  /* ===== Specification for template 13 ===== */
  ISA_Bundle_Type_Create("reserved_d", ".0xd", 3);
  Slot (0, R_Unit);
  Slot (1, R_Unit);
  Slot (2, R_Unit);

  /* ===== Specification for template 14 ===== */
  ISA_Bundle_Type_Create("mfb", ".mfb", 3);
  Slot (0, M_Unit);
  Slot (1, F_Unit);
  Slot (2, B2_Unit);

  /* ===== Specification for template 15 ===== */
  ISA_Bundle_Type_Create("reserved_f", ".0xf", 3);
  Slot (0, R_Unit);
  Slot (1, R_Unit);
  Slot (2, R_Unit);
