...
main()
{
  ...
  STATE ex_unit = Create_State("ex_unit", UNIT_STATE, 0, 3);
  STATE integer_or_alu = Create_State("integer_or_alu", INST_STATE, 40, 1);
  STATE memory_or_alu = Create_State("memory_or_alu", INST_STATE, 40, 1);

  STATE alu = Create_State("alu", INST_STATE, 37, 3);
  STATE integer = Create_State("integer", INST_STATE, 37, 3);
  STATE memory = Create_State("memory", INST_STATE, 37, 3);
  STATE floating = Create_State("floating", INST_STATE, 37, 4);
  STATE branch = Create_State("branch", INST_STATE, 37, 4);
  ...
  Transitions(ex_unit,
	...
	ISA_EXEC_L_Unit, Final(TOP_movl),
	END_TRANSITIONS);
...
/* ===== ALU instructions ===== */
  ...
  STATE alu_mm = Create_State("alu_mm", INST_STATE, 33, 3);
  STATE compare_c = Create_State("compare_c", INST_STATE, 12, 1);
  STATE compare_d = Create_State("compare_d", INST_STATE, 12, 1);
  STATE compare_e = Create_State("compare_e", INST_STATE, 12, 1);

  STATE integer_alu = Create_State("integer_alu", INST_STATE, 27, 6);
  STATE mm_alu = Create_State("mm_alu", INST_STATE, 36, 1);
  STATE mm_alu_1_2 = Create_State("mm_alu_1_2", INST_STATE, 27, 7);
  STATE mm_alu_4 = Create_State("mm_alu_4", INST_STATE, 27, 6);

  STATE compare_c0 = Create_State("compare_c0", INST_STATE, 33, 4);
  STATE compare_c1 = Create_State("compare_c1", INST_STATE, 33, 4);
  STATE compare_d0 = Create_State("compare_d0", INST_STATE, 33, 4);
  STATE compare_d1 = Create_State("compare_d1", INST_STATE, 33, 4);
  STATE compare_e0 = Create_State("compare_e0", INST_STATE, 33, 4);
  STATE compare_e1 = Create_State("compare_e1", INST_STATE, 33, 4);
...
/* ===== Integer instructions ===== */
  ...
  STATE misc = Create_State("misc", INST_STATE, 33, 3);
  STATE shift_test = Create_State("shift_test", INST_STATE, 33, 3);
  STATE movl = Create_State("movl", INST_STATE, 20, 1);
  STATE mpy_shift = Create_State("mpy_shift", INST_STATE, 32, 5);

  STATE misc_0 = Create_State("misc_0", INST_STATE, 27, 6);

  STATE move_to_br = Create_State("move_to_br", INST_STATE, 22, 1);

  STATE tbit_tnat_0 = Create_State("tbit_tnat_0", INST_STATE, 36, 1);
  STATE tbit_tnat_1 = Create_State("tbit_tnat_1", INST_STATE, 36, 1);
  STATE extract = Create_State("extract", INST_STATE, 13, 1);
  STATE deposit = Create_State("deposit", INST_STATE, 26, 1);

  STATE tbit_tnat_00 = Create_State("tbit_tnat_00", INST_STATE, 12, 2);
  STATE tbit_tnat_01 = Create_State("tbit_tnat_01", INST_STATE, 12, 2);

  STATE tbit_tnat_10 = Create_State("tbit_tnat_10", INST_STATE, 12, 2);
  STATE tbit_tnat_11 = Create_State("tbit_tnat_11", INST_STATE, 12, 2);

  STATE mpy_shift_2 = Create_State("mpy_shift_2", INST_STATE, 28, 4);
  STATE mpy_shift_6 = Create_State("mpy_shift_6", INST_STATE, 28, 4);
  STATE mpy_shift_8 = Create_State("mpy_shift_8", INST_STATE, 28, 4);
  STATE mpy_shift_10 = Create_State("mpy_shift_10", INST_STATE, 28, 4);
  STATE mpy_shift_12 = Create_State("mpy_shift_12", INST_STATE, 28, 4);
  STATE mpy_shift_14 = Create_State("mpy_shift_14", INST_STATE, 28, 4);
  STATE mpy_shift_16 = Create_State("mpy_shift_16", INST_STATE, 28, 4);
  STATE mpy_shift_18 = Create_State("mpy_shift_18", INST_STATE, 28, 4);
  STATE mpy_shift_20 = Create_State("mpy_shift_20", INST_STATE, 28, 4);
  STATE mpy_shift_24 = Create_State("mpy_shift_24", INST_STATE, 28, 4);
  STATE mpy_shift_28 = Create_State("mpy_shift_28", INST_STATE, 28, 4);
...
/* ===== Memory instructions ===== */
  ...
  STATE sys_mem_0 = Create_State("sys_mem_0", INST_STATE, 33, 3);
  STATE sys_mem_1 = Create_State("sys_mem_1", INST_STATE, 33, 3);
  STATE int_load_store = Create_State("int_load_store", INST_STATE, 36, 1);
  STATE int_load_store_imm = Create_State("int_load_store_imm", INST_STATE, 30, 6);
  STATE fp_load_store = Create_State("fp_load_store", INST_STATE, 36, 1);
  STATE fp_load_store_imm = Create_State("fp_load_store_imm", INST_STATE, 30, 6);

  STATE sys_mem_00 = Create_State("sys_mem_00", INST_STATE, 27, 6);
  STATE sys_mem_10 = Create_State("sys_mem_10", INST_STATE, 27, 6);

  STATE int_load_store_0 = Create_State("int_load_store_0", INST_STATE, 27, 1);
  STATE int_load_store_1 = Create_State("int_load_store_1", INST_STATE, 27, 1);

  STATE int_load_store_nobase = Create_State("int_load_store_nobase", INST_STATE, 30, 6);
  STATE sem_get_fr = Create_State("sem_get_fr", INST_STATE, 30, 6);
  STATE int_load_store_reg = Create_State("int_load_store_reg", INST_STATE, 30, 6);

  STATE fp_load_store_0 = Create_State("fp_load_store_0", INST_STATE, 27, 1);
  STATE fp_load_store_1 = Create_State("fp_load_store_1", INST_STATE, 27, 1);

  STATE fp_load_store_nobase = Create_State("fp_load_store_nobase", INST_STATE, 30, 6);
  STATE fp_load_pair_nobase = Create_State("fp_load_pair_nobase", INST_STATE, 30, 6);
  STATE fp_load_reg = Create_State("fp_load_reg", INST_STATE, 30, 6);
  STATE fp_load_pair_imm = Create_State("fp_load_pair_imm", INST_STATE, 30, 6);
...
/* ===== Float instructions ===== */
  ...
  STATE fp_misc_0 = Create_State("fp_misc_0", INST_STATE, 33, 1);
  STATE fp_misc_1 = Create_State("fp_misc_1", INST_STATE, 33, 1);
  STATE fp_compare = Create_State("fp_compare", INST_STATE, 33, 1);
  STATE fp_class = Create_State("fp_class", INST_STATE, 12, 1);
  STATE fma_8 = Create_State("fma_8", INST_STATE, 36, 1);
  STATE fma_9 = Create_State("fma_9", INST_STATE, 36, 1);
  STATE fma_a = Create_State("fma_a", INST_STATE, 36, 1);
  STATE fma_b = Create_State("fma_b", INST_STATE, 36, 1);
  STATE fma_c = Create_State("fma_c", INST_STATE, 36, 1);
  STATE fma_d = Create_State("fma_d", INST_STATE, 36, 1);
  STATE fselect = Create_State("fselect", INST_STATE, 34, 3);

  STATE fp_misc_00 = Create_State("fp_misc_00", INST_STATE, 27, 6);
  STATE fp_misc_01 = Create_State("fp_misc_01", INST_STATE, 36, 1);

  STATE fp_misc_10 = Create_State("fp_misc_10", INST_STATE, 27, 6);
  STATE fp_misc_11 = Create_State("fp_misc_11", INST_STATE, 36, 1);

  STATE fp_compare_0 = Create_State("fp_compare_0", INST_STATE, 36, 1);
  STATE fp_compare_1 = Create_State("fp_compare_1", INST_STATE, 36, 1);

  STATE fp_compare_00 = Create_State("fp_compare_00", INST_STATE, 12, 1);
  STATE fp_compare_01 = Create_State("fp_compare_01", INST_STATE, 12, 1);

  STATE fp_compare_10 = Create_State("fp_compare_10", INST_STATE, 12, 1);
  STATE fp_compare_11 = Create_State("fp_compare_11", INST_STATE, 12, 1);
...
/* ===== Branch instructions ===== */
  ...
  STATE misc_branch = Create_State("misc_branch", INST_STATE, 27, 6);
  STATE relative_branch = Create_State("relative_branch", INST_STATE, 6, 3);
  STATE indirect_predict = Create_State("indirect_predict", INST_STATE, 27, 6);

  STATE indirect_branch = Create_State("indirect_branch", INST_STATE, 6, 3);
  STATE indirect_return = Create_State("indirect_return", INST_STATE, 6, 6);
