...
//
//  $Revision: 1.27 $
//  $Date: 2000/04/06 02:34:11 $
//  $Author: mtibuild $
//  $Source: /osprey.src/osprey1.0/common/targ_info/isa/ia64/RCS/isa_print.cxx,v $
...
/* ===== %5s %s %s ===== */
  ...
  Instruction_Print_Group(print_3,
	...
	TOP_break_m,	TOP_fc,	TOP_invala_e,
	TOP_invala_f_e,	TOP_itc_d,	TOP_itc_i,
	TOP_nop_b,	TOP_nop_f,	TOP_nop_i,
	TOP_nop_m,	TOP_ptc_e,	TOP_rsm,
	TOP_rum,	TOP_ssm,	TOP_sum,
	TOP_UNDEFINED);
...
/* ===== %5s %s %s=pkr[%s] ===== */
  ...
  print_31 = ISA_Print_Type_Create("print_31", "%5s %s %s=pkr[%s]");
  Operand(0);		// qp
  Name();
  Result(0);		// r1
  Operand(1);		// r3
...
/* ===== %5s %s %s=pmc[%s] ===== */
  ...
  print_32 = ISA_Print_Type_Create("print_32", "%5s %s %s=pmc[%s]");
  Operand(0);		// qp
  Name();
  Result(0);		// r1
  Operand(1);		// r3
...
/* ===== %5s %s %s=pmd[%s] ===== */
  ...
  print_33 = ISA_Print_Type_Create("print_33", "%5s %s %s=pmd[%s]");
  Operand(0);		// qp
  Name();
  Result(0);		// r1
  Operand(1);		// r3
...
/* ===== %5s %s dbr[%s]=%s ===== */
  ...
  print_34 = ISA_Print_Type_Create("print_34", "%5s %s dbr[%s]=%s");
  Operand(0);		// qp
  Name();
  Operand(1);		// r3
  Operand(2);		// r2
...
/* ===== %5s %s dtr[%s]=%s ===== */
  ...
  print_35 = ISA_Print_Type_Create("print_35", "%5s %s dtr[%s]=%s");
  Operand(0);		// qp
  Name();
  Operand(1);		// r3
  Operand(2);		// r2
...
/* ===== %5s %s ibr[%s]=%s ===== */
  ...
  print_36 = ISA_Print_Type_Create("print_36", "%5s %s ibr[%s]=%s");
  Operand(0);		// qp
  Name();
  Operand(1);		// r3
  Operand(2);		// r2
...
/* ===== %5s %s itr[%s]=%s ===== */
  ...
  print_37 = ISA_Print_Type_Create("print_37", "%5s %s itr[%s]=%s");
  Operand(0);		// qp
  Name();
  Operand(1);		// r3
  Operand(2);		// r2
...
/* ===== %5s %s pkr[%s]=%s ===== */
  ...
  print_38 = ISA_Print_Type_Create("print_38", "%5s %s pkr[%s]=%s");
  Operand(0);		// qp
  Name();
  Operand(1);		// r3
  Operand(2);		// r2
...
/* ===== %5s %s pmc[%s]=%s ===== */
  ...
  print_39 = ISA_Print_Type_Create("print_39", "%5s %s pmc[%s]=%s");
  Operand(0);		// qp
  Name();
  Operand(1);		// r3
  Operand(2);		// r2
...
/* ===== %5s %s pmd[%s]=%s ===== */
  ...
  print_40 = ISA_Print_Type_Create("print_40", "%5s %s pmd[%s]=%s");
  Operand(0);		// qp
  Name();
  Operand(1);		// r3
  Operand(2);		// r2
...
/* ===== %5s %s%s %s,%s=%s ===== */
  ...
  print_41 = ISA_Print_Type_Create("print_41", "%5s %s%s %s,%s=%s");
  Operand(0);		// qp
  Name();
  Operand(1);		// sf
  Result(0);		// f1
...
/* ===== %5s %s%s %s=%s,%s ===== */
  ...
  print_42 = ISA_Print_Type_Create("print_42", "%5s %s%s %s=%s,%s");
  Operand(0);		// qp
  Name();
  Operand(1);		// sf
  Result(0);		// f1
...
/* ===== %5s %s %s,%s=%s,r0 ===== */
  ...
  print_45 = ISA_Print_Type_Create("print_45", "%5s %s %s,%s=%s,r0");
  Operand(0);		// qp
  Name();
  Result(0);		// p1
  Result(1);		// p2
...
/* ===== %5s %s %s,%s=r0,%s ===== */
  ...
  print_46 = ISA_Print_Type_Create("print_46", "%5s %s %s,%s=r0,%s");
  Operand(0);		// qp
  Name();
  Result(0);		// p1
  Result(1);		// p2
...
/* ===== %5s %s %s=%s,%s,%s ===== */
  ...
  print_47 = ISA_Print_Type_Create("print_47", "%5s %s %s=%s,%s,%s");
  Operand(0);		// qp
  Name();
  Result(0);		// r1
  Operand(1);		// r2
...
/* ===== %5s %s%s%s %s=[%s] ===== */
  ...
  print_48 = ISA_Print_Type_Create("print_48", "%5s %s%s%s %s=[%s]");
  Operand(0);		// qp
  Name();
  Operand(1);		// ldtype
  Operand(2);		// ldhint
...
/* ===== %5s %s%s%s%s %s=%s ===== */
  ...
  print_50 = ISA_Print_Type_Create("print_50", "%5s %s%s%s%s %s=%s");
  Operand(0);		// qp
  Name();
  Operand(1);		// bwh
  Operand(2);		// ph
  ...
  Instruction_Print_Group(print_50,
	TOP_br_call,	TOP_br_r_call,
	TOP_UNDEFINED);

/* ===== %5s %s %s=cpuid[%s] ===== */
  ISA_PRINT_TYPE print_51;
  print_51 = ISA_Print_Type_Create("print_51", "%5s %s %s=cpuid[%s]");
  Operand(0);		// qp
  Name();
  Result(0);		// r1
  Operand(1);		// r3
...
/* ===== %5s %s%s %s=[%s],%s ===== */
  ...
  print_52 = ISA_Print_Type_Create("print_52", "%5s %s%s %s=[%s],%s");
  Operand(0);		// qp
  Name();
  Operand(1);		// ldhint
  Result(0);		// r1
...
/* ===== %5s %s%s [%s]=%s,%s ===== */
  ...
  print_53 = ISA_Print_Type_Create("print_53", "%5s %s%s [%s]=%s,%s");
  Operand(0);		// qp
  Name();
  Operand(1);		// sthint
  Operand(2);		// r3
...
/* ===== %5s %s%s%s %s=%s,%s ===== */
  ...
  print_54 = ISA_Print_Type_Create("print_54", "%5s %s%s%s %s=%s,%s");
  Operand(0);		// qp
  Name();
  Operand(1);		// mwh
  Operand(2);		// ph_pvec_ih
  Result(0);		// b1
  Operand(3);		// r2
  Operand(4);		// imm
...
/* ===== %5s %s%s %s,%s=%s,%s ===== */
  ...
  print_55 = ISA_Print_Type_Create("print_55", "%5s %s%s %s,%s=%s,%s");
  Operand(0);		// qp
  Name();
  Operand(1);		// sf
  Result(0);		// p1
...
/* ===== %5s %s%s%s %s,%s=[%s],8 ===== */
  ...
  print_61 = ISA_Print_Type_Create("print_61", "%5s %s%s%s %s,%s=[%s],8");
  Operand(0);		// qp
  Name();
  Operand(1);		// fldtype
  Operand(2);		// ldhint
...
/* ===== %5s %s%s%s %s,%s=[%s],16 ===== */
  ...
  print_62 = ISA_Print_Type_Create("print_62", "%5s %s%s%s %s,%s=[%s],16");
  Operand(0);		// qp
  Name();
  Operand(1);		// fldtype
  Operand(2);		// ldhint
...
/* =====       %s %s=ar.pfs,%s,%s,%s ===== */
  ...
  print_63 = ISA_Print_Type_Create("print_63", "      %s %s=ar.pfs,%s,%s,%s");
  Name();
  Result(0);		// r1
  Operand(0);		// imm
  Operand(1);		// imm
...
/* ===== %5s %s%s%s %s=[%s],%s,ar.ccv ===== */
  ...
  print_64 = ISA_Print_Type_Create("print_64", "%5s %s%s%s %s=[%s],%s,ar.ccv");
  Operand(0);		// qp
  Name();
  Operand(1);		// sem
  Operand(2);		// ldhint
...
/* =====       %s %s=ar.pfs,%s,%s,%s,%s ===== */
  ...
  print_65 = ISA_Print_Type_Create("print_65", "      %s %s=ar.pfs,%s,%s,%s,%s");
  Name();
  Result(0);		// r1
  Operand(0);		// imm
  Operand(1);		// imm
