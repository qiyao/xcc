 ...
 *		otherwise.  A stop bit can always be set for the last
 *              slot in a bundle.
 *
...
#ifdef _KEEP_RCS_ID
static const char ti_bundle_rcs_id[] = "$Source: /isms/cmplrs.src/osprey1.0/common/targ_info/access/RCS/ti_bundle.h,v $ $Revision: 1.16 $";
#endif /* _KEEP_RCS_ID */
