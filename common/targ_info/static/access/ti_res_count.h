 ...
 *  $Revision: 1.9 $
 *  $Date: 2000/04/06 02:31:42 $
 *  $Author: mtibuild $
 *  $Source: /isms/cmplrs.src/osprey1.0/common/targ_info/access/RCS/ti_res_count.h,v $
 *
 *  Revision history:
 ...
 *		resource counts in 'counts'. For format resources, we
 *		optimistically choose the minimum cycle from usage among
 *		all such resources. The cycle is then bounded by maximum
 *		issue constraint. Format resources have to be considered
 *		differently because the maximum of the cycles from format
 *		resource usage does not give a lower bound since some opcodes
 *		can choose from more than one formats. A non-lower bound
 *		min cycles returned may cause SWP to start from a higher
 *		min_ii which may result poor scheduling.
 *
...
#ifdef _KEEP_RCS_ID
static const char ti_res_count_rcs_id[] = "$Source: /isms/cmplrs.src/osprey1.0/common/targ_info/access/RCS/ti_res_count.h,v $ $Revision: 1.9 $";
#endif /* _KEEP_RCS_ID */
