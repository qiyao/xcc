 ...
 *  Module: ti_res_res.h
 *  $Revision: 1.6 $
 *  $Date: 2000/04/06 02:31:47 $
 *  $Author: mtibuild $
 *  $Source: /isms/cmplrs.src/osprey1.0/common/targ_info/access/RCS/ti_res_res.h,v $
 *
 *  Synopsis:
 *
 ...
 *	    )
 *
 *		When used in an Modulo Reservation Table (MRT)
 *		(in be/cg/cg_swp_sched.cxx), return
 *		a set of compatible formats.
 *
 ...
 *	    )
 *
 *	        Return the set of compatible formats at cycle 'cycle' if
 *	        an operation of 'opcode' is scheduled there.
 *
...
#ifdef _KEEP_RCS_ID
static const char ti_res_res_rcs_id[] = "$Source: /isms/cmplrs.src/osprey1.0/common/targ_info/access/RCS/ti_res_res.h,v $ $Revision: 1.6 $";
#endif /* _KEEP_RCS_ID */
...
extern TI_SI_FORMAT_ID_SET TI_RES_RES_Valid_Formats(
  TI_RES_RES  *res,
  INT          cycle
);

extern TI_SI_FORMAT_ID_SET TI_RES_RES_Compatible_Format(
  TI_RES_RES  *res,
  TOP	       opcode,
  INT	       cycle,
  TOP	       alt_opcode
