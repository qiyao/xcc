...
/* Xtensa has neither stacked nor rotating registers. */
 ...
 *
 *	void REGISTER_Init_Stacked(ISA_REGCLASS rclass)
 ...
 *          ISA_REGCLASS rclass, INT n)
 *           Rerserve n rotating registers.
 *
 *	void REGISTER_Set_Stacked_Output_Minimum(ISA_REGCLASS rclass,
 *						 INT num)
 ...
 *
 *	BOOL REGISTER_Has_Stacked_Registers(ISA_REGCLASS rclass)
 ...
 *
 *      BOOL REGISTER_Has_Rotating_Registers(ISA_REGCLASS rclass)
 *          Returns TRUE if rotating register set exists for <rclass>.
 *
 *      REGISTER REGISTER_First_Rotating_Registers(ISA_REGCLASS rclass)
 *          Returns the first rotating register for <rclass>.
 *
 *      REGISTER REGISTER_Last_Rotating_Registers(ISA_REGCLASS rclass)
 *          Returns the last rotating register for <rclass>.
 *
 *      BOOL Is_Predicate_REGISTER_CLASS(ISA_REGCLASS rclass)
 *          Returns TRUE if the rclass is the predicate register class
 *
 *      REGISTER_SET REGISTER_Get_Requested_Rotating_Registers(ISA_REGCLASS rclass)
 *          Returns the set of allocated rotating registers
 *
 */

inline BOOL REGISTER_Has_Stacked_Registers(ISA_REGCLASS rclass) {
  return FALSE;
}
inline BOOL REGISTER_Has_Rotating_Registers(ISA_REGCLASS rclass) {
  return FALSE;
}

extern void REGISTER_Init_Stacked(ISA_REGCLASS rclass);
extern REGISTER REGISTER_Request_Stacked_Register(ABI_PROPERTY has_abi_property,
						  ISA_REGCLASS rclass);
extern REGISTER REGISTER_Allocate_Stacked_Register(ABI_PROPERTY has_abi_property,
						   ISA_REGCLASS rclass,
						   REGISTER reg);
// unallocate a stacked register such that it is not re-used.
extern void REGISTER_Unallocate_Stacked_Register (
   ISA_REGCLASS rclass, REGISTER reg);

// return whether stacked register is allocatable
extern BOOL REGISTER_Is_Allocatable_Stacked_Register (
   ISA_REGCLASS rclass, REGISTER reg);

extern REGISTER_SET REGISTER_Get_Stacked_Avail_Set(ABI_PROPERTY has_abi_property,
						   ISA_REGCLASS rclass);
extern BOOL REGISTER_Is_Stacked_Output(ISA_REGCLASS rclass, REGISTER reg);
extern BOOL REGISTER_Is_Rotating(ISA_REGCLASS rclass, REGISTER reg);
extern BOOL REGISTER_Is_Stacked(ISA_REGCLASS rclass, REGISTER reg);
extern BOOL REGISTER_Is_Stacked_Local(ISA_REGCLASS rclass, REGISTER reg);
extern REGISTER REGISTER_Translate_Stacked_Output(REGISTER reg);
extern INT REGISTER_Number_Stacked_Output (ISA_REGCLASS);
extern INT REGISTER_Number_Stacked_Local (ISA_REGCLASS);
extern INT REGISTER_Number_Stacked_Rotating (ISA_REGCLASS);
extern INT REGISTER_Number_Stacked_Registers_Available (ISA_REGCLASS);

extern void REGISTER_Reserve_Rotating_Registers(ISA_REGCLASS rclass,
						INT n);
extern void REGISTER_Set_Stacked_Output_Minimum(ISA_REGCLASS rclass,
						INT num);

extern char * REGISTER_Stacked_Output_Name (REGISTER reg);

extern REGISTER REGISTER_First_Rotating_Registers(ISA_REGCLASS rclass);
extern REGISTER REGISTER_Last_Rotating_Registers(ISA_REGCLASS rclass);
extern void REGISTER_Request_Stacked_Rotating_Register();

inline BOOL Is_Predicate_REGISTER_CLASS(ISA_REGCLASS rclass) {
  return FALSE;
}

extern REGISTER_SET REGISTER_Get_Requested_Rotating_Registers(ISA_REGCLASS rclass);
