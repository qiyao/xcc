...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /osprey.src/osprey1.0/common/com/ia64/RCS/config_platform.c,v $ $Revision: 1.4 $";
#endif /* _KEEP_RCS_ID */

#include <string.h>
#include "config_platform.h"

TARG_PLATFORM Platform = IP0;	/* Target platform */
...
static PLATFORM_OPTIONS PF_Opts[] =
{
   ...
   */
  { IP0, "ip??", "xtensa", PROC_XTENSA, "Xtensa" },
