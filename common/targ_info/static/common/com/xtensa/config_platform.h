 ...
 * $Revision: 1.4 $
 * $Date: 2000/04/06 02:29:03 $
 * $Author: mtibuild $
 * $Source: /osprey.src/osprey1.0/common/com/ia64/RCS/config_platform.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *config_platform_rcs_id = "$Source: /osprey.src/osprey1.0/common/com/ia64/RCS/config_platform.h,v $ $Revision: 1.4 $";
#endif /* _KEEP_RCS_ID */
...
extern DLL_SHARED TARG_PLATFORM Platform;	/* Target platform */

/* How should we set the options? */
typedef struct {
  TARG_PLATFORM id;		/* Which IP? */
  char *name;		/* "ipxx" */
  char *pname;		/* "r10000" */
  TARG_PROCESSOR processor;	/* PROC_RxK */
