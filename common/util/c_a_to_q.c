 ...
 * Module: c_a_to_q
 * $Revision: 1.5 $
 * $Date: 2000/04/06 02:34:49 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/common/util/RCS/c_a_to_q.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/util/RCS/c_a_to_q.c,v $ $Revision: 1.5 $";
