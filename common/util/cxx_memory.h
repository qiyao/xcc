...
#include <new>
extern DLL_SHARED MEM_POOL* Delete_Mem_Pool;

extern DLL_SHARED MEM_POOL* _dummy_new_mempool;
extern DLL_SHARED MEM_POOL* _dummy_delete_mempool;

#ifdef MEM_STATS
extern DLL_SHARED int         _alloc_callsite_line;
extern DLL_SHARED const char *_alloc_callsite_file;
#endif

extern DLL_SHARED size_t _dummy_pad;
