 ...
 * is freed.
 *
 * Compiling all the compiler sources with -DMEM_STATS enables
 * collection of memory allocation statistics.  With these it is
 ...
 *  =========================
 *
 *  When MEM_STATS is enabled, we also support:
 *
...
#else
#define MEM_STAT_ARGS(line,file)
#endif
 ...
 */
extern DLL_SHARED MEM_POOL MEM_local_pool;
extern DLL_SHARED MEM_POOL MEM_src_pool;
extern DLL_SHARED MEM_POOL MEM_pu_pool;
extern DLL_SHARED MEM_POOL MEM_phase_pool;

extern DLL_SHARED MEM_POOL *MEM_local_pool_ptr;
extern DLL_SHARED MEM_POOL *MEM_src_pool_ptr;
extern DLL_SHARED MEM_POOL *MEM_pu_pool_ptr;
extern DLL_SHARED MEM_POOL *MEM_phase_pool_ptr;
 ...
 * appropriate.
 */
extern DLL_SHARED MEM_POOL MEM_local_nz_pool;
extern DLL_SHARED MEM_POOL MEM_src_nz_pool;
extern DLL_SHARED MEM_POOL MEM_pu_nz_pool;
extern DLL_SHARED MEM_POOL MEM_phase_nz_pool;

extern DLL_SHARED MEM_POOL *MEM_local_nz_pool_ptr;
extern DLL_SHARED MEM_POOL *MEM_src_nz_pool_ptr;
extern DLL_SHARED MEM_POOL *MEM_pu_nz_pool_ptr;
extern DLL_SHARED MEM_POOL *MEM_phase_nz_pool_ptr;
