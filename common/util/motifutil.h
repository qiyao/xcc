 ...
 * Module: motifutil.h
 * $Revision: 1.6 $
 * $Date: 2000/04/06 02:36:04 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/common/util/RCS/motifutil.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *motifutil_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/util/RCS/motifutil.h,v $ $Revision: 1.6 $";
#endif /* _KEEP_RCS_ID */
