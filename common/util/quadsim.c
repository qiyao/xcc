...
/* math.h defines infinity_const on NT as a function, so we'll do
   some gymnastics to make it all come out right */

static const du infinity_const = 
...
extern INT32 c_ji_qint(QUAD x, INT *p_err)
     __attribute__((weak, alias("__c_ji_qint")));
...
extern UINT32 c_ji_quint(QUAD x, INT *p_err)
     __attribute__((weak, alias("__c_ji_quint")));
...
extern INT64 c_ki_qint(QUAD x, INT *p_err)
     __attribute__((weak, alias("__c_ki_qint")));
...
extern UINT64 c_ki_quint(QUAD x, INT *p_err)
     __attribute__((weak, alias("__c_ki_quint")));
...
extern float c_sngl_q(QUAD x, INT *p_err)
     __attribute__((weak, alias("__c_sngl_q")));
...
extern double c_dble_q(QUAD x, INT *p_err)
     __attribute__((weak, alias("__c_dble_q")));
...
extern QUAD c_q_flotj(INT32 n, INT *p_err)
     __attribute__((weak, alias("__c_q_flotj")));
...
extern QUAD c_q_flotju(UINT32 n, INT *p_err)
     __attribute__((weak, alias("__c_q_flotju")));
...
extern QUAD c_q_flotk(INT64 n, INT *p_err)
     __attribute__((weak, alias("__c_q_flotk")));
...
extern QUAD c_q_flotku(UINT64 n, INT *p_err)
     __attribute__((weak, alias("__c_q_flotku")));
...
extern QUAD c_q_ext( float x, INT *p_err)
     __attribute__((weak, alias("__c_q_ext")));
...
extern QUAD c_q_extd(double x, INT *p_err)
     __attribute__((weak, alias("__c_q_extd")));
...
extern QUAD c_q_trunc(QUAD x, INT *p_err)
     __attribute__((weak, alias("__c_q_trunc")));
...
extern INT32 c_fp_class_q(QUAD x)
     __attribute__((weak, alias("__c_fp_class_q")));
