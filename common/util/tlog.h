 ...
 * Module: tlog.h
 * $Revision: 1.4 $
 * $Date: 2000/04/06 02:36:41 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/common/util/RCS/tlog.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *tlog_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/util/RCS/tlog.h,v $ $Revision: 1.4 $";
#endif /* _KEEP_RCS_ID */
