...
#ifdef _KEEP_RCS_ID
static char *tracing_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/util/RCS/tracing.h,v $ $Revision: 2.43 $";
#endif /* _KEEP_RCS_ID */
...
extern DLL_SHARED char *SBar;	/* Single-dash bar w/NL, full page width */
extern DLL_SHARED char *DBar;	/* Double-dash bar w/NL, full page width */
extern DLL_SHARED char *Sharps;	/* Sharps w/NL, full page width */
...
#define TINFO_SCHED	2	/* Code schedule information */
#define TINFO_HARD	4	/* Hard failure information */
#define TINFO_SOFT	8	/* Soft failure information */
#define TINFO_STATS	16	/* Miscellaneous statistics */
...
#define TINFO_CTIME	256	/* Compilation-only timing information */
...
#define TP_TDT		4	/* TDT building */

/* Front end phases: */
#define TP_SCAN		6	/* Lexical scanner */
#define TP_PARSE	7	/* Parser */
#define TP_SEMANTICS	8	/* Semantic analyzer */
#define TP_PRE_IRB	9	/* Pre-IRB transformations */
#define TP_IRB		10	/* IR (WHIRL) builder */

/* Intermediate utility phases: */
#define TP_IR_READ	12	/* IR (WHIRL) reader/writer */
#define TP_WHIRL2FC	13	/* WHIRL to Fortran/C */
#define TP_WHIRLSIMP    14	/* WHIRL simplifier */
#define TP_REGION	15	/* REGION related stuff */
...
#define TP_ORI		23	/* Olimit Region Insertion phase */
...
#define TP_DATALAYOUT	40	/* Data layout */
...
#define TP_PEEP		46	/* Peephole optimizer */
#define TP_FLOWOPT	47	/* Control flow optimization */
#define TP_GCM		48	/* Global code motion */
#define TP_LAN		49	/* Software pipelining loop analysis */
...
#define TP_CGALL        60      /* All code-generator phases */
  
#define TP_TEMP		61	/* Temporary use */

#define TP_TIE		66	/* TIE related info */

/* WARNING: TP_LAST must be at least as large as the largest phase
 * number above, and TP_COUNT must be at least one larger.
 */
#define TP_LAST		66	/* Largest valid phase number */
#define TP_COUNT	67	/* Number of valid phase numbers */
...
/* Determine whether a given trace option is enabled.  If bb_id is not
 * 0, it is checked against the list of enabled BBs as well.
 */
#ifdef __cplusplus
extern BOOL Get_Trace ( INT func, INT arg, INT bb_id = 0);
#else
extern BOOL Get_Trace ( INT func, INT arg, INT bb_id);
#endif
