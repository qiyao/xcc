...
#ifdef _KEEP_RCS_ID
static char *util_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/common/util/RCS/util.h,v $ $Revision: 1.12 $";
#endif /* _KEEP_RCS_ID */
...
#if 0
/* the following is conflictingthe Mod in include/g++-3/stl_tree.h */
...
/* Count set bits */
extern DLL_SHARED const mUINT8 UINT8_pop_count[256];
extern TARG_INT
TARG_INT_Pop_Count(
  TARG_INT x
);
...
extern DLL_SHARED const mUINT8 UINT8_least_sig_one[256];
extern TARG_INT
