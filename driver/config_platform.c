 ...
 * $Revision: 1.7 $
 * $Date: 2000/05/02 23:53:11 $
 * $Author: mpm $
 * $Source: /isms/cmplrs.src/osprey1.0/driver/RCS/config_platform.c,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/driver/RCS/config_platform.c,v $ $Revision: 1.7 $";
#endif /* _KEEP_RCS_ID */
