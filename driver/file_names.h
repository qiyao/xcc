...
/* fixme: this is a hack. We should do the right thing and build a structure
   instead of doing the string matches in construct_temp_file_name */
extern int cur_source_file_num;
...
/* add files to a list of temp files for late deletion.
   This is list is for the case when the file needs to
   be kept around between compilation and linking. eg

   sgicc foo.c bar.c

   foo.o will need to be preserved until bar.c is compiled
*/
