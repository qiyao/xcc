...
extern boolean nostdincplusplus;/* no standard include directory */

extern string help_pattern;	/* pattern string for help file */

extern string xtensa_tools;	

extern int inline_t;            /* toggle for inline options */

extern boolean skip_inliner;	/* entirely skip the inliner? */
...
extern string lsp_name;

extern string input_charset;	/* argument to -finput-charset */
...
extern void print_multi_lib (void);     /* for building newlib only */
extern void print_search_dirs (void);   /* only prints installation dir at this point */
extern void print_lsp (void);           /* only prints installation dir at this point */
