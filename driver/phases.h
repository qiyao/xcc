...
extern string fb_entry;		/* entry point for -fb */
...
#else
#define FIXPATH(old,fixed) strcpy(fixed,old)
#endif

/* XTENSA: these are defined in special_options.c */
#include "string_utils.h"
extern string_list_t * start_link_args;
extern string_list_t * lib_link_args;
extern string_list_t * end_link_args;
extern string_list_t * c_args;
extern string_list_t * cpp_args;
extern void xtensa_add_linker_options();
