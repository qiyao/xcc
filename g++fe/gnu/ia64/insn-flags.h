...
#define HAVE_pr_spill 1
#define HAVE_pr_restore 1
#define HAVE_pfs_restore 1
#define HAVE_unat_spill 1
#define HAVE_unat_restore 1
...
#define HAVE_flush_cache 1
#define HAVE_ccv_restore_si 1
#define HAVE_ccv_restore_di 1
#define HAVE_mf 1
...
#define HAVE_sgeu 1
#define HAVE_call 1
#define HAVE_indirect_call_pic 1
#define HAVE_setjmp_call_pic 1
#define HAVE_call_pic 1
#define HAVE_call_value 1
#define HAVE_indirect_call_value_pic 1
#define HAVE_indirect_call_multiple_values_pic 1
#define HAVE_setjmp_call_value_pic 1
#define HAVE_call_value_pic 1
#define HAVE_call_multiple_values_pic 1
...
#define HAVE_val_compare_and_swap_si 1
#define HAVE_val_compare_and_swap_di 1
#define HAVE_lock_test_and_set_si 1
#define HAVE_lock_test_and_set_di 1
#define HAVE_fetch_and_add_si 1
#define HAVE_fetch_and_sub_si 1
#define HAVE_fetch_and_or_si 1
#define HAVE_fetch_and_and_si 1
#define HAVE_fetch_and_xor_si 1
#define HAVE_fetch_and_nand_si 1
#define HAVE_fetch_and_add_di 1
#define HAVE_fetch_and_sub_di 1
#define HAVE_fetch_and_or_di 1
#define HAVE_fetch_and_and_di 1
#define HAVE_fetch_and_xor_di 1
#define HAVE_fetch_and_nand_di 1
#define HAVE_add_and_fetch_di 1
#define HAVE_sub_and_fetch_di 1
#define HAVE_or_and_fetch_di 1
#define HAVE_and_and_fetch_di 1
#define HAVE_xor_and_fetch_di 1
#define HAVE_nand_and_fetch_di 1
#define HAVE_add_and_fetch_si 1
#define HAVE_sub_and_fetch_si 1
#define HAVE_or_and_fetch_si 1
#define HAVE_and_and_fetch_si 1
#define HAVE_xor_and_fetch_si 1
#define HAVE_nand_and_fetch_si 1
...
extern rtx gen_call_internal                     PARAMS ((rtx, rtx, rtx));
extern rtx gen_call_value_internal               PARAMS ((rtx, rtx, rtx, rtx));
...
extern rtx gen_tablejump_internal                PARAMS ((rtx, rtx));
...
extern rtx gen_gr_spill                          PARAMS ((rtx, rtx));
extern rtx gen_gr_restore                        PARAMS ((rtx, rtx));
extern rtx gen_fr_spill                          PARAMS ((rtx, rtx));
extern rtx gen_fr_restore                        PARAMS ((rtx, rtx));
extern rtx gen_pr_spill                          PARAMS ((rtx));
extern rtx gen_pr_restore                        PARAMS ((rtx));
extern rtx gen_pfs_restore                       PARAMS ((rtx));
extern rtx gen_unat_spill                        PARAMS ((rtx));
extern rtx gen_unat_restore                      PARAMS ((rtx));
...
extern rtx gen_insn_group_barrier                PARAMS ((void));
extern rtx gen_flush_cache                       PARAMS ((rtx));
extern rtx gen_ccv_restore_si                    PARAMS ((rtx));
extern rtx gen_ccv_restore_di                    PARAMS ((rtx));
extern rtx gen_mf                                PARAMS ((rtx));
extern rtx gen_fetchadd_acq_si                   PARAMS ((rtx, rtx, rtx));
extern rtx gen_fetchadd_acq_di                   PARAMS ((rtx, rtx, rtx));
extern rtx gen_cmpxchg_acq_si                    PARAMS ((rtx, rtx, rtx));
extern rtx gen_cmpxchg_acq_di                    PARAMS ((rtx, rtx, rtx));
...
extern rtx gen_load_symptr                       PARAMS ((rtx, rtx));
...
extern rtx gen_indirect_call_pic                 PARAMS ((rtx, rtx));
extern rtx gen_setjmp_call_pic                   PARAMS ((rtx, rtx));
extern rtx gen_call_pic                          PARAMS ((rtx, rtx));
#define GEN_CALL_VALUE(A, B, C, D, E) gen_call_value ((A), (B), (C), (D), (E))
extern rtx gen_call_value                        PARAMS ((rtx, rtx, rtx, rtx, rtx));
extern rtx gen_indirect_call_value_pic           PARAMS ((rtx, rtx, rtx));
extern rtx gen_indirect_call_multiple_values_pic PARAMS ((rtx, rtx, rtx));
extern rtx gen_setjmp_call_value_pic             PARAMS ((rtx, rtx, rtx));
extern rtx gen_call_value_pic                    PARAMS ((rtx, rtx, rtx));
extern rtx gen_call_multiple_values_pic          PARAMS ((rtx, rtx, rtx));
...
extern rtx gen_nonlocal_goto_receiver            PARAMS ((void));
extern rtx gen_eh_epilogue                       PARAMS ((rtx, rtx, rtx));
extern rtx gen_restore_stack_nonlocal            PARAMS ((rtx, rtx));
extern rtx gen_val_compare_and_swap_si           PARAMS ((rtx, rtx, rtx, rtx));
extern rtx gen_val_compare_and_swap_di           PARAMS ((rtx, rtx, rtx, rtx));
extern rtx gen_lock_test_and_set_si              PARAMS ((rtx, rtx, rtx));
extern rtx gen_lock_test_and_set_di              PARAMS ((rtx, rtx, rtx));
extern rtx gen_fetch_and_add_si                  PARAMS ((rtx, rtx, rtx));
extern rtx gen_fetch_and_sub_si                  PARAMS ((rtx, rtx, rtx));
extern rtx gen_fetch_and_or_si                   PARAMS ((rtx, rtx, rtx));
extern rtx gen_fetch_and_and_si                  PARAMS ((rtx, rtx, rtx));
extern rtx gen_fetch_and_xor_si                  PARAMS ((rtx, rtx, rtx));
extern rtx gen_fetch_and_nand_si                 PARAMS ((rtx, rtx, rtx));
extern rtx gen_fetch_and_add_di                  PARAMS ((rtx, rtx, rtx));
extern rtx gen_fetch_and_sub_di                  PARAMS ((rtx, rtx, rtx));
extern rtx gen_fetch_and_or_di                   PARAMS ((rtx, rtx, rtx));
extern rtx gen_fetch_and_and_di                  PARAMS ((rtx, rtx, rtx));
extern rtx gen_fetch_and_xor_di                  PARAMS ((rtx, rtx, rtx));
extern rtx gen_fetch_and_nand_di                 PARAMS ((rtx, rtx, rtx));
extern rtx gen_add_and_fetch_di                  PARAMS ((rtx, rtx, rtx));
extern rtx gen_sub_and_fetch_di                  PARAMS ((rtx, rtx, rtx));
extern rtx gen_or_and_fetch_di                   PARAMS ((rtx, rtx, rtx));
extern rtx gen_and_and_fetch_di                  PARAMS ((rtx, rtx, rtx));
extern rtx gen_xor_and_fetch_di                  PARAMS ((rtx, rtx, rtx));
extern rtx gen_nand_and_fetch_di                 PARAMS ((rtx, rtx, rtx));
extern rtx gen_add_and_fetch_si                  PARAMS ((rtx, rtx, rtx));
extern rtx gen_sub_and_fetch_si                  PARAMS ((rtx, rtx, rtx));
extern rtx gen_or_and_fetch_si                   PARAMS ((rtx, rtx, rtx));
extern rtx gen_and_and_fetch_si                  PARAMS ((rtx, rtx, rtx));
extern rtx gen_xor_and_fetch_si                  PARAMS ((rtx, rtx, rtx));
extern rtx gen_nand_and_fetch_si                 PARAMS ((rtx, rtx, rtx));
