...
#if 0
/* sca: strsignal is declared differently on different systems,
   and furthermore, it can be found in /usr/include/string.

   If we just use the system's definition rather than this
