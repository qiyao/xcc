...
rtx
gen_xmulsi3_highpart_5400 (operand0, operand1, operand2, operand3, operand4, operand5)
     rtx operand0;
     rtx operand1;
     rtx operand2;
     rtx operand3;
...
#ifdef SGI_MONGOOSE
  REAL_VALUE_TYPE dval;
  REAL_VALUE_TYPE offset;
  REAL_VALUE_FROM_INT  (dval, 1, 0, DFmode);
  offset = REAL_VALUE_LDEXP (dval, 31);
#else
...

{
  ...
  REAL_VALUE_TYPE offset;
  REAL_VALUE_FROM_INT  (dval, 1, 0, DFmode);
  offset = REAL_VALUE_LDEXP (dval, 63);
#else
...

{
  ...
  offset = REAL_VALUE_LDEXP (dval, 31);
#else
  REAL_VALUE_TYPE offset = REAL_VALUE_LDEXP (1.0, 32);
#endif /* SGI_MONGOOSE */
...
rtx
gen_sibcall_internal0 (operand0, operand1)
     rtx operand0;
     rtx operand1;
{
...
rtx
gen_sibcall_internal1 (operand0, operand1)
     rtx operand0;
     rtx operand1;
{
  return gen_rtx_CALL (VOIDmode,
...
rtx
gen_sibcall_value_internal0 (operand0, operand1, operand2)
     rtx operand0;
     rtx operand1;
     rtx operand2;
{
...
rtx
gen_sibcall_value_internal1 (operand0, operand1, operand2)
     rtx operand0;
     rtx operand1;
     rtx operand2;
{
