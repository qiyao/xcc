...
#ifndef USING_MALLOC_PAGE_GROUPS
#define USING_MMAP
#endif
...
#if defined (HAVE_MMAP_ANYWHERE) && !defined(MAP_ANONYMOUS) & defined(USING_MMAP)
  int dev_zero_fd;
#endif
...
#if defined(HAVE_MMAP_ANYWHERE) && defined(USING_MMAP)
#ifdef MAP_ANONYMOUS
...
release_pages ()
{
#if defined(USING_MMAP)
#if defined (HAVE_MMAP_ANYWHERE)
  page_entry *p, *next;
  char *start;
  size_t len;
