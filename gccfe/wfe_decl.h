...
/* call this routine to process pragma name([id[,arg1[,arg2]]]) on encountering pragma */
/* 1 -- ok, 0 -- fail */
extern int WFE_idaa (char *name, char *id, int arg1, int arg2);

/* add a frequency hint pragma: frequent or never */
extern void WFE_Add_Frequency_Hint(int frequent);

/* add a IVDEP pragma */
extern void WFE_Add_IVDep();

/* add a CONCURRENT, SIMD, or SIMD_IF_CONVERT pragma */
extern void WFE_Add_Concurrent();
extern void WFE_Add_Simd();
extern void WFE_Add_Simd_If_Convert();
extern void WFE_Add_Super_SWP(int ii, int unroll);
extern void WFE_Add_SWP_Schedule(const char* str);

/* add a Generate_HW pragma */
extern void WFE_Add_Generate_HW();

/* add a barrier */
extern void WFE_Add_Barrier(BOOL no_reorder_memory,
			    BOOL flush_memory,
			    BOOL no_reorder,
			    BOOL flush);
