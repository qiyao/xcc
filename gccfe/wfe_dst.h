 ...
 * Module: wfe_dst.h
 * $Revision: 1.9 $
 * $Date: 2000/07/05 19:01:34 $
 * $Author: murthy $
 * $Source: /isms/cmplrs.src/osprey1.0/gccfe/RCS/wfe_dst.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *wfe_dst_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/gccfe/RCS/wfe_dst.h,v $ $Revision: 1.9 $";
#endif /* _KEEP_RCS_ID */
...
extern void Update_DST_For_Array(tree array_decl);
