...
#define DW_LNE_define_file		3
  ...
  /* Xtensa Specific: Used to generate address advances symbolically, i.e.
     the difference between two labels.  This extended opcode will never be
     emitted into the object but is used in libdwarf to generate compressed
     3 byte or 1 byte pc/line advance opcodes.
   */
#define DW_LNE_xtensa_advance_pc_symbolic 4
