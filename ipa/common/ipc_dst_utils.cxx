                          ...
                          DST_flag flag)
{
  ...
  // invalidate the parent type info since it is not included in the new DST
  DST_SUBPROGRAM_decl_parent(attr) = DST_INVALID_IDX;
                         ...
                         DST_flag flag)
{
  ...
  // invalidate the parent type info since it is not included in the new DST
  DST_SUBPROGRAM_def_parent(attr) = DST_INVALID_IDX;
                            ...
                            DST_IDX old_idx)
{
  ...
  if (DST_IS_memdef(flag)) {
    ...
    return DST_mk_subpr_decl(dest, p, cu, prev,
                             ...
                             DST_SUBPROGRAM_decl_parent(sub),
