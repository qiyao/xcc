...
extern "C" void
Sync_symbol_attributes (ST_IDX st_idx, UINT32 sym_attr, UINT32 export_class);
...
struct IPC_GLOBAL_IDX_MAP
{
	...
	sym_str (0, __gnu_cxx::hash<STR_IDX>(), __gnu_cxx::equal_to<STR_IDX>(),
...
typedef __gnu_cxx::hash_map<ST_IDX, BLOCK_ELEMENTS*,
