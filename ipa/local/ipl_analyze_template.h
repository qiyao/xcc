 ...
 * $Source: /isms/cmplrs.src/osprey1.0/ipa/local/RCS/ipl_analyze_template.h,v $
 *
 * Description:
...
extern "C" {
 ...
 inline void CD_is_br_taken__10DU_MANAGERUi(void) {}
 inline void CD_is_fall_thru__10DU_MANAGERUi(void) {}
 inline void Def_at_entry__C7CODEREP(void) {}
 inline void Defbb__C7CODEREP(void) {}
 inline void Dominate__10DU_MANAGERUiUi(void) {}
 inline void Get_cd__10DU_MANAGERUi(void) {}
 inline void Get_last_stmt__10DU_MANAGERUi(void) {}
 inline void Print_kind__7CODEREPCGv(void) {}
#endif
...
SUMMARIZE<program>:: Record_global_ref (WN* w, ST *s, OPERATOR op, BOOL refcount_only) 
{
    ...
    // don't bother with non-string constants and register variables
    if ((ST_class(s) == CLASS_CONST && 
         ST_sclass(s) != SCLASS_MERGE_STRING) ||
