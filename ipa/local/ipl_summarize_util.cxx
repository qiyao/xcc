...
#include <elf.h>			// needed in ipl_summary.h
#include "defs.h"
#include "symtab.h"
#include "wn.h"
#include "cxx_template.h"
#include "cxx_memory.h"
#include "targ_sim.h" 			// for Get_Return_*
#include "opt_htable.h"			// for CODEREP
#include "fb_whirl.h"			// for FEEDBACK, FB_FREQ
...
static BOOL HasReturnPreg(WN *w, TY_IDX type)
{
  if (WHIRL_Return_Info_On) {
    ...
    Fail_FmtAssertion("WHIRL_Return_Info_On must be set to TRUE");
    TYPE_ID  ty1, ty2;
    PREG_NUM reg1, reg2;
