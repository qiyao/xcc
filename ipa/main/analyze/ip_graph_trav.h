...
typedef enum traveral_order
{
    ...
    INLINEORDER = 3,             /* similar to level but ignore edges marked to never be inlined */
    DONTCARE = 4,		/* just iterate all vertices */
    ORDER_LAST = 5		/* number of traveral order supported
				   (must be last) */
} TRAVERSAL_ORDER;
