...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/ipa/main/analyze/RCS/ipa_solver.cxx,v $ $Revision: 1.22 $";
#endif /* _KEEP_RCS_ID */
...
DFBASE::Connect_graph ( MEM_POOL *pool )
{
  ...
  Trace_CG = Get_Trace ( TP_IPA, IPA_TRACE_IPAA_GRAPH_SOLVER );
