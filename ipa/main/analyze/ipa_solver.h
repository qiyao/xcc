...
#ifdef _KEEP_RCS_ID
static char *ipa_solver_rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/ipa/main/analyze/RCS/ipa_solver.h,v $ $Revision: 1.17 $";
#endif /* _KEEP_RCS_ID */
...
Iterative_Solver_Core ( DF_T *dataflow )
{
  ...
  if ( Get_Trace ( TP_IPA, IPA_TRACE_IPAA_GRAPH_SOLVER ) ) {
