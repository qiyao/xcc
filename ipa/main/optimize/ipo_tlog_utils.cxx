...
static char *rcs_id = 	ipo_tlog_utils_CXX"$Revision: 1.8 $";
...
Ipa_tlog_trace( void )
{
  return Get_Trace ( TP_PTRACE1, TP_PTRACE1_IPA, 0 );
}

static BOOL
Inline_tlog_trace( void )
{
  return Get_Trace ( TP_PTRACE1, TP_PTRACE1_INL, 0 );
}
