...
)
{
	...
	*/
    ...
    printf("total line info length %ld bytes, "
		"line offset 0x%" LLX_FMT " %" LLD_FMT "\n",
		(long)total_length,
    ...
    printf("  statement prog offset in section: %" LLD_FMT " 0x%" LLX_FMT "\n",
	...
	printf(" [0x%06llx] ",
	   ...
	   /*   This op code is a special op in
		...
		printf("DW_LNS_advance_pc val %" LLD_FMT " 0x%" LLX_FMT "\n",
		...
		printf("DW_LNS_advance_line val %" LLD_FMT " 0x%" LLX_FMT "\n",
		...
		printf("DW_LNS_set_column val %" LLD_FMT " 0x%" LLX_FMT "\n",
			(long long)column,
			(long long)column);
                break;
            }
		...
		printf("DW_LNS_const_add_pc new address 0x%" LLX_FMT "\n",
			(long long)address);
                break;
            }
		...
		printf("DW_LNS_fixed_advance_pc val %" LLD_FMT " 0x%" LLX_FMT ""
			" new address 0x%" LLX_FMT "\n",
		...
		print_line_detail("DW_LNE_end_sequence extended",
			...
			is_stmt,basic_block,end_sequence);
			    ...
			    printf("DW_LNE_set_address address 0x%" LLX_FMT "\n",
					(long long)address);
                        }
                        else {
