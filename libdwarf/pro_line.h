...
#define VERSION				2
#if !defined(TARG_XTENSA)
#define MIN_INST_LENGTH			4
#else
// 
// The meaning of this parameter does not match its name.  The code assumes
// that MIN_INST_LENGTH divides all instruction sizes.  On xtensa, which
// has 2- and 3-byte instructions, we have to set this value to 1.
//
