 ...
 * Module: atan2tab.c
 * $Revision: 1.9 $
 * $Date: 2000/04/14 00:29:03 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/RCS/atan2tab.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/RCS/atan2tab.c,v $ $Revision: 1.9 $";
