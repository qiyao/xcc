 ...
 * Module: cabs.c
 * $Revision: 1.9 $
 * $Date: 2000/04/14 00:27:53 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/RCS/cabs.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/RCS/cabs.c,v $ $Revision: 1.9 $";
