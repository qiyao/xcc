 ...
 * Module: cabsf.c
 * $Revision: 1.8 $
 * $Date: 2000/04/14 00:27:36 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/RCS/cabsf.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/RCS/cabsf.c,v $ $Revision: 1.8 $";
