 ...
 * Module: expftab.c
 * $Revision: 1.9 $
 * $Date: 2000/04/14 21:19:40 $
 * $Author: vegas $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/RCS/expftab.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/RCS/expftab.c,v $ $Revision: 1.9 $";
