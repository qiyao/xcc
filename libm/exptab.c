 ...
 * Module: exptab.c
 * $Revision: 1.8 $
 * $Date: 2000/04/14 00:54:02 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/RCS/exptab.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/RCS/exptab.c,v $ $Revision: 1.8 $";
