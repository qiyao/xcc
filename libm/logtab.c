 ...
 * Module: logtab.c
 * $Revision: 1.6 $
 * $Date: 2000/04/14 00:55:28 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/RCS/logtab.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/RCS/logtab.c,v $ $Revision: 1.6 $";
