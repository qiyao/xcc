 ...
 * Module: cosf.c
 * $Revision: 1.7 $
 * $Date: 2000/08/11 21:27:43 $
 * $Author: vegas $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/mips/RCS/cosf.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/mips/RCS/cosf.c,v $ $Revision: 1.7 $";
