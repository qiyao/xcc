 ...
 * Module: expf.c
 * $Revision: 1.9 $
 * $Date: 2000/04/19 00:54:56 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/mips/RCS/expf.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/mips/RCS/expf.c,v $ $Revision: 1.9 $";
