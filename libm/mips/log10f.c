 ...
 * Module: log10f.c
 * $Revision: 1.9 $
 * $Date: 2000/04/19 00:57:26 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/mips/RCS/log10f.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/mips/RCS/log10f.c,v $ $Revision: 1.9 $";
