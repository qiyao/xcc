 ...
 * Module: log1p.c
 * $Revision: 1.20 $
 * $Date: 2000/08/15 22:04:40 $
 * $Author: vegas $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/mips/RCS/log1p.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/mips/RCS/log1p.c,v $ $Revision: 1.20 $";
