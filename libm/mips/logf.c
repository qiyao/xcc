 ...
 * Module: logf.c
 * $Revision: 1.8 $
 * $Date: 2000/04/19 00:58:18 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/mips/RCS/logf.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/mips/RCS/logf.c,v $ $Revision: 1.8 $";
