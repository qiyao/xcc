 ...
 * Module: powf.c
 * $Revision: 1.9 $
 * $Date: 2000/08/11 21:27:48 $
 * $Author: vegas $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/mips/RCS/powf.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/mips/RCS/powf.c,v $ $Revision: 1.9 $";
