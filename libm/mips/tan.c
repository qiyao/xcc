 ...
 * Module: tan.c
 * $Revision: 1.23 $
 * $Date: 2000/08/15 22:04:49 $
 * $Author: vegas $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/mips/RCS/tan.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/mips/RCS/tan.c,v $ $Revision: 1.23 $";
