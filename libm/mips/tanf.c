 ...
 * Module: tanf.c
 * $Revision: 1.8 $
 * $Date: 2000/08/11 21:27:55 $
 * $Author: vegas $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/mips/RCS/tanf.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/mips/RCS/tanf.c,v $ $Revision: 1.8 $";
