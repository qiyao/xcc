 ...
 * Module: tanhf.c
 * $Revision: 1.7 $
 * $Date: 2000/04/19 01:01:11 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/mips/RCS/tanhf.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/mips/RCS/tanhf.c,v $ $Revision: 1.7 $";
