 ...
 * Module: powtab.c
 * $Revision: 1.7 $
 * $Date: 2000/04/14 00:56:01 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/RCS/powtab.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/RCS/powtab.c,v $ $Revision: 1.7 $";
