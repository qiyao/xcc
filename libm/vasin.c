 ...
 * Module: vasin.c
 * $Revision: 1.13 $
 * $Date: 2000/04/14 00:57:50 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vasin.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vasin.c,v $ $Revision: 1.13 $";
