 ...
 * Module: vatan.c
 * $Revision: 1.10 $
 * $Date: 2000/04/14 00:58:26 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vatan.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vatan.c,v $ $Revision: 1.10 $";
