 ...
 * Module: vatanf.c
 * $Revision: 1.13 $
 * $Date: 2000/04/14 00:58:46 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vatanf.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vatanf.c,v $ $Revision: 1.13 $";
