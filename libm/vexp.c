 ...
 * Module: vexp.c
 * $Revision: 1.19 $
 * $Date: 2000/04/14 01:00:15 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vexp.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vexp.c,v $ $Revision: 1.19 $";
