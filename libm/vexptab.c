 ...
 * Module: vexptab.c
 * $Revision: 1.2 $
 * $Date: 2000/04/14 01:01:07 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vexptab.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vexptab.c,v $ $Revision: 1.2 $";
