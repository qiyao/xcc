 ...
 * Module: vlog.c
 * $Revision: 1.21 $
 * $Date: 2000/04/14 01:01:24 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vlog.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vlog.c,v $ $Revision: 1.21 $";
