 ...
 * Module: vlogf.c
 * $Revision: 1.19 $
 * $Date: 2000/04/14 01:02:18 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vlogf.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vlogf.c,v $ $Revision: 1.19 $";
