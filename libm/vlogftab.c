 ...
 * Module: vlogftab.c
 * $Revision: 1.5 $
 * $Date: 2000/04/14 01:02:36 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vlogftab.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vlogftab.c,v $ $Revision: 1.5 $";
