 ...
 * Module: vsin.c
 * $Revision: 1.13 $
 * $Date: 2000/04/14 01:03:15 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vsin.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vsin.c,v $ $Revision: 1.13 $";
