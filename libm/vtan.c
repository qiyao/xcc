 ...
 * Module: vtan.c
 * $Revision: 1.11 $
 * $Date: 2000/04/14 01:04:25 $
 * $Author: mtibuild $
 * $Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vtan.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /isms/cmplrs.src/osprey1.0/libm/RCS/vtan.c,v $ $Revision: 1.11 $";
