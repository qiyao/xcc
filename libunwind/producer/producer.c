...
__unw_error_t unwind_info_add_desc(__uint64_t size, char *buf) {
	...
	memcpy((void *)((char *)_current_unwind_info + _current_unwind_info_size - size), 
...
__unw_error_t unwind_info_finalize(__unw_info_t *info) {
	...
	memcpy((void *)((char *)_unwind_info + _unwind_info_size - _current_unwind_info_size),
		(const void *)_current_unwind_info, (size_t)_current_unwind_info_size);
#ifdef DEBUG
	fprintf(stderr, "unwind_info_finalize(): ");
...
__unw_error_t unwind_info_add_language_specific_info(__unw_info_t *info,
	...
	memcpy((void *)((char *)_lang_spec_data + _lang_spec_data_size - size),
